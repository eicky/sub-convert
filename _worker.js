...
`).filter(Boolean)??[]).reduce((e,t)=>(e.unshift({label:t,value:t}),e),[{label:`ACL4SSR_Online 默认版 分组比较全 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini`},{label:`ACL4SSR_Online_AdblockPlus 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_AdblockPlus.ini`},{label:`ACL4SSR_Online_NoAuto 无自动测速 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_NoAuto.ini`},{label:`ACL4SSR_Online_NoReject 无广告拦截规则 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_NoReject.ini`},{label:`ACL4SSR_Online_Mini 精简版 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini.ini`},{label:`ACL4SSR_Online_Mini_AdblockPlus.ini 精简版 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_AdblockPlus.ini`},{label:`ACL4SSR_Online_Mini_NoAuto.ini 精简版 不带自动测速 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_NoAuto.ini`},{label:`ACL4SSR_Online_Mini_Fallback.ini 精简版 带故障转移 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_Fallback.ini`},{label:`ACL4SSR_Online_Mini_MultiMode.ini 精简版 自动测速、故障转移、负载均衡 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_MultiMode.ini`},{label:`ACL4SSR_Online_Full 全分组 重度用户使用 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full.ini`},{label:`ACL4SSR_Online_Full_NoAuto.ini 全分组 无自动测速 重度用户使用 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_NoAuto.ini`},{label:`ACL4SSR_Online_Full_AdblockPlus 全分组 重度用户使用 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_AdblockPlus.ini`},{label:`ACL4SSR_Online_Full_Netflix 全分组 重度用户使用 奈飞全量 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_Netflix.ini`}])}function ht(e,t){if(!t.SHORT_URL_ENABLED)return[];let{origin:n}=new URL(e.url);return[{label:n,value:n}]}function gt(){return[{label:`Clash`,value:`clash`},{label:`Sing-box`,value:`singbox`},{label:`v2ray`,value:`v2ray`}]}var _t=class e{static#e=[{label:`中国香港`,value:`ZH_HK`,rules:`港|HK|Hong Kong|HongKong|HKG`},{label:`中国台湾`,value:`ZH_TW`,rules:`台|新北|彰化|TW|Taiwan|TPE|KHH`},{label:`中国澳门`,value:`ZH_MO`,rules:`澳|MAC|Macao|macau|MACAU`},{label:`韩国`,value:`KR`,rules:`KR|Korea|KOR|Seoul|首尔|春川|韩|韓|ICN`},{label:`日本`,value:`JP`,rules:`日本|川日|东京|大阪|泉日|埼玉|沪日|深日|[^-]日|JP|Japan|Tokyo|NRT|KIX`},{label:`新加坡`,value:`SG`,rules:`新加坡|坡|狮城|SG|Singapore|SIN`},{label:`美国`,value:`US`,rules:`美|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉拉|西雅图|芝加哥|US|United States|ATL|BUF|DFW|EWR|IAD|LAX|MCI|MIA|ORD|PHX|PDX|SEA|SJC`}];static#t=null;static#n(e){let t=e.split(`|`).map(e=>/^[A-Z0-9][A-Z0-9 ]*$/i.test(e)?`\\b${e}\\b`:e).join(`|`);return new RegExp(t,`i`)}static#r(){return e.#t||=e.#e.map(t=>({value:t.value,regexp:e.#n(t.rules)})),e.#t}getTag(t){if(!t)return null;let n=decodeURIComponent(t);for(let{value:t,regexp:r}of e.#r())if(r.test(n))return t;return null}get excludeRules(){return e.#e}};function vt(){return new _t().excludeRules.map(e=>({label:e.label,value:e.value}))}function yt(){return`
    ...
    `}function St(e,t){let n=mt(t),r=ft(e,t),i=ht(e,t),a=gt(),o=ut(),s=pt(),c=vt(),l=dt(e,t),u=t.SHORT_URL_ENABLED===!0,d=`  
    <!DOCTYPE html>
    ...
    `;return new Response(d,{headers:new Headers({"Content-Type":`text/html; charset=UTF-8`,"Cache-Control":`no-store, no-cache, must-revalidate`})})}const Ct=new ze;Ct.get(`/`,e=>St(e.req.raw,e.env)),Ct.get(`/favicon.ico`,e=>e.body(null,204));var wt=class{constructor(e){this.service=e}async toSub(e){let n=e.req.query(`target`);if(!n)throw new t(400,{message:`Unsupported client type`});let r=gt().map(e=>e.value);if(!r.includes(n))throw new t(400,{message:`Unsupported client type, support list: ${r.join(`, `)}`});let{body:i,contentType:a}=await this.service.toSub(e.req.raw,e.env,n);return e.body(i,200,{"Content-Type":a,"Cache-Control":`no-store`})}async getVersion(e){let t=this.service.getVersionRedirect(e.req.raw,e.env);return e.redirect(t,302)}async add(e){let n=await e.req.json();if(!n?.long_url)throw new t(400,{message:`Missing long_url`});let r=new URL(e.req.url),i=n.serve||`${r.protocol}//${r.host}`,a=await this.service.add(n.long_url,i);return e.json({data:a})}async delete(e){let n=e.req.query(`code`);if(!n)throw new t(400,{message:`Missing code`});return await this.service.deleteByCode(n),e.json({data:{deleted:!0}})}async queryByCode(e){let n=e.req.query(`code`);if(!n)throw new t(400,{message:`Missing code`});let r=await this.service.getByCode(n);if(!r)throw new t(404,{message:`Not found`});return e.json({data:r})}async queryList(e){let t=Number.parseInt(e.req.query(`page`)||`1`,10),n=Number.parseInt(e.req.query(`pageSize`)||`10`,10),r=await this.service.getList(t,n);return e.json({data:r})}async redirect(e){let n=e.req.param(`code`);if(!n)throw new t(400,{message:`Invalid short URL`});let r=await this.service.getByCode(n);if(!r)throw new t(404,{message:`Not found`});return e.redirect(r.long_url,302)}};
/*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT */
function Tt(e){return e==null}function Et(e){return typeof e==`object`&&!!e}function Dt(e){return Array.isArray(e)?e:Tt(e)?[]:[e]}function Ot(e,t){var n,r,i,a;if(t)for(a=Object.keys(t),n=0,r=a.length;n<r;n+=1)i=a[n],e[i]=t[i];return e}function kt(e,t){var n=``,r;for(r=0;r<t;r+=1)n+=e;return n}function At(e){return e===0&&1/e==-1/0}var w={isNothing:Tt,isObject:Et,toArray:Dt,repeat:kt,isNegativeZero:At,extend:Ot};function jt(e,t){var n=``,r=e.reason||`(unknown reason)`;return e.mark?(e.mark.name&&(n+=`in "`+e.mark.name+`" `),n+=`(`+(e.mark.line+1)+`:`+(e.mark.column+1)+`)`,!t&&e.mark.snippet&&(n+=`

`+e.mark.snippet),r+` `+n):r}function T(e,t){Error.call(this),this.name=`YAMLException`,this.reason=e,this.mark=t,this.message=jt(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack||``}T.prototype=Object.create(Error.prototype),T.prototype.constructor=T,T.prototype.toString=function(e){return this.name+`: `+jt(this,e)};var E=T;function Mt(e,t,n,r,i){var a=``,o=``,s=Math.floor(i/2)-1;return r-t>s&&(a=` ... `,t=r-s+a.length),n-r>s&&(o=` ...`,n=r+s-o.length),{str:a+e.slice(t,n).replace(/\t/g,`→`)+o,pos:r-t+a.length}}function Nt(e,t){return w.repeat(` `,t-e.length)+e}function Pt(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||=79,typeof t.indent!=`number`&&(t.indent=1),typeof t.linesBefore!=`number`&&(t.linesBefore=3),typeof t.linesAfter!=`number`&&(t.linesAfter=2);for(var n=/\r?\n|\r|\0/g,r=[0],i=[],a,o=-1;a=n.exec(e.buffer);)i.push(a.index),r.push(a.index+a[0].length),e.position<=a.index&&o<0&&(o=r.length-2);o<0&&(o=r.length-1);var s=``,c,l,u=Math.min(e.line+t.linesAfter,i.length).toString().length,d=t.maxLength-(t.indent+u+3);for(c=1;c<=t.linesBefore&&!(o-c<0);c++)l=Mt(e.buffer,r[o-c],i[o-c],e.position-(r[o]-r[o-c]),d),s=w.repeat(` `,t.indent)+Nt((e.line-c+1).toString(),u)+` | `+l.str+`
`+s;for(l=Mt(e.buffer,r[o],i[o],e.position,d),s+=w.repeat(` `,t.indent)+Nt((e.line+1).toString(),u)+` | `+l.str+`
`,s+=w.repeat(`-`,t.indent+u+3+l.pos)+`^
`,c=1;c<=t.linesAfter&&!(o+c>=i.length);c++)l=Mt(e.buffer,r[o+c],i[o+c],e.position-(r[o]-r[o+c]),d),s+=w.repeat(` `,t.indent)+Nt((e.line+c+1).toString(),u)+` | `+l.str+`
`;return s.replace(/\n$/,``)}var Ft=Pt,It=[`kind`,`multi`,`resolve`,`construct`,`instanceOf`,`predicate`,`represent`,`representName`,`defaultStyle`,`styleAliases`],Lt=[`scalar`,`sequence`,`mapping`];function Rt(e){var t={};return e!==null&&Object.keys(e).forEach(function(n){e[n].forEach(function(e){t[String(e)]=n})}),t}function zt(e,t){if(t||={},Object.keys(t).forEach(function(t){if(It.indexOf(t)===-1)throw new E(`Unknown option "`+t+`" is met in definition of "`+e+`" YAML type.`)}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(e){return e},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=Rt(t.styleAliases||null),Lt.indexOf(this.kind)===-1)throw new E(`Unknown kind "`+this.kind+`" is specified for "`+e+`" YAML type.`)}var D=zt;function Bt(e,t){var n=[];return e[t].forEach(function(e){var t=n.length;n.forEach(function(n,r){n.tag===e.tag&&n.kind===e.kind&&n.multi===e.multi&&(t=r)}),n[t]=e}),n}function Vt(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},t,n;function r(t){t.multi?(e.multi[t.kind].push(t),e.multi.fallback.push(t)):e[t.kind][t.tag]=e.fallback[t.tag]=t}for(t=0,n=arguments.length;t<n;t+=1)arguments[t].forEach(r);return e}function Ht(e){return this.extend(e)}Ht.prototype.extend=function(e){var t=[],n=[];if(e instanceof D)n.push(e);else if(Array.isArray(e))n=n.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(n=n.concat(e.explicit));else throw new E(`Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })`);t.forEach(function(e){if(!(e instanceof D))throw new E(`Specified list of YAML types (or a single Type object) contains a non-Type object.`);if(e.loadKind&&e.loadKind!==`scalar`)throw new E(`There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.`);if(e.multi)throw new E(`There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.`)}),n.forEach(function(e){if(!(e instanceof D))throw new E(`Specified list of YAML types (or a single Type object) contains a non-Type object.`)});var r=Object.create(Ht.prototype);return r.implicit=(this.implicit||[]).concat(t),r.explicit=(this.explicit||[]).concat(n),r.compiledImplicit=Bt(r,`implicit`),r.compiledExplicit=Bt(r,`explicit`),r.compiledTypeMap=Vt(r.compiledImplicit,r.compiledExplicit),r};var Ut=new Ht({explicit:[new D(`tag:yaml.org,2002:str`,{kind:`scalar`,construct:function(e){return e===null?``:e}}),new D(`tag:yaml.org,2002:seq`,{kind:`sequence`,construct:function(e){return e===null?[]:e}}),new D(`tag:yaml.org,2002:map`,{kind:`mapping`,construct:function(e){return e===null?{}:e}})]});function Wt(e){if(e===null)return!0;var t=e.length;return t===1&&e===`~`||t===4&&(e===`null`||e===`Null`||e===`NULL`)}function Gt(){return null}function Kt(e){return e===null}var qt=new D(`tag:yaml.org,2002:null`,{kind:`scalar`,resolve:Wt,construct:Gt,predicate:Kt,represent:{canonical:function(){return`~`},lowercase:function(){return`null`},uppercase:function(){return`NULL`},camelcase:function(){return`Null`},empty:function(){return``}},defaultStyle:`lowercase`});function Jt(e){if(e===null)return!1;var t=e.length;return t===4&&(e===`true`||e===`True`||e===`TRUE`)||t===5&&(e===`false`||e===`False`||e===`FALSE`)}function Yt(e){return e===`true`||e===`True`||e===`TRUE`}function Xt(e){return Object.prototype.toString.call(e)===`[object Boolean]`}var Zt=new D(`tag:yaml.org,2002:bool`,{kind:`scalar`,resolve:Jt,construct:Yt,predicate:Xt,represent:{lowercase:function(e){return e?`true`:`false`},uppercase:function(e){return e?`TRUE`:`FALSE`},camelcase:function(e){return e?`True`:`False`}},defaultStyle:`lowercase`});function Qt(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function $t(e){return 48<=e&&e<=55}function en(e){return 48<=e&&e<=57}function tn(e){if(e===null)return!1;var t=e.length,n=0,r=!1,i;if(!t)return!1;if(i=e[n],(i===`-`||i===`+`)&&(i=e[++n]),i===`0`){if(n+1===t)return!0;if(i=e[++n],i===`b`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(i!==`0`&&i!==`1`)return!1;r=!0}return r&&i!==`_`}if(i===`x`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(!Qt(e.charCodeAt(n)))return!1;r=!0}return r&&i!==`_`}if(i===`o`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(!$t(e.charCodeAt(n)))return!1;r=!0}return r&&i!==`_`}}if(i===`_`)return!1;for(;n<t;n++)if(i=e[n],i!==`_`){if(!en(e.charCodeAt(n)))return!1;r=!0}return!(!r||i===`_`)}function nn(e){var t=e,n=1,r;if(t.indexOf(`_`)!==-1&&(t=t.replace(/_/g,``)),r=t[0],(r===`-`||r===`+`)&&(r===`-`&&(n=-1),t=t.slice(1),r=t[0]),t===`0`)return 0;if(r===`0`){if(t[1]===`b`)return n*parseInt(t.slice(2),2);if(t[1]===`x`)return n*parseInt(t.slice(2),16);if(t[1]===`o`)return n*parseInt(t.slice(2),8)}return n*parseInt(t,10)}function rn(e){return Object.prototype.toString.call(e)===`[object Number]`&&e%1==0&&!w.isNegativeZero(e)}var an=new D(`tag:yaml.org,2002:int`,{kind:`scalar`,resolve:tn,construct:nn,predicate:rn,represent:{binary:function(e){return e>=0?`0b`+e.toString(2):`-0b`+e.toString(2).slice(1)},octal:function(e){return e>=0?`0o`+e.toString(8):`-0o`+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?`0x`+e.toString(16).toUpperCase():`-0x`+e.toString(16).toUpperCase().slice(1)}},defaultStyle:`decimal`,styleAliases:{binary:[2,`bin`],octal:[8,`oct`],decimal:[10,`dec`],hexadecimal:[16,`hex`]}}),on=RegExp(`^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`);function sn(e){return!(e===null||!on.test(e)||e[e.length-1]===`_`)}function cn(e){var t=e.replace(/_/g,``).toLowerCase(),n=t[0]===`-`?-1:1;return`+-`.indexOf(t[0])>=0&&(t=t.slice(1)),t===`.inf`?n===1?1/0:-1/0:t===`.nan`?NaN:n*parseFloat(t,10)}var ln=/^[-+]?[0-9]+e/;function un(e,t){var n;if(isNaN(e))switch(t){case`lowercase`:return`.nan`;case`uppercase`:return`.NAN`;case`camelcase`:return`.NaN`}else if(e===1/0)switch(t){case`lowercase`:return`.inf`;case`uppercase`:return`.INF`;case`camelcase`:return`.Inf`}else if(e===-1/0)switch(t){case`lowercase`:return`-.inf`;case`uppercase`:return`-.INF`;case`camelcase`:return`-.Inf`}else if(w.isNegativeZero(e))return`-0.0`;return n=e.toString(10),ln.test(n)?n.replace(`e`,`.e`):n}function dn(e){return Object.prototype.toString.call(e)===`[object Number]`&&(e%1!=0||w.isNegativeZero(e))}var fn=new D(`tag:yaml.org,2002:float`,{kind:`scalar`,resolve:sn,construct:cn,predicate:dn,represent:un,defaultStyle:`lowercase`}),pn=Ut.extend({implicit:[qt,Zt,an,fn]}),mn=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$`),hn=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$`);function gn(e){return e===null?!1:mn.exec(e)!==null||hn.exec(e)!==null}function _n(e){var t,n,r,i,a,o,s,c=0,l=null,u,d,f;if(t=mn.exec(e),t===null&&(t=hn.exec(e)),t===null)throw Error(`Date resolve error`);if(n=+t[1],r=t[2]-1,i=+t[3],!t[4])return new Date(Date.UTC(n,r,i));if(a=+t[4],o=+t[5],s=+t[6],t[7]){for(c=t[7].slice(0,3);c.length<3;)c+=`0`;c=+c}return t[9]&&(u=+t[10],d=+(t[11]||0),l=(u*60+d)*6e4,t[9]===`-`&&(l=-l)),f=new Date(Date.UTC(n,r,i,a,o,s,c)),l&&f.setTime(f.getTime()-l),f}function vn(e){return e.toISOString()}var yn=new D(`tag:yaml.org,2002:timestamp`,{kind:`scalar`,resolve:gn,construct:_n,instanceOf:Date,represent:vn});function bn(e){return e===`<<`||e===null}var xn=new D(`tag:yaml.org,2002:merge`,{kind:`scalar`,resolve:bn}),Sn=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Cn(e){if(e===null)return!1;var t,n,r=0,i=e.length,a=Sn;for(n=0;n<i;n++)if(t=a.indexOf(e.charAt(n)),!(t>64)){if(t<0)return!1;r+=6}return r%8==0}function wn(e){var t,n,r=e.replace(/[\r\n=]/g,``),i=r.length,a=Sn,o=0,s=[];for(t=0;t<i;t++)t%4==0&&t&&(s.push(o>>16&255),s.push(o>>8&255),s.push(o&255)),o=o<<6|a.indexOf(r.charAt(t));return n=i%4*6,n===0?(s.push(o>>16&255),s.push(o>>8&255),s.push(o&255)):n===18?(s.push(o>>10&255),s.push(o>>2&255)):n===12&&s.push(o>>4&255),new Uint8Array(s)}function Tn(e){var t=``,n=0,r,i,a=e.length,o=Sn;for(r=0;r<a;r++)r%3==0&&r&&(t+=o[n>>18&63],t+=o[n>>12&63],t+=o[n>>6&63],t+=o[n&63]),n=(n<<8)+e[r];return i=a%3,i===0?(t+=o[n>>18&63],t+=o[n>>12&63],t+=o[n>>6&63],t+=o[n&63]):i===2?(t+=o[n>>10&63],t+=o[n>>4&63],t+=o[n<<2&63],t+=o[64]):i===1&&(t+=o[n>>2&63],t+=o[n<<4&63],t+=o[64],t+=o[64]),t}function En(e){return Object.prototype.toString.call(e)===`[object Uint8Array]`}var Dn=new D(`tag:yaml.org,2002:binary`,{kind:`scalar`,resolve:Cn,construct:wn,predicate:En,represent:Tn}),On=Object.prototype.hasOwnProperty,kn=Object.prototype.toString;function An(e){if(e===null)return!0;var t=[],n,r,i,a,o,s=e;for(n=0,r=s.length;n<r;n+=1){if(i=s[n],o=!1,kn.call(i)!==`[object Object]`)return!1;for(a in i)if(On.call(i,a))if(!o)o=!0;else return!1;if(!o)return!1;if(t.indexOf(a)===-1)t.push(a);else return!1}return!0}function jn(e){return e===null?[]:e}var Mn=new D(`tag:yaml.org,2002:omap`,{kind:`sequence`,resolve:An,construct:jn}),Nn=Object.prototype.toString;function Pn(e){if(e===null)return!0;var t,n,r,i,a,o=e;for(a=Array(o.length),t=0,n=o.length;t<n;t+=1){if(r=o[t],Nn.call(r)!==`[object Object]`||(i=Object.keys(r),i.length!==1))return!1;a[t]=[i[0],r[i[0]]]}return!0}function Fn(e){if(e===null)return[];var t,n,r,i,a,o=e;for(a=Array(o.length),t=0,n=o.length;t<n;t+=1)r=o[t],i=Object.keys(r),a[t]=[i[0],r[i[0]]];return a}var In=new D(`tag:yaml.org,2002:pairs`,{kind:`sequence`,resolve:Pn,construct:Fn}),Ln=Object.prototype.hasOwnProperty;function Rn(e){if(e===null)return!0;var t,n=e;for(t in n)if(Ln.call(n,t)&&n[t]!==null)return!1;return!0}function zn(e){return e===null?{}:e}var Bn=new D(`tag:yaml.org,2002:set`,{kind:`mapping`,resolve:Rn,construct:zn}),Vn=pn.extend({implicit:[yn,xn],explicit:[Dn,Mn,In,Bn]}),O=Object.prototype.hasOwnProperty,Hn=1,Un=2,Wn=3,Gn=4,Kn=1,qn=2,Jn=3,Yn=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Xn=/[\x85\u2028\u2029]/,Zn=/[,\[\]\{\}]/,Qn=/^(?:!|!!|![a-z\-]+!)$/i,$n=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function er(e){return Object.prototype.toString.call(e)}function k(e){return e===10||e===13}function A(e){return e===9||e===32}function j(e){return e===9||e===32||e===10||e===13}function M(e){return e===44||e===91||e===93||e===123||e===125}function tr(e){var t;return 48<=e&&e<=57?e-48:(t=e|32,97<=t&&t<=102?t-97+10:-1)}function nr(e){return e===120?2:e===117?4:e===85?8:0}function rr(e){return 48<=e&&e<=57?e-48:-1}function ir(e){return e===48?`\0`:e===97?`\x07`:e===98?`\b`:e===116||e===9?`	`:e===110?`
`:e===118?`\v`:e===102?`\f`:e===114?`\r`:e===101?`\x1B`:e===32?` `:e===34?`"`:e===47?`/`:e===92?`\\`:e===78?``:e===95?`\xA0`:e===76?`\u2028`:e===80?`\u2029`:``}function ar(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function or(e,t,n){t===`__proto__`?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:n}):e[t]=n}for(var sr=Array(256),cr=Array(256),N=0;N<256;N++)sr[N]=+!!ir(N),cr[N]=ir(N);function lr(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||Vn,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function ur(e,t){var n={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return n.snippet=Ft(n),new E(t,n)}function P(e,t){throw ur(e,t)}function dr(e,t){e.onWarning&&e.onWarning.call(null,ur(e,t))}var fr={YAML:function(e,t,n){var r,i,a;e.version!==null&&P(e,`duplication of %YAML directive`),n.length!==1&&P(e,`YAML directive accepts exactly one argument`),r=/^([0-9]+)\.([0-9]+)$/.exec(n[0]),r===null&&P(e,`ill-formed argument of the YAML directive`),i=parseInt(r[1],10),a=parseInt(r[2],10),i!==1&&P(e,`unacceptable YAML version of the document`),e.version=n[0],e.checkLineBreaks=a<2,a!==1&&a!==2&&dr(e,`unsupported YAML version of the document`)},TAG:function(e,t,n){var r,i;n.length!==2&&P(e,`TAG directive accepts exactly two arguments`),r=n[0],i=n[1],Qn.test(r)||P(e,`ill-formed tag handle (first argument) of the TAG directive`),O.call(e.tagMap,r)&&P(e,`there is a previously declared suffix for "`+r+`" tag handle`),$n.test(i)||P(e,`ill-formed tag prefix (second argument) of the TAG directive`);try{i=decodeURIComponent(i)}catch{P(e,`tag prefix is malformed: `+i)}e.tagMap[r]=i}};function F(e,t,n,r){var i,a,o,s;if(t<n){if(s=e.input.slice(t,n),r)for(i=0,a=s.length;i<a;i+=1)o=s.charCodeAt(i),o===9||32<=o&&o<=1114111||P(e,`expected valid JSON character`);else Yn.test(s)&&P(e,`the stream contains non-printable characters`);e.result+=s}}function pr(e,t,n,r){var i,a,o,s;for(w.isObject(n)||P(e,`cannot merge mappings; the provided source object is unacceptable`),i=Object.keys(n),o=0,s=i.length;o<s;o+=1)a=i[o],O.call(t,a)||(or(t,a,n[a]),r[a]=!0)}function I(e,t,n,r,i,a,o,s,c){var l,u;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),l=0,u=i.length;l<u;l+=1)Array.isArray(i[l])&&P(e,`nested arrays are not supported inside keys`),typeof i==`object`&&er(i[l])===`[object Object]`&&(i[l]=`[object Object]`);if(typeof i==`object`&&er(i)===`[object Object]`&&(i=`[object Object]`),i=String(i),t===null&&(t={}),r===`tag:yaml.org,2002:merge`)if(Array.isArray(a))for(l=0,u=a.length;l<u;l+=1)pr(e,t,a[l],n);else pr(e,t,a,n);else !e.json&&!O.call(n,i)&&O.call(t,i)&&(e.line=o||e.line,e.lineStart=s||e.lineStart,e.position=c||e.position,P(e,`duplicated mapping key`)),or(t,i,a),delete n[i];return t}function mr(e){var t=e.input.charCodeAt(e.position);t===10?e.position++:t===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):P(e,`a line break is expected`),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function L(e,t,n){for(var r=0,i=e.input.charCodeAt(e.position);i!==0;){for(;A(i);)i===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),i=e.input.charCodeAt(++e.position);if(t&&i===35)do i=e.input.charCodeAt(++e.position);while(i!==10&&i!==13&&i!==0);if(k(i))for(mr(e),i=e.input.charCodeAt(e.position),r++,e.lineIndent=0;i===32;)e.lineIndent++,i=e.input.charCodeAt(++e.position);else break}return n!==-1&&r!==0&&e.lineIndent<n&&dr(e,`deficient indentation`),r}function hr(e){var t=e.position,n=e.input.charCodeAt(t);return!!((n===45||n===46)&&n===e.input.charCodeAt(t+1)&&n===e.input.charCodeAt(t+2)&&(t+=3,n=e.input.charCodeAt(t),n===0||j(n)))}function gr(e,t){t===1?e.result+=` `:t>1&&(e.result+=w.repeat(`
`,t-1))}function _r(e,t,n){var r,i,a,o,s,c,l,u,d=e.kind,f=e.result,p=e.input.charCodeAt(e.position);if(j(p)||M(p)||p===35||p===38||p===42||p===33||p===124||p===62||p===39||p===34||p===37||p===64||p===96||(p===63||p===45)&&(i=e.input.charCodeAt(e.position+1),j(i)||n&&M(i)))return!1;for(e.kind=`scalar`,e.result=``,a=o=e.position,s=!1;p!==0;){if(p===58){if(i=e.input.charCodeAt(e.position+1),j(i)||n&&M(i))break}else if(p===35){if(r=e.input.charCodeAt(e.position-1),j(r))break}else if(e.position===e.lineStart&&hr(e)||n&&M(p))break;else if(k(p))if(c=e.line,l=e.lineStart,u=e.lineIndent,L(e,!1,-1),e.lineIndent>=t){s=!0,p=e.input.charCodeAt(e.position);continue}else{e.position=o,e.line=c,e.lineStart=l,e.lineIndent=u;break}s&&=(F(e,a,o,!1),gr(e,e.line-c),a=o=e.position,!1),A(p)||(o=e.position+1),p=e.input.charCodeAt(++e.position)}return F(e,a,o,!1),e.result?!0:(e.kind=d,e.result=f,!1)}function vr(e,t){var n=e.input.charCodeAt(e.position),r,i;if(n!==39)return!1;for(e.kind=`scalar`,e.result=``,e.position++,r=i=e.position;(n=e.input.charCodeAt(e.position))!==0;)if(n===39)if(F(e,r,e.position,!0),n=e.input.charCodeAt(++e.position),n===39)r=e.position,e.position++,i=e.position;else return!0;else k(n)?(F(e,r,i,!0),gr(e,L(e,!1,t)),r=i=e.position):e.position===e.lineStart&&hr(e)?P(e,`unexpected end of the document within a single quoted scalar`):(e.position++,i=e.position);P(e,`unexpected end of the stream within a single quoted scalar`)}function yr(e,t){var n,r,i,a,o,s=e.input.charCodeAt(e.position);if(s!==34)return!1;for(e.kind=`scalar`,e.result=``,e.position++,n=r=e.position;(s=e.input.charCodeAt(e.position))!==0;)if(s===34)return F(e,n,e.position,!0),e.position++,!0;else if(s===92){if(F(e,n,e.position,!0),s=e.input.charCodeAt(++e.position),k(s))L(e,!1,t);else if(s<256&&sr[s])e.result+=cr[s],e.position++;else if((o=nr(s))>0){for(i=o,a=0;i>0;i--)s=e.input.charCodeAt(++e.position),(o=tr(s))>=0?a=(a<<4)+o:P(e,`expected hexadecimal character`);e.result+=ar(a),e.position++}else P(e,`unknown escape sequence`);n=r=e.position}else k(s)?(F(e,n,r,!0),gr(e,L(e,!1,t)),n=r=e.position):e.position===e.lineStart&&hr(e)?P(e,`unexpected end of the document within a double quoted scalar`):(e.position++,r=e.position);P(e,`unexpected end of the stream within a double quoted scalar`)}function br(e,t){var n=!0,r,i,a,o=e.tag,s,c=e.anchor,l,u,d,f,p,m=Object.create(null),h,g,_,v=e.input.charCodeAt(e.position);if(v===91)u=93,p=!1,s=[];else if(v===123)u=125,p=!0,s={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=s),v=e.input.charCodeAt(++e.position);v!==0;){if(L(e,!0,t),v=e.input.charCodeAt(e.position),v===u)return e.position++,e.tag=o,e.anchor=c,e.kind=p?`mapping`:`sequence`,e.result=s,!0;n?v===44&&P(e,`expected the node content, but found ','`):P(e,`missed comma between flow collection entries`),g=h=_=null,d=f=!1,v===63&&(l=e.input.charCodeAt(e.position+1),j(l)&&(d=f=!0,e.position++,L(e,!0,t))),r=e.line,i=e.lineStart,a=e.position,R(e,t,Hn,!1,!0),g=e.tag,h=e.result,L(e,!0,t),v=e.input.charCodeAt(e.position),(f||e.line===r)&&v===58&&(d=!0,v=e.input.charCodeAt(++e.position),L(e,!0,t),R(e,t,Hn,!1,!0),_=e.result),p?I(e,s,m,g,h,_,r,i,a):d?s.push(I(e,null,m,g,h,_,r,i,a)):s.push(h),L(e,!0,t),v=e.input.charCodeAt(e.position),v===44?(n=!0,v=e.input.charCodeAt(++e.position)):n=!1}P(e,`unexpected end of the stream within a flow collection`)}function xr(e,t){var n,r,i=Kn,a=!1,o=!1,s=t,c=0,l=!1,u,d=e.input.charCodeAt(e.position);if(d===124)r=!1;else if(d===62)r=!0;else return!1;for(e.kind=`scalar`,e.result=``;d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)Kn===i?i=d===43?Jn:qn:P(e,`repeat of a chomping mode identifier`);else if((u=rr(d))>=0)u===0?P(e,`bad explicit indentation width of a block scalar; it cannot be less than one`):o?P(e,`repeat of an indentation width identifier`):(s=t+u-1,o=!0);else break;if(A(d)){do d=e.input.charCodeAt(++e.position);while(A(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!k(d)&&d!==0)}for(;d!==0;){for(mr(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!o||e.lineIndent<s)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!o&&e.lineIndent>s&&(s=e.lineIndent),k(d)){c++;continue}if(e.lineIndent<s){i===Jn?e.result+=w.repeat(`
`,a?1+c:c):i===Kn&&a&&(e.result+=`
`);break}for(r?A(d)?(l=!0,e.result+=w.repeat(`
`,a?1+c:c)):l?(l=!1,e.result+=w.repeat(`
`,c+1)):c===0?a&&(e.result+=` `):e.result+=w.repeat(`
`,c):e.result+=w.repeat(`
`,a?1+c:c),a=!0,o=!0,c=0,n=e.position;!k(d)&&d!==0;)d=e.input.charCodeAt(++e.position);F(e,n,e.position,!1)}return!0}function Sr(e,t){var n,r=e.tag,i=e.anchor,a=[],o,s=!1,c;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=a),c=e.input.charCodeAt(e.position);c!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,P(e,`tab characters must not be used in indentation`)),!(c!==45||(o=e.input.charCodeAt(e.position+1),!j(o))));){if(s=!0,e.position++,L(e,!0,-1)&&e.lineIndent<=t){a.push(null),c=e.input.charCodeAt(e.position);continue}if(n=e.line,R(e,t,Wn,!1,!0),a.push(e.result),L(e,!0,-1),c=e.input.charCodeAt(e.position),(e.line===n||e.lineIndent>t)&&c!==0)P(e,`bad indentation of a sequence entry`);else if(e.lineIndent<t)break}return s?(e.tag=r,e.anchor=i,e.kind=`sequence`,e.result=a,!0):!1}function Cr(e,t,n){var r,i,a,o,s,c,l=e.tag,u=e.anchor,d={},f=Object.create(null),p=null,m=null,h=null,g=!1,_=!1,v;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=d),v=e.input.charCodeAt(e.position);v!==0;){if(!g&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,P(e,`tab characters must not be used in indentation`)),r=e.input.charCodeAt(e.position+1),a=e.line,(v===63||v===58)&&j(r))v===63?(g&&(I(e,d,f,p,m,null,o,s,c),p=m=h=null),_=!0,g=!0,i=!0):g?(g=!1,i=!0):P(e,`incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line`),e.position+=1,v=r;else{if(o=e.line,s=e.lineStart,c=e.position,!R(e,n,Un,!1,!0))break;if(e.line===a){for(v=e.input.charCodeAt(e.position);A(v);)v=e.input.charCodeAt(++e.position);if(v===58)v=e.input.charCodeAt(++e.position),j(v)||P(e,`a whitespace character is expected after the key-value separator within a block mapping`),g&&(I(e,d,f,p,m,null,o,s,c),p=m=h=null),_=!0,g=!1,i=!1,p=e.tag,m=e.result;else if(_)P(e,`can not read an implicit mapping pair; a colon is missed`);else return e.tag=l,e.anchor=u,!0}else if(_)P(e,`can not read a block mapping entry; a multiline key may not be an implicit key`);else return e.tag=l,e.anchor=u,!0}if((e.line===a||e.lineIndent>t)&&(g&&(o=e.line,s=e.lineStart,c=e.position),R(e,t,Gn,!0,i)&&(g?m=e.result:h=e.result),g||(I(e,d,f,p,m,h,o,s,c),p=m=h=null),L(e,!0,-1),v=e.input.charCodeAt(e.position)),(e.line===a||e.lineIndent>t)&&v!==0)P(e,`bad indentation of a mapping entry`);else if(e.lineIndent<t)break}return g&&I(e,d,f,p,m,null,o,s,c),_&&(e.tag=l,e.anchor=u,e.kind=`mapping`,e.result=d),_}function wr(e){var t,n=!1,r=!1,i,a,o=e.input.charCodeAt(e.position);if(o!==33)return!1;if(e.tag!==null&&P(e,`duplication of a tag property`),o=e.input.charCodeAt(++e.position),o===60?(n=!0,o=e.input.charCodeAt(++e.position)):o===33?(r=!0,i=`!!`,o=e.input.charCodeAt(++e.position)):i=`!`,t=e.position,n){do o=e.input.charCodeAt(++e.position);while(o!==0&&o!==62);e.position<e.length?(a=e.input.slice(t,e.position),o=e.input.charCodeAt(++e.position)):P(e,`unexpected end of the stream within a verbatim tag`)}else{for(;o!==0&&!j(o);)o===33&&(r?P(e,`tag suffix cannot contain exclamation marks`):(i=e.input.slice(t-1,e.position+1),Qn.test(i)||P(e,`named tag handle cannot contain such characters`),r=!0,t=e.position+1)),o=e.input.charCodeAt(++e.position);a=e.input.slice(t,e.position),Zn.test(a)&&P(e,`tag suffix cannot contain flow indicator characters`)}a&&!$n.test(a)&&P(e,`tag name cannot contain such characters: `+a);try{a=decodeURIComponent(a)}catch{P(e,`tag name is malformed: `+a)}return n?e.tag=a:O.call(e.tagMap,i)?e.tag=e.tagMap[i]+a:i===`!`?e.tag=`!`+a:i===`!!`?e.tag=`tag:yaml.org,2002:`+a:P(e,`undeclared tag handle "`+i+`"`),!0}function Tr(e){var t,n=e.input.charCodeAt(e.position);if(n!==38)return!1;for(e.anchor!==null&&P(e,`duplication of an anchor property`),n=e.input.charCodeAt(++e.position),t=e.position;n!==0&&!j(n)&&!M(n);)n=e.input.charCodeAt(++e.position);return e.position===t&&P(e,`name of an anchor node must contain at least one character`),e.anchor=e.input.slice(t,e.position),!0}function Er(e){var t,n,r=e.input.charCodeAt(e.position);if(r!==42)return!1;for(r=e.input.charCodeAt(++e.position),t=e.position;r!==0&&!j(r)&&!M(r);)r=e.input.charCodeAt(++e.position);return e.position===t&&P(e,`name of an alias node must contain at least one character`),n=e.input.slice(t,e.position),O.call(e.anchorMap,n)||P(e,`unidentified alias "`+n+`"`),e.result=e.anchorMap[n],L(e,!0,-1),!0}function R(e,t,n,r,i){var a,o,s,c=1,l=!1,u=!1,d,f,p,m,h,g;if(e.listener!==null&&e.listener(`open`,e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,a=o=s=Gn===n||Wn===n,r&&L(e,!0,-1)&&(l=!0,e.lineIndent>t?c=1:e.lineIndent===t?c=0:e.lineIndent<t&&(c=-1)),c===1)for(;wr(e)||Tr(e);)L(e,!0,-1)?(l=!0,s=a,e.lineIndent>t?c=1:e.lineIndent===t?c=0:e.lineIndent<t&&(c=-1)):s=!1;if(s&&=l||i,(c===1||Gn===n)&&(h=Hn===n||Un===n?t:t+1,g=e.position-e.lineStart,c===1?s&&(Sr(e,g)||Cr(e,g,h))||br(e,h)?u=!0:(o&&xr(e,h)||vr(e,h)||yr(e,h)?u=!0:Er(e)?(u=!0,(e.tag!==null||e.anchor!==null)&&P(e,`alias node should not have any properties`)):_r(e,h,Hn===n)&&(u=!0,e.tag===null&&(e.tag=`?`)),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):c===0&&(u=s&&Sr(e,g))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag===`?`){for(e.result!==null&&e.kind!==`scalar`&&P(e,`unacceptable node kind for !<?> tag; it should be "scalar", not "`+e.kind+`"`),d=0,f=e.implicitTypes.length;d<f;d+=1)if(m=e.implicitTypes[d],m.resolve(e.result)){e.result=m.construct(e.result),e.tag=m.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!==`!`){if(O.call(e.typeMap[e.kind||`fallback`],e.tag))m=e.typeMap[e.kind||`fallback`][e.tag];else for(m=null,p=e.typeMap.multi[e.kind||`fallback`],d=0,f=p.length;d<f;d+=1)if(e.tag.slice(0,p[d].tag.length)===p[d].tag){m=p[d];break}m||P(e,`unknown tag !<`+e.tag+`>`),e.result!==null&&m.kind!==e.kind&&P(e,`unacceptable node kind for !<`+e.tag+`> tag; it should be "`+m.kind+`", not "`+e.kind+`"`),m.resolve(e.result,e.tag)?(e.result=m.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):P(e,`cannot resolve a node with !<`+e.tag+`> explicit tag`)}return e.listener!==null&&e.listener(`close`,e),e.tag!==null||e.anchor!==null||u}function Dr(e){var t=e.position,n,r,i,a=!1,o;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(o=e.input.charCodeAt(e.position))!==0&&(L(e,!0,-1),o=e.input.charCodeAt(e.position),!(e.lineIndent>0||o!==37));){for(a=!0,o=e.input.charCodeAt(++e.position),n=e.position;o!==0&&!j(o);)o=e.input.charCodeAt(++e.position);for(r=e.input.slice(n,e.position),i=[],r.length<1&&P(e,`directive name must not be less than one character in length`);o!==0;){for(;A(o);)o=e.input.charCodeAt(++e.position);if(o===35){do o=e.input.charCodeAt(++e.position);while(o!==0&&!k(o));break}if(k(o))break;for(n=e.position;o!==0&&!j(o);)o=e.input.charCodeAt(++e.position);i.push(e.input.slice(n,e.position))}o!==0&&mr(e),O.call(fr,r)?fr[r](e,r,i):dr(e,`unknown document directive "`+r+`"`)}if(L(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,L(e,!0,-1)):a&&P(e,`directives end mark is expected`),R(e,e.lineIndent-1,Gn,!1,!0),L(e,!0,-1),e.checkLineBreaks&&Xn.test(e.input.slice(t,e.position))&&dr(e,`non-ASCII line breaks are interpreted as content`),e.documents.push(e.result),e.position===e.lineStart&&hr(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,L(e,!0,-1));return}if(e.position<e.length-1)P(e,`end of the stream or a document separator is expected`);else return}function Or(e,t){e=String(e),t||={},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var n=new lr(e,t),r=e.indexOf(`\0`);for(r!==-1&&(n.position=r,P(n,`null byte is not allowed in input`)),n.input+=`\0`;n.input.charCodeAt(n.position)===32;)n.lineIndent+=1,n.position+=1;for(;n.position<n.length-1;)Dr(n);return n.documents}function kr(e,t,n){typeof t==`object`&&t&&n===void 0&&(n=t,t=null);var r=Or(e,n);if(typeof t!=`function`)return r;for(var i=0,a=r.length;i<a;i+=1)t(r[i])}function Ar(e,t){var n=Or(e,t);if(n.length!==0){if(n.length===1)return n[0];throw new E(`expected a single document in the stream, but found more`)}}var jr={loadAll:kr,load:Ar},Mr=Object.prototype.toString,Nr=Object.prototype.hasOwnProperty,Pr=65279,Fr=9,z=10,Ir=13,Lr=32,Rr=33,zr=34,Br=35,Vr=37,Hr=38,Ur=39,Wr=42,Gr=44,Kr=45,qr=58,Jr=61,Yr=62,Xr=63,Zr=64,Qr=91,$r=93,ei=96,ti=123,ni=124,ri=125,B={};B[0]=`\\0`,B[7]=`\\a`,B[8]=`\\b`,B[9]=`\\t`,B[10]=`\\n`,B[11]=`\\v`,B[12]=`\\f`,B[13]=`\\r`,B[27]=`\\e`,B[34]=`\\"`,B[92]=`\\\\`,B[133]=`\\N`,B[160]=`\\_`,B[8232]=`\\L`,B[8233]=`\\P`;var ii=[`y`,`Y`,`yes`,`Yes`,`YES`,`on`,`On`,`ON`,`n`,`N`,`no`,`No`,`NO`,`off`,`Off`,`OFF`],ai=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function oi(e,t){var n,r,i,a,o,s,c;if(t===null)return{};for(n={},r=Object.keys(t),i=0,a=r.length;i<a;i+=1)o=r[i],s=String(t[o]),o.slice(0,2)===`!!`&&(o=`tag:yaml.org,2002:`+o.slice(2)),c=e.compiledTypeMap.fallback[o],c&&Nr.call(c.styleAliases,s)&&(s=c.styleAliases[s]),n[o]=s;return n}function si(e){var t=e.toString(16).toUpperCase(),n,r;if(e<=255)n=`x`,r=2;else if(e<=65535)n=`u`,r=4;else if(e<=4294967295)n=`U`,r=8;else throw new E(`code point within a string may not be greater than 0xFFFFFFFF`);return`\\`+n+w.repeat(`0`,r-t.length)+t}var ci=1,V=2;function li(e){this.schema=e.schema||Vn,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=w.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=oi(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType===`"`?V:ci,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer==`function`?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result=``,this.duplicates=[],this.usedDuplicates=null}function ui(e,t){for(var n=w.repeat(` `,t),r=0,i=-1,a=``,o,s=e.length;r<s;)i=e.indexOf(`
`,r),i===-1?(o=e.slice(r),r=s):(o=e.slice(r,i+1),r=i+1),o.length&&o!==`
`&&(a+=n),a+=o;return a}function di(e,t){return`
`+w.repeat(` `,e.indent*t)}function fi(e,t){var n,r,i;for(n=0,r=e.implicitTypes.length;n<r;n+=1)if(i=e.implicitTypes[n],i.resolve(t))return!0;return!1}function pi(e){return e===Lr||e===Fr}function H(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==Pr||65536<=e&&e<=1114111}function mi(e){return H(e)&&e!==Pr&&e!==Ir&&e!==z}function hi(e,t,n){var r=mi(e),i=r&&!pi(e);return(n?r:r&&e!==Gr&&e!==Qr&&e!==$r&&e!==ti&&e!==ri)&&e!==Br&&!(t===qr&&!i)||mi(t)&&!pi(t)&&e===Br||t===qr&&i}function gi(e){return H(e)&&e!==Pr&&!pi(e)&&e!==Kr&&e!==Xr&&e!==qr&&e!==Gr&&e!==Qr&&e!==$r&&e!==ti&&e!==ri&&e!==Br&&e!==Hr&&e!==Wr&&e!==Rr&&e!==ni&&e!==Jr&&e!==Yr&&e!==Ur&&e!==zr&&e!==Vr&&e!==Zr&&e!==ei}function _i(e){return!pi(e)&&e!==qr}function U(e,t){var n=e.charCodeAt(t),r;return n>=55296&&n<=56319&&t+1<e.length&&(r=e.charCodeAt(t+1),r>=56320&&r<=57343)?(n-55296)*1024+r-56320+65536:n}function vi(e){return/^\n* /.test(e)}var yi=1,bi=2,xi=3,Si=4,W=5;function Ci(e,t,n,r,i,a,o,s){var c,l=0,u=null,d=!1,f=!1,p=r!==-1,m=-1,h=gi(U(e,0))&&_i(U(e,e.length-1));if(t||o)for(c=0;c<e.length;l>=65536?c+=2:c++){if(l=U(e,c),!H(l))return W;h&&=hi(l,u,s),u=l}else{for(c=0;c<e.length;l>=65536?c+=2:c++){if(l=U(e,c),l===z)d=!0,p&&(f||=c-m-1>r&&e[m+1]!==` `,m=c);else if(!H(l))return W;h&&=hi(l,u,s),u=l}f||=p&&c-m-1>r&&e[m+1]!==` `}return!d&&!f?h&&!o&&!i(e)?yi:a===V?W:bi:n>9&&vi(e)?W:o?a===V?W:bi:f?Si:xi}function wi(e,t,n,r,i){e.dump=function(){if(t.length===0)return e.quotingType===V?`""`:`''`;if(!e.noCompatMode&&(ii.indexOf(t)!==-1||ai.test(t)))return e.quotingType===V?`"`+t+`"`:`'`+t+`'`;var a=e.indent*Math.max(1,n),o=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-a),s=r||e.flowLevel>-1&&n>=e.flowLevel;function c(t){return fi(e,t)}switch(Ci(t,s,e.indent,o,c,e.quotingType,e.forceQuotes&&!r,i)){case yi:return t;case bi:return`'`+t.replace(/'/g,`''`)+`'`;case xi:return`|`+Ti(t,e.indent)+Ei(ui(t,a));case Si:return`>`+Ti(t,e.indent)+Ei(ui(Di(t,o),a));case W:return`"`+ki(t)+`"`;default:throw new E(`impossible error: invalid scalar style`)}}()}function Ti(e,t){var n=vi(e)?String(t):``,r=e[e.length-1]===`
`;return n+(r&&(e[e.length-2]===`
`||e===`
`)?`+`:r?``:`-`)+`
`}function Ei(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function Di(e,t){for(var n=/(\n+)([^\n]*)/g,r=function(){var r=e.indexOf(`
`);return r=r===-1?e.length:r,n.lastIndex=r,Oi(e.slice(0,r),t)}(),i=e[0]===`
`||e[0]===` `,a,o;o=n.exec(e);){var s=o[1],c=o[2];a=c[0]===` `,r+=s+(!i&&!a&&c!==``?`
`:``)+Oi(c,t),i=a}return r}function Oi(e,t){if(e===``||e[0]===` `)return e;for(var n=/ [^ ]/g,r,i=0,a,o=0,s=0,c=``;r=n.exec(e);)s=r.index,s-i>t&&(a=o>i?o:s,c+=`
`+e.slice(i,a),i=a+1),o=s;return c+=`
`,e.length-i>t&&o>i?c+=e.slice(i,o)+`
`+e.slice(o+1):c+=e.slice(i),c.slice(1)}function ki(e){for(var t=``,n=0,r,i=0;i<e.length;n>=65536?i+=2:i++)n=U(e,i),r=B[n],!r&&H(n)?(t+=e[i],n>=65536&&(t+=e[i+1])):t+=r||si(n);return t}function Ai(e,t,n){var r=``,i=e.tag,a,o,s;for(a=0,o=n.length;a<o;a+=1)s=n[a],e.replacer&&(s=e.replacer.call(n,String(a),s)),(G(e,t,s,!1,!1)||s===void 0&&G(e,t,null,!1,!1))&&(r!==``&&(r+=`,`+(e.condenseFlow?``:` `)),r+=e.dump);e.tag=i,e.dump=`[`+r+`]`}function ji(e,t,n,r){var i=``,a=e.tag,o,s,c;for(o=0,s=n.length;o<s;o+=1)c=n[o],e.replacer&&(c=e.replacer.call(n,String(o),c)),(G(e,t+1,c,!0,!0,!1,!0)||c===void 0&&G(e,t+1,null,!0,!0,!1,!0))&&((!r||i!==``)&&(i+=di(e,t)),e.dump&&z===e.dump.charCodeAt(0)?i+=`-`:i+=`- `,i+=e.dump);e.tag=a,e.dump=i||`[]`}function Mi(e,t,n){var r=``,i=e.tag,a=Object.keys(n),o,s,c,l,u;for(o=0,s=a.length;o<s;o+=1)u=``,r!==``&&(u+=`, `),e.condenseFlow&&(u+=`"`),c=a[o],l=n[c],e.replacer&&(l=e.replacer.call(n,c,l)),G(e,t,c,!1,!1)&&(e.dump.length>1024&&(u+=`? `),u+=e.dump+(e.condenseFlow?`"`:``)+`:`+(e.condenseFlow?``:` `),G(e,t,l,!1,!1)&&(u+=e.dump,r+=u));e.tag=i,e.dump=`{`+r+`}`}function Ni(e,t,n,r){var i=``,a=e.tag,o=Object.keys(n),s,c,l,u,d,f;if(e.sortKeys===!0)o.sort();else if(typeof e.sortKeys==`function`)o.sort(e.sortKeys);else if(e.sortKeys)throw new E(`sortKeys must be a boolean or a function`);for(s=0,c=o.length;s<c;s+=1)f=``,(!r||i!==``)&&(f+=di(e,t)),l=o[s],u=n[l],e.replacer&&(u=e.replacer.call(n,l,u)),G(e,t+1,l,!0,!0,!0)&&(d=e.tag!==null&&e.tag!==`?`||e.dump&&e.dump.length>1024,d&&(e.dump&&z===e.dump.charCodeAt(0)?f+=`?`:f+=`? `),f+=e.dump,d&&(f+=di(e,t)),G(e,t+1,u,!0,d)&&(e.dump&&z===e.dump.charCodeAt(0)?f+=`:`:f+=`: `,f+=e.dump,i+=f));e.tag=a,e.dump=i||`{}`}function Pi(e,t,n){var r,i=n?e.explicitTypes:e.implicitTypes,a,o,s,c;for(a=0,o=i.length;a<o;a+=1)if(s=i[a],(s.instanceOf||s.predicate)&&(!s.instanceOf||typeof t==`object`&&t instanceof s.instanceOf)&&(!s.predicate||s.predicate(t))){if(n?s.multi&&s.representName?e.tag=s.representName(t):e.tag=s.tag:e.tag=`?`,s.represent){if(c=e.styleMap[s.tag]||s.defaultStyle,Mr.call(s.represent)===`[object Function]`)r=s.represent(t,c);else if(Nr.call(s.represent,c))r=s.represent[c](t,c);else throw new E(`!<`+s.tag+`> tag resolver accepts not "`+c+`" style`);e.dump=r}return!0}return!1}function G(e,t,n,r,i,a,o){e.tag=null,e.dump=n,Pi(e,n,!1)||Pi(e,n,!0);var s=Mr.call(e.dump),c=r,l;r&&=e.flowLevel<0||e.flowLevel>t;var u=s===`[object Object]`||s===`[object Array]`,d,f;if(u&&(d=e.duplicates.indexOf(n),f=d!==-1),(e.tag!==null&&e.tag!==`?`||f||e.indent!==2&&t>0)&&(i=!1),f&&e.usedDuplicates[d])e.dump=`*ref_`+d;else{if(u&&f&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),s===`[object Object]`)r&&Object.keys(e.dump).length!==0?(Ni(e,t,e.dump,i),f&&(e.dump=`&ref_`+d+e.dump)):(Mi(e,t,e.dump),f&&(e.dump=`&ref_`+d+` `+e.dump));else if(s===`[object Array]`)r&&e.dump.length!==0?(e.noArrayIndent&&!o&&t>0?ji(e,t-1,e.dump,i):ji(e,t,e.dump,i),f&&(e.dump=`&ref_`+d+e.dump)):(Ai(e,t,e.dump),f&&(e.dump=`&ref_`+d+` `+e.dump));else if(s===`[object String]`)e.tag!==`?`&&wi(e,e.dump,t,a,c);else if(s===`[object Undefined]`)return!1;else{if(e.skipInvalid)return!1;throw new E(`unacceptable kind of an object to dump `+s)}e.tag!==null&&e.tag!==`?`&&(l=encodeURI(e.tag[0]===`!`?e.tag.slice(1):e.tag).replace(/!/g,`%21`),l=e.tag[0]===`!`?`!`+l:l.slice(0,18)===`tag:yaml.org,2002:`?`!!`+l.slice(18):`!<`+l+`>`,e.dump=l+` `+e.dump)}return!0}function Fi(e,t){var n=[],r=[],i,a;for(Ii(e,n,r),i=0,a=r.length;i<a;i+=1)t.duplicates.push(n[r[i]]);t.usedDuplicates=Array(a)}function Ii(e,t,n){var r,i,a;if(typeof e==`object`&&e)if(i=t.indexOf(e),i!==-1)n.indexOf(i)===-1&&n.push(i);else if(t.push(e),Array.isArray(e))for(i=0,a=e.length;i<a;i+=1)Ii(e[i],t,n);else for(r=Object.keys(e),i=0,a=r.length;i<a;i+=1)Ii(e[r[i]],t,n)}function Li(e,t){t||={};var n=new li(t);n.noRefs||Fi(e,n);var r=e;return n.replacer&&(r=n.replacer.call({"":r},``,r)),G(n,0,r,!0,!0)?n.dump+`
`:``}var Ri={dump:Li},zi=jr.load;jr.loadAll;var Bi=Ri.dump;const K={BACKEND:`https://url.v1.mk`,LOCK_BACKEND:!1,REMOTE_CONFIG:``,CHUNK_COUNT:`20`};function Vi(e,t=10){let n=[],r=[];return e.forEach((e,i)=>{r.push(e),(i+1)%t===0&&(n.push(r.join(`|`)),r=[])}),r.length>0&&n.push(r.join(`|`)),n}function Hi(e){try{return JSON.parse(e),!0}catch{return!1}}function q(e,t){return Object.hasOwn(e,t)}const J={retries:0,retryDelay:1e3,maxRetryDelay:3e4,timeout:1e4,retryOn:[408,429,500,502,503,504],exponentialBackoff:!0,jitter:.1},Ui={timeout:0};var Wi=class{requestInterceptors=[];responseInterceptors=[];useRequestInterceptor(e){this.requestInterceptors.push(e)}useResponseInterceptor(e){this.responseInterceptors.push(e)}async request(e,t={}){let n,r;e instanceof Request?(r=e.url,n={...t,retries:J.retries,url:r,method:e.method||`GET`,headers:Object.fromEntries(e.headers.entries())}):typeof e==`string`||e instanceof URL?(r=e.toString(),n={...t,retries:J.retries,url:r}):(r=e.url,n={...e,...t,retries:t.retries??J.retries}),n.retries=n.retries??J.retries,n.retryDelay=n.retryDelay??J.retryDelay,n.timeout=n.timeout??Ui.timeout,n.method=n.method||`GET`;for(let e of this.requestInterceptors)n=await e(n);if(n.params){let e=new URLSearchParams(n.params).toString();n.url+=(n.url.includes(`?`)?`&`:`?`)+e}let i=0,a=new AbortController,o=t.signal||a.signal,s=async()=>{i++;let e;n.timeout&&n.timeout>0&&(e=setTimeout(()=>{a.abort()},n.timeout));try{let t=new Request(n.url,{method:n.method,headers:n.headers,body:n.body?JSON.stringify(n.body):void 0,signal:o}),r=await fetch(t);e&&clearTimeout(e);let a;switch(n.responseType){case`text`:a=await r.text();break;case`blob`:a=await r.blob();break;case`arrayBuffer`:a=await r.arrayBuffer();break;case`formData`:a=await r.formData();break;case`stream`:if(!r.body)throw Error(`Response body is null`);a=r.body;break;default:a=await r.json();break}let c={data:a,status:r.status,statusText:r.statusText,headers:Object.fromEntries(r.headers.entries()),config:n,ok:r.ok};for(let e of this.responseInterceptors)c=await e(c);return!r.ok&&n.retries>0&&i<n.retries?(await new Promise(e=>setTimeout(e,n.retryDelay)),s()):c}catch(t){if(e&&clearTimeout(e),t.name===`AbortError`)throw Error(`请求超时`);if(n.retries>0&&i<n.retries)return await new Promise(e=>setTimeout(e,n.retryDelay)),s();throw t}};return s()}get(e,t){return this.request(e,{...t,method:`GET`})}post(e,t,n){return this.request(e,{...n,method:`POST`,body:t})}put(e,t,n){return this.request(e,{...n,method:`PUT`,body:t})}delete(e,t){return this.request(e,{...t,method:`DELETE`})}patch(e,t,n){return this.request(e,{...n,method:`PATCH`,body:t})}async fetchJson(e,t){return await this.request(e,{...t,headers:{Accept:`application/json`,...t?.headers}})}async fetchBlob(e,t){let n=await fetch(new Request(e,t));return{data:await n.blob(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchText(e,t){let n=await fetch(new Request(e,t));return{data:await n.text(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchArrayBuffer(e,t){let n=await fetch(new Request(e,t));return{data:await n.arrayBuffer(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchFormData(e,t){let n=await fetch(new Request(e,t));return{data:await n.formData(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchStream(e,t){let n=await fetch(new Request(e,t));if(!n.body)throw Error(`Response body is null`);return{data:n.body,status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}},Gi=class extends Error{constructor(e,t,n,r){super(e),this.message=e,this.status=t,this.response=n,this.attempt=r,this.name=`FetchRetryError`}};function Ki(e,t){let n=t.retryDelay;if(t.exponentialBackoff&&(n*=2**(e-1)),t.jitter>0){let e=t.jitter*Math.random();n*=1+e}return Math.min(n,t.maxRetryDelay)}function qi(e){return new Promise((t,n)=>{setTimeout(()=>{n(new Gi(`请求超时 (${e}ms)`))},e)})}async function Ji(e,t={}){let n={...J,...t,retries:t.retries===1/0?30:Math.min(t.retries||J.retries||0,30)},r=0,i=async()=>{r++;try{let a,o;if(e instanceof Request){o=e.url;let n=e.clone();a=new Request(n,{...n,...t})}else o=e.toString(),a=new Request(o,t);let s=fetch(a),c=n.timeout?qi(n.timeout):null,l=await(c?Promise.race([s,c]):s),u={status:l.status,statusText:l.statusText,headers:Object.fromEntries(l.headers.entries()),data:l,config:{url:o,...t},ok:l.ok};if(n.retries>0&&r<=n.retries&&(typeof n.retryOn==`function`?n.retryOn(l):n.retryOn.includes(l.status))){let e=Ki(r,n);if(n.onRetry&&await n.onRetry(r,e),n.onError){let e=new Gi(`请求失败，状态码 ${u.status}`,u.status,l,r);await n.onError(e,r)}return await new Promise(t=>setTimeout(t,e)),i()}return u}catch(e){let t=e instanceof Gi?e:new Gi(e.message||`请求失败`,void 0,void 0,r);if(n.onError&&await n.onError(t,r),n.retries>0&&r<=n.retries){let e=Ki(r,n);return n.onRetry&&await n.onRetry(r,e),await new Promise(t=>setTimeout(t,e)),i()}throw t}};return i()}new Wi;function Y(e){if(!e)return e;let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return new TextDecoder().decode(n)}function Yi(e,t){let n=t||(e=>e);try{return e?Y(e.toString()):n(e)}catch{return n(e)}}function X(e){if(!e)return e;let t=new TextEncoder().encode(e.trim()),n=``;for(let e=0;e<t.length;e+=1)n+=String.fromCharCode(t[e]);return btoa(n)}function Xi(e,t){let n=t||(e=>e);try{return e?X(e.toString()):n(e)}catch{return n(e)}}var Zi=class{existVps=[];existVpsMap=new Map;constructor(e=[]){this.existVps=e,this.updateExist(this.existVps)}updateExist(e=[]){for(let t of e){let e=this.getParser(t);e&&this.setExistVpsMap(e)}}updateVpsPs(e){let t=this.getParser(e);if(!t)return null;let n=t.originPs,[r,i]=n.split(`#`);if(!i)return e;let a=this.existVpsMap.get(i)||0,o=a===0?n:`${r}#${i} ${a}`;return t.updateOriginConfig(o),this.existVpsMap.set(i,a+1),t.originLink}setExistVpsMap(e){let[,t]=e.originPs.split(`#`);if(!t)return;let[n,r]=t.split(` `),i=r?Number.parseInt(r)>>>0:0,a=this.existVpsMap.get(n)||0;this.existVpsMap.set(n,Math.max(a,i+1))}getParser(e){return e.startsWith(`anytls://`)?new $i(e):e.startsWith(`vless://`)?new aa(e):e.startsWith(`vmess://`)?new oa(e):e.startsWith(`trojan://`)?new ra(e):e.startsWith(`ss://`)?new ta(e):e.startsWith(`ssr://`)?new na(e):e.startsWith(`hysteria2://`)||e.startsWith(`hysteria://`)||e.startsWith(`hy2://`)?new ea(e):e.startsWith(`tuic://`)?new ia(e):null}},Qi=class extends Zi{constructor(e=[]){super(e)}},Z=class extends _t{constructor(){super()}#e=[`localhost`,`127.0.0.1`,`abc.cba.com`];#t=[`AES_256_GCM`,`CHACHA20_POLY1305`,`AES_128_GCM`,`CHACHA20_IETF`];#n=1024;#r=65535;getUUID(){return crypto.randomUUID()}getUsername(){return this.getUUID()}getPassword(){return this.getUUID()}getHost(){return`${this.getHostName()}:${this.getPort()}`}getHostName(){return this.#e[Math.floor(Math.random()*this.#e.length)]}getPort(){return Math.floor(Math.random()*(this.#r-this.#n+1)+this.#n).toString()}getEncrtptionProtocol(){return this.#t[Math.floor(Math.random()*this.#t.length)]}},Q=class e{static#e=`^LINK_TO^`;static#t=new Map;static getPs(t){let n=t.split(e.#e);return[n[0],n[1]]}static setPs(t,n){return[this.formatPs(t),n].join(e.#e)}static formatPs(e){return e?e.replace(/\|/g,`-`):crypto.randomUUID()}static getPrefix(t){if(!t?.includes(e.#e))return null;if(e.#t.has(t))return e.#t.get(t);let[n]=e.getPs(t);if(n){let r=n.trim();return e.#t.set(t,r),r}return null}static isConfigType(e){return e.includes(this.#e)}static clearCache(){this.#t.clear()}},$i=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.password=this.originConfig.username??``,this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams.get(`sni`)??``),this.originConfig.searchParams?.has(`insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`insecure`)===`1`),e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.password=this.originConfig.username??``,e.tls?.server_name&&this.originConfig.searchParams?.has(`sni`)&&(e.tls.server_name=this.originConfig.searchParams.get(`sni`)??``),e.tls&&this.originConfig.searchParams?.has(`insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},ea=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.type===`hysteria2`&&q(e,`password`)&&(e.password=this.originConfig?.searchParams?.get(`password`)??this.originConfig.username??``),e.type===`hysteria2`&&q(e,`auth`)&&(e.auth=this.originConfig?.searchParams?.get(`auth`)??this.originConfig.username??``),q(e,`down`)&&(e.down=e.down===``?this.originConfig.searchParams?.get(`down`)??this.originConfig.searchParams?.get(`downmbps`)??0:e.down,e.down=decodeURIComponent(e.down)),q(e,`up`)&&(e.up=e.up===``?this.originConfig.searchParams?.get(`up`)??this.originConfig.searchParams?.get(`upmbps`)??0:e.up,e.up=decodeURIComponent(e.up)),q(e,`delay`)&&(e.delay=this.originConfig.searchParams?.get(`delay`)??0),this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams?.get(`sni`)??``),this.originConfig.searchParams?.has(`insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`insecure`)===`1`),e}restoreSingbox(e,t){return e.password=this.originConfig?.searchParams?.get(`password`)??``,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.down&&=decodeURIComponent(e.down),e.up&&=decodeURIComponent(e.up),e.tls&&this.originConfig.searchParams?.has(`insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},ta=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){let t=this.toStandard(e);this.#e=t,this.#n=new URL(t),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(this.toStandard(e)),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=`ss://${decodeURIComponent(this.#n.username)}@${this.#r.hostname}:${this.#r.port}${this.#r.search}#${this.#r.hash}`}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig?.port??0),e}restoreSingbox(e,t){return e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}toStandard(e){let t=e.match(/#(.*)$/),n=t?`#${t[1]}`:``,r=e.replace(/#.*$/,``);if(!r.startsWith(`ss://`))return e;let i=r.substring(5);if(i.includes(`@`))return e;try{let e=Y(i),t=e.lastIndexOf(`@`);if(t===-1)throw Error(`Invalid SIP002 format: missing @ separator`);let r=e.substring(0,t),a=e.substring(t+1),o=r.indexOf(`:`);if(o===-1)throw Error(`Invalid user info: missing colon separator`);let s=r.substring(0,o),c=r.substring(o+1),l=a.lastIndexOf(`:`);if(l===-1)throw Error(`Invalid server info: missing port`);let u=a.substring(0,l),d=a.substring(l+1);if(!s||!c||!u||!d)throw Error(`Invalid format: missing required fields`);let f=`ss://${X(`${s}:${c}`)}@${u}:${d}`;return f+=`?type=tcp`,n&&(f+=n),f}catch{return e}}},na=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig()}setOriginConfig(e){let[t,n]=e.match(/ssr:\/\/(.*)/)||[];this.#e=e,this.#n=this.getOriginConfig(Y(n)),this.#i=this.#n.remarks??``,this.#o=this.getTag(this.#n.remarks)??``}getOriginConfig(e){let[t,n,r,i,a,o]=e.split(`:`),s=new URL(e);return{server:t,port:n,protocol:r,method:i,obfs:a,password_base64:o.replace(s.search,``),remarks:Yi(s.searchParams.get(`remarks`)?.replace(`-`,`+`)||``),params:s.search.replace(`?remarks=${s.searchParams.get(`remarks`)}`,``)}}updateOriginConfig(e){this.#n.remarks=e,this.#i=e,this.#e=`ssr://${X(`${this.#n.server}:${this.#n.port}:${this.#n.protocol}:${this.#n.method}:${this.#n.obfs}:${this.#n.password_base64}?remarks=${this.#n.remarks}${this.#n.params}`)}`,this.setConfuseConfig()}setConfuseConfig(){this.#r=structuredClone(this.#n),this.#r.server=this.getHostName(),this.#r.port=this.getPort(),this.#r.remarks=X(Q.setPs(this.#i,this.#a)),this.#t=`ssr://${X(`${this.#r.server}:${this.#r.port}:${this.#r.protocol}:${this.#r.method}:${this.#r.obfs}:${this.#r.password_base64}?remarks=${this.#r.remarks}${this.#r.params}`)}`}restoreClash(e,t){return e.name=t,e.server=this.originConfig.server??``,e.port=Number(this.originConfig?.port??0),e}restoreSingbox(e,t){return e.server=this.originConfig.server??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.add??``),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},ra=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=Q.formatPs(this.#n.hash)??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=Q.formatPs(e),this.#i=Q.formatPs(e),this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.password=this.originConfig?.username??``,e.alpn=e.alpn?e.alpn.map(e=>decodeURIComponent(e)):e.alpn,e}restoreSingbox(e,t){return e.password=this.originConfig?.username??``,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.hostname??``),e.tls?.alpn&&(e.tls.alpn=e.tls.alpn.map(e=>decodeURIComponent(e))),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},ia=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.password=this.getPassword(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.password=this.originConfig.password??``,this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams?.get(`sni`)??``),this.originConfig.searchParams?.has(`allow_insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`allow_insecure`)===`1`),e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.password=this.originConfig.password??``,e.tls?.server_name&&this.originConfig.searchParams?.has(`sni`)&&(e.tls.server_name=this.originConfig.searchParams?.get(`sni`)??``),e.tls&&this.originConfig.searchParams?.has(`allow_insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`allow_insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},aa=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=Q.formatPs(this.#n.hash)??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=Q.formatPs(e),this.#i=Q.formatPs(e),this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Q.setPs(this.#i,this.#a),this.#t=this.#r.href}#s(e){return q(e,`Host`)?{...e,Host:e.Host||this.originConfig.add||``}:e}#c(e){e.network===`ws`&&(e[`ws-opts`]={...e[`ws-opts`],headers:this.#s(e[`ws-opts`].headers),path:decodeURIComponent(this.originConfig.searchParams?.get(`path`)??`/`)})}restoreClash(e,t){return this.#c(e),e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig?.port??0),e.uuid=this.originConfig.username??``,e.alpn=e.alpn?e.alpn?.map(e=>decodeURIComponent(decodeURIComponent(e))):e.alpn,e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.tls?.server_name&&(e.tls.server_name=this.originConfig.hostname??``),e.tls?.alpn&&(e.tls.alpn=e.tls.alpn.map(e=>decodeURIComponent(decodeURIComponent(e)))),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},oa=class extends Z{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig()}setOriginConfig(e){let[t,n]=e.match(/vmess:\/\/(.*)/)||[];this.#e=e,this.#n=JSON.parse(Y(n)),this.#i=this.#n.ps??``,this.#o=this.getTag(this.#n.ps)??``}updateOriginConfig(e){this.#n.ps=e,this.#i=e,this.#e=`vmess://${X(JSON.stringify(this.#n))}`,this.setConfuseConfig()}setConfuseConfig(){this.#r=structuredClone(this.#n),this.#r.add=this.getHostName(),this.#r.port=this.getPort(),this.#r.id=this.getPassword(),this.#r.ps=Q.setPs(this.#i,this.#a),this.#t=`vmess://${X(JSON.stringify(this.#r))}`}#s(e){return q(e,`Host`)?{...e,Host:e.Host||this.originConfig.add||``}:e}#c(e){e.network===`ws`&&(e[`ws-opts`]={...e[`ws-opts`],headers:this.#s(e[`ws-opts`].headers),path:this.originConfig.path})}restoreClash(e,t){return this.#c(e),e.name=t,e.server=this.originConfig.add??``,e.port=Number(this.originConfig?.port??0),e.uuid=this.originConfig?.id??``,q(e,`servername`)&&(e.servername=this.originConfig.add??``),e}restoreSingbox(e,t){return e.server=this.originConfig.add??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.add??``),e.uuid=this.originConfig?.id??``,e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}};function sa(e){if(!e?.server||!e.port||!e.password)throw Error(`AnyTLS configuration object must contain server, port, and password.`);let t=new URLSearchParams,n=(e,n)=>{n!=null&&n!==``&&t.set(e,String(n))};n(`sni`,e.sni??e.servername),n(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),n(`fp`,e[`client-fingerprint`]??e.fingerprint);let r=e.insecure??e[`skip-cert-verify`];typeof r==`boolean`&&t.set(`insecure`,r?`1`:`0`),n(`idle_session_check_interval`,e[`idle-session-check-interval`]??e.idle_session_check_interval),n(`idle_session_timeout`,e[`idle-session-timeout`]??e.idle_session_timeout),n(`min_idle_session`,e[`min-idle-session`]??e.min_idle_session);let i=t.toString(),a=e.name?`#${encodeURIComponent(e.name)}`:``;return`anytls://${encodeURIComponent(e.password)}@${encodeURIComponent(e.server)}:${e.port}${i?`?${i}`:``}${a}`}function ca(e){let t=e.password||e.auth||e.auth_str;if(!e||!e.server||!e.port||!t)throw Error(`Hysteria configuration object must contain server, port, and authentication (password, auth, or auth_str).`);let n=e.server,r=e.port,i=e.name||``,a=new URLSearchParams;a.append(`auth`,t),e.peerCA&&a.append(`peerCA`,X(e.peerCA).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``));let o=e.insecure??e[`skip-cert-verify`];typeof o==`boolean`&&a.append(`insecure`,o?`1`:`0`),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&a.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),e.upmbps!==void 0&&e.upmbps!==null&&a.append(`upmbps`,e.upmbps.toString()),e.downmbps!==void 0&&e.downmbps!==null&&a.append(`downmbps`,e.downmbps.toString()),e.obfs&&a.append(`obfs`,e.obfs),e[`obfs-param`]&&a.append(`obfs-param`,e[`obfs-param`]),q(e,`up`)&&a.append(`up`,e.up),q(e,`down`)&&a.append(`down`,e.down),q(e,`delay`)&&a.append(`delay`,e.delay),q(e,`sni`)&&a.append(`sni`,e.sni);let s=a.toString(),c=encodeURIComponent(n),l=encodeURIComponent(i),u=`hysteria://${c}:${r}`;return s&&(u+=`?${s}`),i&&(u+=`#${l}`),u}function la(e){if(!e||!e.server||!e.port||!e.password)throw Error(`Hysteria2 configuration object must contain server, port, and password.`);let t=e.server,n=e.port,r=e.password,i=e.name||``,a=new URLSearchParams;a.append(`password`,r);let o=e.sni||e.servername||e.server;o&&a.append(`sni`,o);let s=e.insecure??e[`skip-cert-verify`];typeof s==`boolean`&&a.append(`insecure`,s?`1`:`0`),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&a.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),e.obfs&&a.append(`obfs`,e.obfs),e[`obfs-param`]&&a.append(`obfs-param`,e[`obfs-param`]),e[`obfs-password`]&&a.append(`obfs-password`,e[`obfs-password`]);let c=a.toString(),l=encodeURIComponent(t),u=encodeURIComponent(i),d=`hysteria2://${l}:${n}`;return c&&(d+=`?${c}`),i&&(d+=`#${u}`),d}function ua(e){if(!e||!e.server||!e.port||!e.cipher||!e.password)throw Error(`Shadowsocks configuration object must contain server, port, cipher, and password.`);let t=e.cipher,n=e.password,r=e.server,i=e.port,a=e.name||``,o=X(`${t}:${n}`),s=new URLSearchParams,c=e.network||`tcp`;if((c!==`tcp`||e.network)&&s.append(`type`,c),e.tls){s.append(`security`,`tls`);let t=e.sni||e.servername||e.server;t&&s.append(`sni`,t),e[`client-fingerprint`]&&s.append(`fp`,e[`client-fingerprint`]),e[`skip-cert-verify`]&&s.append(`allowInsecure`,`1`)}switch(c){case`ws`:case`http`:{let t=e[`ws-opts`]||e[`http-opts`]||{},n;n=t.headers&&t.headers.Host?t.headers.Host:e.sni||e.servername?e.sni||e.servername:e.server,n&&s.append(`host`,n);let r=t.path||`/`;r!==`/`&&s.append(`path`,r);break}case`grpc`:{let t=e[`grpc-opts`]||{};t.serviceName&&s.append(`serviceName`,t.serviceName);break}}e.tfo&&s.append(`tfo`,`1`),e.udp&&s.append(`udp`,`1`);let l=`ss://${o}@${encodeURIComponent(r)}:${i}`,u=s.toString();return u&&(l+=`?${u}`),a&&(l+=`#${encodeURIComponent(a)}`),l}function da(e){return X(e).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}function fa(e){if(!e||!e.server||!e.port||!e.protocol||!e.method||!e.obfs||!e.password)throw Error(`ShadowsocksR configuration object must contain server, port, protocol, method, obfs, and password.`);let t=e.server,n=e.port,r=e.protocol,i=e.method||e.cipher,a=e.obfs,o=e.password,s=e[`obfs-param`]||``,c=e[`protocol-param`]||``,l=e.name||``,u=`${t}:${n}:${r}:${i}:${a}:${da(o)}/`,d=new URLSearchParams;if(s){let e=da(s);d.append(`obfsparam`,e)}if(c){let e=da(c);d.append(`protoparam`,e)}let f=d.toString();f&&(u+=`?${f}`);let p=da(u),m=encodeURIComponent(l),h=`ssr://${p}`;return l&&(h+=`#${m}`),h}function pa(e){if(!e||!e.server||!e.port||!e.password)throw Error(`Trojan configuration object must contain server, port, and password.`);let t=e.password,n=e.server,r=e.port,i=e.name||``,a=new URLSearchParams,o=e.sni||e.servername||e.server;o&&a.append(`sni`,o),e[`skip-cert-verify`]&&a.append(`allowInsecure`,`1`);let s=e.network||`tcp`;switch(a.append(`type`,s),s){case`ws`:case`http`:{let t=e[`ws-opts`]||e[`http-opts`]||{},n;n=t.headers&&t.headers.Host?t.headers.Host:e.sni||e.servername?e.sni||e.servername:e.server,n&&a.append(`host`,n);let r=t.path||`/`;r!==`/`&&a.append(`path`,r);break}case`grpc`:{let t=e[`grpc-opts`]||{};t.serviceName&&a.append(`serviceName`,t.serviceName);break}}e.flow&&a.append(`flow`,e.flow),e.tfo&&a.append(`tfo`,`1`),e.udp&&a.append(`udp`,`1`),e[`client-fingerprint`]&&a.append(`fp`,e[`client-fingerprint`]);let c=`trojan://${encodeURIComponent(t)}@${encodeURIComponent(n)}:${r}`,l=a.toString();return l&&(c+=`?${l}`),i&&(c+=`#${encodeURIComponent(i)}`),c}function ma(e){if(!e||!e.server||!e.port||!e.uuid)throw Error(`TUIC configuration object must contain server, port, and uuid.`);let t=e.server,n=e.port,r=e.uuid,i=e.password??``,a=e.name||``,o=new URLSearchParams,s=e[`congestion-controller`]||e.congestion_control;s&&o.append(`congestion_control`,s);let c=e[`udp-relay-mode`]||e.udp_relay_mode;c&&o.append(`udp_relay_mode`,c),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&o.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn);let l=e.sni||e.servername;l&&o.append(`sni`,l);let u=e.insecure??e[`skip-cert-verify`];typeof u==`boolean`&&o.append(`allow_insecure`,u?`1`:`0`),e[`disable-sni`]&&o.append(`disable_sni`,`1`);let d=o.toString(),f=`${encodeURIComponent(r)}:${encodeURIComponent(i)}`,p=encodeURIComponent(t),m=encodeURIComponent(a),h=`tuic://${f}@${p}:${n}`;return d&&(h+=`?${d}`),a&&(h+=`#${m}`),h}function ha(e){if(e.type!==`vless`)throw Error(`Configuration type must be "vless"`);if(!e.uuid||!e.server||!e.port)throw Error(`Missing required fields: uuid, server, or port`);let t=e.uuid,n=e.server,r=e.port,i=`#${encodeURIComponent(e.name||`vless-node`)}`,a=new URLSearchParams,o=e.network||`tcp`,s=`none`;if(e.security===`reality`||e[`reality-opts`]?s=`reality`:(e.security===`tls`||e.tls===!0)&&(s=`tls`),(o!==`tcp`||o===`tcp`&&e[`tcp-opts`]?.header?.type&&e[`tcp-opts`].header.type!==`none`)&&a.set(`type`,o),s===`tls`){a.set(`security`,`tls`),e.servername&&a.set(`sni`,e.servername),Array.isArray(e.alpn)&&e.alpn.length>0&&a.set(`alpn`,encodeURIComponent(e.alpn.join(`,`)));let t=e[`client-fingerprint`]||e.fingerprint;t&&a.set(`fp`,encodeURIComponent(t)),e[`skip-cert-verify`]===!0&&a.set(`allowInsecure`,`1`),e.flow&&a.set(`flow`,e.flow)}else if(s===`reality`){a.set(`security`,`reality`),e.servername&&a.set(`sni`,e.servername);let t=e[`reality-opts`]||{},n=t[`public-key`]||t.publicKey,r=t[`short-id`]||t.shortId;n&&a.set(`pbk`,encodeURIComponent(n)),r&&a.set(`sid`,encodeURIComponent(r));let i=e[`client-fingerprint`]||e.fingerprint;i&&a.set(`fp`,encodeURIComponent(i))}switch(o){case`tcp`:e[`tcp-opts`]?.header?.type&&e[`tcp-opts`].header.type!==`none`&&a.set(`headerType`,e[`tcp-opts`].header.type);break;case`ws`:e[`ws-opts`]&&(e[`ws-opts`].headers?.Host&&a.set(`host`,e[`ws-opts`].headers.Host),e[`ws-opts`].path&&a.set(`path`,encodeURIComponent(e[`ws-opts`].path)));break;case`grpc`:if(e[`grpc-opts`]){(e[`grpc-opts`][`grpc-mode`]||e[`grpc-opts`].mode)===`multi`&&a.set(`mode`,`multi`);let t=e[`grpc-opts`][`grpc-service-name`];t&&a.set(`serviceName`,encodeURIComponent(t))}break;case`quic`:s!==`tls`&&s!==`reality`&&(a.has(`security`)||a.set(`security`,`tls`)),e[`quic-opts`]&&(e[`quic-opts`].security&&e[`quic-opts`].security!==`none`&&a.set(`quicSecurity`,encodeURIComponent(e[`quic-opts`].security)),e[`quic-opts`].key&&a.set(`key`,encodeURIComponent(e[`quic-opts`].key)),e[`quic-opts`].header?.type&&e[`quic-opts`].header.type!==`none`&&a.set(`headerType`,e[`quic-opts`].header.type));break;case`httpupgrade`:e[`httpupgrade-opts`]&&(e[`httpupgrade-opts`].host&&a.set(`host`,e[`httpupgrade-opts`].host),e[`httpupgrade-opts`].path&&a.set(`path`,encodeURIComponent(e[`httpupgrade-opts`].path)));break;case`h2`:if(s!==`tls`&&s!==`reality`&&(a.has(`security`)||a.set(`security`,`tls`)),e[`h2-opts`]){let t=e[`h2-opts`].host;Array.isArray(t)&&t.length>0?a.set(`host`,encodeURIComponent(t.join(`,`))):typeof t==`string`&&a.set(`host`,encodeURIComponent(t)),e[`h2-opts`].path&&a.set(`path`,encodeURIComponent(e[`h2-opts`].path))}break;default:console.warn(`Unsupported network type for URL generation: ${o}`)}e.tfo===!0&&a.set(`tfo`,`1`);let c=a.toString();return`vless://${t}@${n}:${r}${c?`?${c}`:``}${i}`}function ga(e){if(!e||!e.server||!e.port||!e.uuid)throw Error(`Vmess configuration object must contain server, port, and uuid.`);let t={v:`2`,ps:e.name||``,add:e.server,port:e.port,id:e.uuid,aid:e.alterId||0,scy:e.cipher||`auto`,net:e.network||`tcp`};switch(e.tls?(t.tls=`tls`,t.sni=e.servername||e.server,e[`client-fingerprint`]&&(t.fp=e[`client-fingerprint`])):t.tls=``,t.net){case`ws`:case`http`:{let n=e[`ws-opts`]||e[`http-opts`]||{};n.headers&&n.headers.Host?t.host=n.headers.Host:t.sni?t.host=t.sni:t.host=t.add,t.path=n.path||`/`,t.net===`http`&&!e.tls?t.type=`http`:t.net===`ws`&&!e.tls&&(t.type=`ws`);break}case`tcp`:e.tls||(t.type=`none`);break;case`grpc`:e[`grpc-opts`]&&e[`grpc-opts`].serviceName&&(t.serviceName=e[`grpc-opts`].serviceName),t.type=`grpc`;break}return(t.type===`none`||t.net===t.type&&!e.tls)&&delete t.type,t.tfo=e.tfo?`1`:`0`,t.udp=e.udp?`1`:`0`,`vmess://${X(JSON.stringify(t))}`}function _a(e){let t=[];for(let n of e)try{n.type===`anytls`&&t.push(sa(n)),n.type===`vmess`&&t.push(ga(n)),n.type===`trojan`&&t.push(pa(n)),n.type===`vless`&&t.push(ha(n)),n.type===`ss`&&t.push(ua(n)),n.type===`ssr`&&t.push(fa(n)),(n.type===`hysteria2`||n.type===`hy2`)&&t.push(la(n)),n.type===`hysteria`&&t.push(ca(n)),n.type===`tuic`&&t.push(ma(n))}catch{continue}return t}var va=class extends Qi{urlSet=new Set;vpsStore=new Map;originUrls=new Set;vps=[];includeProtocol=[];excludeTag=[];constructor(e,t=[],n=``,r=``){super(t),this.vps=e,this.includeProtocol=n?JSON.parse(n):[],this.excludeTag=r?JSON.parse(r):[]}async parse(e=this.vps){for await(let t of e)try{let e=this.updateVpsPs(t);if(e){let t=null;e.startsWith(`anytls://`)&&this.hasProtocol(`anytls`)?t=new $i(e):e.startsWith(`vless://`)&&this.hasProtocol(`vless`)?t=new aa(e):e.startsWith(`vmess://`)&&this.hasProtocol(`vmess`)?t=new oa(e):e.startsWith(`trojan://`)&&this.hasProtocol(`trojan`)?t=new ra(e):e.startsWith(`ss://`)&&this.hasProtocol(`shadowsocks`)?t=new ta(e):e.startsWith(`ssr://`)&&this.hasProtocol(`shadowsocksr`)?t=new na(e):this.isHysteria2(e)&&this.hasProtocol(`hysteria`,`hysteria2`,`hy2`)?t=new ea(e):e.startsWith(`tuic://`)&&this.hasProtocol(`tuic`)&&(t=new ia(e)),t&&this.setStore(e,t)}if(t.startsWith(`https://`)||t.startsWith(`http://`)){let e=await Ji(t,{retries:3}).then(async e=>e.data.text()),{subType:n,content:r}=this.getSubType(e);if(n===`base64`&&r&&(this.updateExist(Array.from(this.originUrls)),await this.parse(r.split(`
`).filter(Boolean))),n===`yaml`&&r){let e=r.proxies;if(e.length){this.updateExist(Array.from(this.originUrls));let t=_a(e);await this.parse(t.filter(Boolean))}}}}catch{continue}}setStore(e,t){let n=t.tag;n&&this.excludeTag.includes(n)||(this.urlSet.add(t.confuseLink),this.originUrls.add(e),this.vpsStore.set(t.confusePs,t))}getSubType(e){try{return{subType:`base64`,content:Y(e)}}catch{try{return{subType:`yaml`,content:zi(e)}}catch{try{let t=JSON.parse(e);return{subType:`json`,content:JSON.stringify(t)}}catch{return{subType:`unknown`,content:e}}}}}isHysteria2(e){return e.startsWith(`hysteria2://`)||e.startsWith(`hysteria://`)||e.startsWith(`hy2://`)}hasProtocol(...e){return this.includeProtocol.length===0||e.some(e=>this.includeProtocol.includes(e))}get urls(){return Array.from(this.urlSet)}get vpsMap(){return this.vpsStore}get originVps(){return Array.from(this.originUrls)}},ya=class{async getConfig(e){try{let t=(await Promise.all(e.map(e=>Ji(e,{retries:3}).then(e=>e.data.text())))).map(e=>zi(e));return this.mergeClashConfig(t)}catch(e){throw Error(`Failed to get clash config: ${e.message||e}`)}}isSameProxies(e,t){if(e.length!==t.length)return!1;let n=new Set(e);return t.every(e=>n.has(e))}mergeGroupProxies(e,t){let n=new Set(e),r=[...e];for(let e of t)n.has(e)||(n.add(e),r.push(e));return r}mergeClashConfig(e=[]){try{if(!e.length)return{};if(e.length===1)return e[0];let t=[];for(let n of e)n.proxies?.length&&t.push(...n.proxies);let n=new Map,r=[];for(let t of e)if(t[`proxy-groups`]?.length)for(let e of t[`proxy-groups`]){let t=n.get(e.name);if(!t)n.set(e.name,{...e,proxies:[...e.proxies||[]]}),r.push(e.name);else{let n=t.proxies||[],r=e.proxies||[];this.isSameProxies(n,r)||(t.proxies=this.mergeGroupProxies(n,r))}}return{...e[0],proxies:t,"proxy-groups":r.map(e=>n.get(e))}}catch(e){throw Error(`Failed to merge clash config: ${e.message||e}`)}}},ba=class{async getConfig(e){try{let t=(await Promise.all(e.map(e=>Ji(e,{retries:3}).then(e=>e.data.text())))).filter(e=>Hi(e)).map(e=>JSON.parse(e));return this.mergeConfig(t)}catch(e){throw Error(`Failed to get singbox config: ${e.message||e}`)}}mergeConfig(e){try{if(e.length===0)return{};let t=structuredClone(e[0]),n=[],r=new Set,i=new Map;for(let t of e)if(t.outbounds?.length){for(let e of t.outbounds)if(e.outbounds){let t=`${e.type}:${e.tag}`;if(!i.has(t)){let n=new Set(e.outbounds.filter(e=>!Q.isConfigType(e)));i.set(t,{base:e,baseOutbounds:n,linkOutbounds:new Set})}e.outbounds.forEach(e=>{Q.isConfigType(e)&&i.get(t)?.linkOutbounds.add(e)})}}for(let t of e)if(t.outbounds?.length){for(let e of t.outbounds)if(!e.outbounds)if(Q.isConfigType(e.tag))n.push(e);else{let t=`${e.type}:${e.tag}`;r.has(t)||(r.add(t),n.push(e))}}for(let[e,t]of i){let e={...t.base},r=new Set([...t.baseOutbounds,...t.linkOutbounds]);e.outbounds=Array.from(r),n.push(e)}return t.outbounds=n,t}catch(e){throw Error(`Failed to merge singbox config: ${e.message||e}`)}}},xa=class extends va{async getConfig(e,t){try{return await this.parse(t),Xi(this.originVps.join(`
`))}catch(e){throw Error(`Failed to get v2ray config: ${e.message||e}`)}}},Sa=class{urls=[];vps=[];chunkCount=Number(K.CHUNK_COUNT);backend=K.BACKEND;parser=null;clashClient=new ya;singboxClient=new ba;v2rayClient=new xa(this.vps);constructor(e){this.chunkCount=Number(e.CHUNK_COUNT??K.CHUNK_COUNT),this.backend=e.BACKEND??K.BACKEND,this.parser=null}async setSubUrls(e){let{searchParams:t}=new URL(e.url),n=t.get(`url`),r=t.get(`protocol`),i=t.get(`exclude`);this.backend=t.get(`backend`)??this.backend;let a=n.split(/\||\n/).filter(Boolean);this.parser=new va(a,[],r,i),this.vps=a,await this.parser.parse(a);let o=Vi(Array.from(this.parser.urls),Number(this.chunkCount));this.urls=o.map(t=>{let n=new URL(`${this.backend}/sub`),{searchParams:r}=new URL(e.url);return r.set(`url`,t),n.search=r.toString(),n.toString()})}async getClashConfig(){return await this.clashClient.getConfig(this.urls)}async getSingboxConfig(){return await this.singboxClient.getConfig(this.urls)}async getV2RayConfig(){return await this.v2rayClient.getConfig(this.urls,this.vps)}get vpsStore(){return this.parser?.vpsMap}},Ca=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(e){try{return this.confuseConfig.proxies=this.restoreProxies(this.confuseConfig.proxies,e),this.confuseConfig[`proxy-groups`]=this.confuseConfig?.[`proxy-groups`]?.map(e=>(e.proxies&&=this.updateProxiesGroups(e.proxies),e)),this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}restoreProxies(e,t){let n=[];if(!e)return n;for(let r of e)try{let[e,i]=Q.getPs(r.name);t.has(i)&&(t.get(i)?.restoreClash(r,e),n.push(r))}catch(e){console.warn(`Restore proxies failed: ${e.message||e}, function trace: ${e.stack}`);continue}return n}updateProxiesGroups(e){try{return e.map(e=>{let[t]=Q.getPs(e);return t})}catch(e){throw Error(`Update proxies groups failed: ${e.message||e}, function trace: ${e.stack}`)}}},wa=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(e){try{return this.confuseConfig.outbounds=this.restoreOutbounds(this.confuseConfig.outbounds,e),this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}restoreOutbounds(e=[],t){let n=[];if(!e)return n;for(let r of e)try{if(this.isConfuseVps(r.tag)){let[e,n]=Q.getPs(r.tag);t.get(n)?.restoreSingbox(r,e)}Reflect.has(r,`outbounds`)&&(r.outbounds=this.updateOutbouns(r.outbounds)),n.push(r)}catch(e){console.warn(`Restore outbounds failed: ${e.message||e}, function trace: ${e.stack}`);continue}return n}updateOutbouns(e=[]){try{return e.map(e=>{if(this.isConfuseVps(e)){let[t]=Q.getPs(e);return t}return e})}catch(e){throw Error(`Update outbounds failed: ${e.message||e}, function trace: ${e.stack}`)}}isConfuseVps(e){return Q.isConfigType(e)}},Ta=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(){try{return this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}},Ea=class{constructor(e){this.confuse=e,this.confuse=e}async getClashConfig(){return new Ca(await this.confuse.getClashConfig()).getOriginConfig(this.confuse.vpsStore)}async getSingboxConfig(){return new wa(await this.confuse.getSingboxConfig()).getOriginConfig(this.confuse.vpsStore)}async getV2RayConfig(){return new Ta(await this.confuse.getV2RayConfig()).getOriginConfig()}},Da=class{constructor(e){this.repo=e}async toSub(e,t,n){let r=new Sa(t);await r.setSubUrls(e);let i=new Ea(r);if([`clash`,`clashr`].includes(n))return{body:Bi(await i.getClashConfig(),{indent:2,lineWidth:200}),contentType:`text/yaml; charset=UTF-8`};if(n===`singbox`){let e=await i.getSingboxConfig();return{body:JSON.stringify(e),contentType:`text/plain; charset=UTF-8`}}if(n===`v2ray`)return{body:await i.getV2RayConfig(),contentType:`text/plain; charset=UTF-8`};throw Error(`Unsupported client type, support list: clash, singbox, v2ray`)}getVersionRedirect(e,t){let{searchParams:n}=new URL(e.url);return`${n.get(`backend`)??t.BACKEND??K.BACKEND}/version`}async add(e,t){return this.ensureRepo(),this.repo.add(e,t)}async deleteByCode(e){return this.ensureRepo(),this.repo.deleteByCode(e)}async getByCode(e){return this.ensureRepo(),this.repo.getByCode(e)}async getList(e=1,t=10){return this.ensureRepo(),this.repo.getList(e,t)}ensureRepo(){if(!this.repo)throw Error(`Short URL service is not enabled (no repository configured)`)}};const $=new ze;function Oa(e){let n=e.get(`repo`);if(!n)throw new t(503,{message:`Short URL service is not enabled`});return new wt(new Da(n))}$.post(`/api/add`,e=>Oa(e).add(e)),$.delete(`/api/delete`,e=>Oa(e).delete(e)),$.get(`/api/queryByCode`,e=>Oa(e).queryByCode(e)),$.get(`/api/queryList`,e=>Oa(e).queryList(e)),$.get(`/:code`,e=>Oa(e).redirect(e));const ka=new ze;ka.get(`/sub`,e=>new wt(new Da(e.get(`repo`))).toSub(e)),ka.get(`/version`,e=>new wt(new Da(e.get(`repo`))).getVersion(e));function Aa(e){e.route(`/`,Ct),e.route(`/`,ka),e.route(`/`,$)}function ja(e){let t=new ze;return t.use(`*`,Xe()),t.use(`*`,Ve()),t.use(`*`,Ze(e.repo)),t.onError(He),t.notFound(e=>e.json({error:`Not Found`},404)),Aa(t),t}function Ma(){return crypto.randomUUID().substring(0,8)}var Na=class{constructor(e){this.db=e}async add(e,t){let n=Ma(),r=`${t}/${n}`,i=await this.db.prepare(`INSERT INTO short_url (short_code, short_url, long_url) VALUES (?, ?, ?) RETURNING id`).bind(n,r,e).first();if(!i?.id)throw Error(`Failed to create short URL`);return{id:i.id,short_code:n,short_url:r,long_url:e}}async deleteByCode(e){await this.db.prepare(`DELETE FROM short_url WHERE short_code = ?`).bind(e).run()}async getByCode(e){return await this.db.prepare(`SELECT id, short_code, short_url, long_url FROM short_url WHERE short_code = ?`).bind(e).first()}async getList(e,t){let n=(e-1)*t,[r,i]=await Promise.all([this.db.prepare(`SELECT COUNT(*) as count FROM short_url`).first(),this.db.prepare(`SELECT id, short_code, short_url, long_url FROM short_url LIMIT ? OFFSET ?`).bind(t,n).all()]);return{total:r?.count||0,items:i?.results||[]}}};function Pa(e){return e?new Na(e):null}var Fa={fetch(e,t,n){let r=Pa(t.DB),i=ja({repo:r}),a={...t,SHORT_URL_ENABLED:r!==null};return i.fetch(e,a,n)}};export{Fa as default};