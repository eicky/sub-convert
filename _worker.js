var e=(e,t,n)=>(r,i)=>{let a=-1;return o(0);async function o(s){if(s<=a)throw Error(`next() called multiple times`);a=s;let c,l=!1,u;if(e[s]?(u=e[s][0][0],r.req.routeIndex=s):u=s===e.length&&i||void 0,u)try{c=await u(r,()=>o(s+1))}catch(e){if(e instanceof Error&&t)r.error=e,c=await t(e,r),l=!0;else throw e}else r.finalized===!1&&n&&(c=await n(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},t=class extends Error{res;status;constructor(e=500,t){super(t?.message,{cause:t?.cause}),this.res=t?.res,this.status=e}getResponse(){return this.res?new Response(this.res.body,{status:this.status,headers:this.res.headers}):new Response(this.message,{status:this.status})}},n=Symbol(),r=async(e,t=Object.create(null))=>{let{all:n=!1,dot:r=!1}=t,a=(e instanceof se?e.raw.headers:e.headers).get(`Content-Type`);return a?.startsWith(`multipart/form-data`)||a?.startsWith(`application/x-www-form-urlencoded`)?i(e,{all:n,dot:r}):{}};async function i(e,t){let n=await e.formData();return n?a(n,t):{}}function a(e,t){let n=Object.create(null);return e.forEach((e,r)=>{t.all||r.endsWith(`[]`)?o(n,r,e):n[r]=e}),t.dot&&Object.entries(n).forEach(([e,t])=>{e.includes(`.`)&&(s(n,e,t),delete n[e])}),n}var o=(e,t,n)=>{e[t]===void 0?t.endsWith(`[]`)?e[t]=[n]:e[t]=n:Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]},s=(e,t,n)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=e,i=t.split(`.`);i.forEach((e,t)=>{t===i.length-1?r[e]=n:((!r[e]||typeof r[e]!=`object`||Array.isArray(r[e])||r[e]instanceof File)&&(r[e]=Object.create(null)),r=r[e])})},c=e=>{let t=e.split(`/`);return t[0]===``&&t.shift(),t},l=e=>{let{groups:t,path:n}=u(e);return d(c(n),t)},u=e=>{let t=[];return e=e.replace(/\{[^}]+\}/g,(e,n)=>{let r=`@${n}`;return t.push([r,e]),r}),{groups:t,path:e}},d=(e,t)=>{for(let n=t.length-1;n>=0;n--){let[r]=t[n];for(let i=e.length-1;i>=0;i--)if(e[i].includes(r)){e[i]=e[i].replace(r,t[n][1]);break}}return e},f={},p=(e,t)=>{if(e===`*`)return`*`;let n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){let r=`${e}#${t}`;return f[r]||(n[2]?f[r]=t&&t[0]!==`:`&&t[0]!==`*`?[r,n[1],RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],RegExp(`^${n[2]}$`)]:f[r]=[e,n[1],!0]),f[r]}return null},m=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},h=e=>m(e,decodeURI),g=e=>{let t=e.url,n=t.indexOf(`/`,t.indexOf(`:`)+4),r=n;for(;r<t.length;r++){let e=t.charCodeAt(r);if(e===37){let e=t.indexOf(`?`,r),i=t.indexOf(`#`,r),a=e===-1?i===-1?void 0:i:i===-1?e:Math.min(e,i),o=t.slice(n,a);return h(o.includes(`%25`)?o.replace(/%25/g,`%2525`):o)}else if(e===63||e===35)break}return t.slice(n,r)},_=e=>{let t=g(e);return t.length>1&&t.at(-1)===`/`?t.slice(0,-1):t},v=(e,t,...n)=>(n.length&&(t=v(t,...n)),`${e?.[0]===`/`?``:`/`}${e}${t===`/`?``:`${e?.at(-1)===`/`?``:`/`}${t?.[0]===`/`?t.slice(1):t}`}`),ee=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(`:`))return null;let t=e.split(`/`),n=[],r=``;return t.forEach(e=>{if(e!==``&&!/\:/.test(e))r+=`/`+e;else if(/\:/.test(e))if(/\?/.test(e)){n.length===0&&r===``?n.push(`/`):n.push(r);let t=e.replace(`?`,``);r+=`/`+t,n.push(r)}else r+=`/`+e}),n.filter((e,t,n)=>n.indexOf(e)===t)},te=e=>/[%+]/.test(e)?(e.indexOf(`+`)!==-1&&(e=e.replace(/\+/g,` `)),e.indexOf(`%`)===-1?e:m(e,ae)):e,ne=(e,t,n)=>{let r;if(!n&&t&&!/[%+]/.test(t)){let n=e.indexOf(`?`,8);if(n===-1)return;for(e.startsWith(t,n+1)||(n=e.indexOf(`&${t}`,n+1));n!==-1;){let r=e.charCodeAt(n+t.length+1);if(r===61){let r=n+t.length+2,i=e.indexOf(`&`,r);return te(e.slice(r,i===-1?void 0:i))}else if(r==38||isNaN(r))return``;n=e.indexOf(`&${t}`,n+1)}if(r=/[%+]/.test(e),!r)return}let i={};r??=/[%+]/.test(e);let a=e.indexOf(`?`,8);for(;a!==-1;){let t=e.indexOf(`&`,a+1),o=e.indexOf(`=`,a);o>t&&t!==-1&&(o=-1);let s=e.slice(a+1,o===-1?t===-1?void 0:t:o);if(r&&(s=te(s)),a=t,s===``)continue;let c;o===-1?c=``:(c=e.slice(o+1,t===-1?void 0:t),r&&(c=te(c))),n?(i[s]&&Array.isArray(i[s])||(i[s]=[]),i[s].push(c)):i[s]??=c}return t?i[t]:i},re=ne,ie=(e,t)=>ne(e,t,!0),ae=decodeURIComponent,oe=e=>m(e,ae),se=class{raw;#e;#t;routeIndex=0;path;bodyCache={};constructor(e,t=`/`,n=[[]]){this.raw=e,this.path=t,this.#t=n,this.#e={}}param(e){return e?this.#n(e):this.#r()}#n(e){let t=this.#t[0][this.routeIndex][1][e],n=this.#i(t);return n&&/\%/.test(n)?oe(n):n}#r(){let e={},t=Object.keys(this.#t[0][this.routeIndex][1]);for(let n of t){let t=this.#i(this.#t[0][this.routeIndex][1][n]);t!==void 0&&(e[n]=/\%/.test(t)?oe(t):t)}return e}#i(e){return this.#t[1]?this.#t[1][e]:e}query(e){return re(this.url,e)}queries(e){return ie(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;let t={};return this.raw.headers.forEach((e,n)=>{t[n]=e}),t}async parseBody(e){return r(this,e)}#a=e=>{let{bodyCache:t,raw:n}=this,r=t[e];if(r)return r;let i=Object.keys(t)[0];return i?t[i].then(t=>(i===`json`&&(t=JSON.stringify(t)),new Response(t)[e]())):t[e]=n[e]()};json(){return this.#a(`text`).then(e=>JSON.parse(e))}text(){return this.#a(`text`)}arrayBuffer(){return this.#a(`arrayBuffer`)}blob(){return this.#a(`blob`)}formData(){return this.#a(`formData`)}addValidatedData(e,t){this.#e[e]=t}valid(e){return this.#e[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[n](){return this.#t}get matchedRoutes(){return this.#t[0].map(([[,e]])=>e)}get routePath(){return this.#t[0].map(([[,e]])=>e)[this.routeIndex].path}},ce={Stringify:1,BeforeStream:2,Stream:3},le=(e,t)=>{let n=new String(e);return n.isEscaped=!0,n.callbacks=t,n},ue=async(e,t,n,r,i)=>{typeof e==`object`&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));let a=e.callbacks;if(!a?.length)return Promise.resolve(e);i?i[0]+=e:i=[e];let o=Promise.all(a.map(e=>e({phase:t,buffer:i,context:r}))).then(e=>Promise.all(e.filter(Boolean).map(e=>ue(e,t,!1,r,i))).then(()=>i[0]));return n?le(await o,a):o},de=`text/plain; charset=UTF-8`,fe=(e,t)=>({"Content-Type":e,...t}),pe=(e,t)=>new Response(e,t),me=class{#e;#t;env={};#n;finalized=!1;error;#r;#i;#a;#o;#s;#c;#l;#u;#d;constructor(e,t){this.#e=e,t&&(this.#i=t.executionCtx,this.env=t.env,this.#c=t.notFoundHandler,this.#d=t.path,this.#u=t.matchResult)}get req(){return this.#t??=new se(this.#e,this.#d,this.#u),this.#t}get event(){if(this.#i&&`respondWith`in this.#i)return this.#i;throw Error(`This context has no FetchEvent`)}get executionCtx(){if(this.#i)return this.#i;throw Error(`This context has no ExecutionContext`)}get res(){return this.#a||=pe(null,{headers:this.#l??=new Headers})}set res(e){if(this.#a&&e){e=pe(e.body,e);for(let[t,n]of this.#a.headers.entries())if(t!==`content-type`)if(t===`set-cookie`){let t=this.#a.headers.getSetCookie();e.headers.delete(`set-cookie`);for(let n of t)e.headers.append(`set-cookie`,n)}else e.headers.set(t,n)}this.#a=e,this.finalized=!0}render=(...e)=>(this.#s??=e=>this.html(e),this.#s(...e));setLayout=e=>this.#o=e;getLayout=()=>this.#o;setRenderer=e=>{this.#s=e};header=(e,t,n)=>{this.finalized&&(this.#a=pe(this.#a.body,this.#a));let r=this.#a?this.#a.headers:this.#l??=new Headers;t===void 0?r.delete(e):n?.append?r.append(e,t):r.set(e,t)};status=e=>{this.#r=e};set=(e,t)=>{this.#n??=new Map,this.#n.set(e,t)};get=e=>this.#n?this.#n.get(e):void 0;get var(){return this.#n?Object.fromEntries(this.#n):{}}#f(e,t,n){let r=this.#a?new Headers(this.#a.headers):this.#l??new Headers;if(typeof t==`object`&&`headers`in t){let e=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(let[t,n]of e)t.toLowerCase()===`set-cookie`?r.append(t,n):r.set(t,n)}if(n)for(let[e,t]of Object.entries(n))if(typeof t==`string`)r.set(e,t);else{r.delete(e);for(let n of t)r.append(e,n)}return pe(e,{status:typeof t==`number`?t:t?.status??this.#r,headers:r})}newResponse=(...e)=>this.#f(...e);body=(e,t,n)=>this.#f(e,t,n);text=(e,t,n)=>!this.#l&&!this.#r&&!t&&!n&&!this.finalized?new Response(e):this.#f(e,t,fe(de,n));json=(e,t,n)=>this.#f(JSON.stringify(e),t,fe(`application/json`,n));html=(e,t,n)=>{let r=e=>this.#f(e,t,fe(`text/html; charset=UTF-8`,n));return typeof e==`object`?ue(e,ce.Stringify,!1,{}).then(r):r(e)};redirect=(e,t)=>{let n=String(e);return this.header(`Location`,/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)};notFound=()=>(this.#c??=()=>pe(),this.#c(this))},he=[`get`,`post`,`put`,`delete`,`options`,`patch`],ge=`Can not add a route since the matcher is already built.`,_e=class extends Error{},ve=`__COMPOSED_HANDLER`,ye=e=>e.text(`404 Not Found`,404),be=(e,t)=>{if(`getResponse`in e){let n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text(`Internal Server Error`,500)},xe=class t{get;post;put;delete;options;patch;all;on;use;router;getPath;_basePath=`/`;#e=`/`;routes=[];constructor(e={}){[...he,`all`].forEach(e=>{this[e]=(t,...n)=>(typeof t==`string`?this.#e=t:this.#r(e,this.#e,t),n.forEach(t=>{this.#r(e,this.#e,t)}),this)}),this.on=(e,t,...n)=>{for(let r of[t].flat()){this.#e=r;for(let t of[e].flat())n.map(e=>{this.#r(t.toUpperCase(),this.#e,e)})}return this},this.use=(e,...t)=>(typeof e==`string`?this.#e=e:(this.#e=`*`,t.unshift(e)),t.forEach(e=>{this.#r(`ALL`,this.#e,e)}),this);let{strict:t,...n}=e;Object.assign(this,n),this.getPath=t??!0?e.getPath??g:_}#t(){let e=new t({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,e.#n=this.#n,e.routes=this.routes,e}#n=ye;errorHandler=be;route(t,n){let r=this.basePath(t);return n.routes.map(t=>{let i;n.errorHandler===be?i=t.handler:(i=async(r,i)=>(await e([],n.errorHandler)(r,()=>t.handler(r,i))).res,i[ve]=t.handler),r.#r(t.method,t.path,i)}),this}basePath(e){let t=this.#t();return t._basePath=v(this._basePath,e),t}onError=e=>(this.errorHandler=e,this);notFound=e=>(this.#n=e,this);mount(e,t,n){let r,i;n&&(typeof n==`function`?i=n:(i=n.optionHandler,r=n.replaceRequest===!1?e=>e:n.replaceRequest));let a=i?e=>{let t=i(e);return Array.isArray(t)?t:[t]}:e=>{let t;try{t=e.executionCtx}catch{}return[e.env,t]};return r||=(()=>{let t=v(this._basePath,e),n=t===`/`?0:t.length;return e=>{let t=new URL(e.url);return t.pathname=t.pathname.slice(n)||`/`,new Request(t,e)}})(),this.#r(`ALL`,v(e,`*`),async(e,n)=>{let i=await t(r(e.req.raw),...a(e));if(i)return i;await n()}),this}#r(e,t,n){e=e.toUpperCase(),t=v(this._basePath,t);let r={basePath:this._basePath,path:t,method:e,handler:n};this.router.add(e,t,[n,r]),this.routes.push(r)}#i(e,t){if(e instanceof Error)return this.errorHandler(e,t);throw e}#a(t,n,r,i){if(i===`HEAD`)return(async()=>new Response(null,await this.#a(t,n,r,`GET`)))();let a=this.getPath(t,{env:r}),o=this.router.match(i,a),s=new me(t,{path:a,matchResult:o,env:r,executionCtx:n,notFoundHandler:this.#n});if(o[0].length===1){let e;try{e=o[0][0][0][0](s,async()=>{s.res=await this.#n(s)})}catch(e){return this.#i(e,s)}return e instanceof Promise?e.then(e=>e||(s.finalized?s.res:this.#n(s))).catch(e=>this.#i(e,s)):e??this.#n(s)}let c=e(o[0],this.errorHandler,this.#n);return(async()=>{try{let e=await c(s);if(!e.finalized)throw Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return e.res}catch(e){return this.#i(e,s)}})()}fetch=(e,...t)=>this.#a(e,t[1],t[0],e.method);request=(e,t,n,r)=>e instanceof Request?this.fetch(t?new Request(e,t):e,n,r):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${v(`/`,e)}`,t),n,r));fire=()=>{addEventListener(`fetch`,e=>{e.respondWith(this.#a(e.request,e,void 0,e.request.method))})}},Se=[];function Ce(e,t){let n=this.buildAllMatchers(),r=((e,t)=>{let r=n[e]||n.ALL,i=r[2][t];if(i)return i;let a=t.match(r[0]);if(!a)return[[],Se];let o=a.indexOf(``,1);return[r[1][o],a]});return this.match=r,r(e,t)}var we=`[^/]+`,y=`.*`,b=`(?:|/.*)`,x=Symbol(),Te=new Set(`.\\+*[^]$()`);function Ee(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===y||e===b?1:t===y||t===b?-1:e===we?1:t===we?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var De=class e{#e;#t;#n=Object.create(null);insert(t,n,r,i,a){if(t.length===0){if(this.#e!==void 0)throw x;if(a)return;this.#e=n;return}let[o,...s]=t,c=o===`*`?s.length===0?[``,``,y]:[``,``,we]:o===`/*`?[``,``,b]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/),l;if(c){let t=c[1],n=c[2]||we;if(t&&c[2]&&(n===`.*`||(n=n.replace(/^\((?!\?:)(?=[^)]+\)$)/,`(?:`),/\((?!\?:)/.test(n))))throw x;if(l=this.#n[n],!l){if(Object.keys(this.#n).some(e=>e!==y&&e!==b))throw x;if(a)return;l=this.#n[n]=new e,t!==``&&(l.#t=i.varIndex++)}!a&&t!==``&&r.push([t,l.#t])}else if(l=this.#n[o],!l){if(Object.keys(this.#n).some(e=>e.length>1&&e!==y&&e!==b))throw x;if(a)return;l=this.#n[o]=new e}l.insert(s,n,r,i,a)}buildRegExpStr(){let e=Object.keys(this.#n).sort(Ee).map(e=>{let t=this.#n[e];return(typeof t.#t==`number`?`(${e})@${t.#t}`:Te.has(e)?`\\${e}`:e)+t.buildRegExpStr()});return typeof this.#e==`number`&&e.unshift(`#${this.#e}`),e.length===0?``:e.length===1?e[0]:`(?:`+e.join(`|`)+`)`}},Oe=class{#e={varIndex:0};#t=new De;insert(e,t,n){let r=[],i=[];for(let t=0;;){let n=!1;if(e=e.replace(/\{[^}]+\}/g,e=>{let r=`@\\${t}`;return i[t]=[r,e],t++,n=!0,r}),!n)break}let a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let e=i.length-1;e>=0;e--){let[t]=i[e];for(let n=a.length-1;n>=0;n--)if(a[n].indexOf(t)!==-1){a[n]=a[n].replace(t,i[e][1]);break}}return this.#t.insert(a,t,r,this.#e,n),r}buildRegExp(){let e=this.#t.buildRegExpStr();if(e===``)return[/^$/,[],[]];let t=0,n=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(e,i,a)=>i===void 0?(a===void 0||(r[Number(a)]=++t),``):(n[++t]=Number(i),`$()`)),[RegExp(`^${e}`),n,r]}},ke=[/^$/,[],Object.create(null)],Ae=Object.create(null);function je(e){return Ae[e]??=RegExp(e===`*`?``:`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,t)=>t?`\\${t}`:`(?:|/.*)`)}$`)}function Me(){Ae=Object.create(null)}function Ne(e){let t=new Oe,n=[];if(e.length===0)return ke;let r=e.map(e=>[!/\*|\/:/.test(e[0]),...e]).sort(([e,t],[n,r])=>e?1:n?-1:t.length-r.length),i=Object.create(null);for(let e=0,a=-1,o=r.length;e<o;e++){let[o,s,c]=r[e];o?i[s]=[c.map(([e])=>[e,Object.create(null)]),Se]:a++;let l;try{l=t.insert(s,a,o)}catch(e){throw e===x?new _e(s):e}o||(n[a]=c.map(([e,t])=>{let n=Object.create(null);for(--t;t>=0;t--){let[e,r]=l[t];n[e]=r}return[e,n]}))}let[a,o,s]=t.buildRegExp();for(let e=0,t=n.length;e<t;e++)for(let t=0,r=n[e].length;t<r;t++){let r=n[e][t]?.[1];if(!r)continue;let i=Object.keys(r);for(let e=0,t=i.length;e<t;e++)r[i[e]]=s[r[i[e]]]}let c=[];for(let e in o)c[e]=n[o[e]];return[a,c,i]}function S(e,t){if(e){for(let n of Object.keys(e).sort((e,t)=>t.length-e.length))if(je(n).test(t))return[...e[n]]}}var Pe=class{name=`RegExpRouter`;#e;#t;constructor(){this.#e={ALL:Object.create(null)},this.#t={ALL:Object.create(null)}}add(e,t,n){let r=this.#e,i=this.#t;if(!r||!i)throw Error(ge);r[e]||[r,i].forEach(t=>{t[e]=Object.create(null),Object.keys(t.ALL).forEach(n=>{t[e][n]=[...t.ALL[n]]})}),t===`/*`&&(t=`*`);let a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){let o=je(t);e===`ALL`?Object.keys(r).forEach(e=>{r[e][t]||=S(r[e],t)||S(r.ALL,t)||[]}):r[e][t]||=S(r[e],t)||S(r.ALL,t)||[],Object.keys(r).forEach(t=>{(e===`ALL`||e===t)&&Object.keys(r[t]).forEach(e=>{o.test(e)&&r[t][e].push([n,a])})}),Object.keys(i).forEach(t=>{(e===`ALL`||e===t)&&Object.keys(i[t]).forEach(e=>o.test(e)&&i[t][e].push([n,a]))});return}let o=ee(t)||[t];for(let t=0,s=o.length;t<s;t++){let c=o[t];Object.keys(i).forEach(o=>{(e===`ALL`||e===o)&&(i[o][c]||=[...S(r[o],c)||S(r.ALL,c)||[]],i[o][c].push([n,a-s+t+1]))})}}match=Ce;buildAllMatchers(){let e=Object.create(null);return Object.keys(this.#t).concat(Object.keys(this.#e)).forEach(t=>{e[t]||=this.#n(t)}),this.#e=this.#t=void 0,Me(),e}#n(e){let t=[],n=e===`ALL`;return[this.#e,this.#t].forEach(r=>{let i=r[e]?Object.keys(r[e]).map(t=>[t,r[e][t]]):[];i.length===0?e!==`ALL`&&t.push(...Object.keys(r.ALL).map(e=>[e,r.ALL[e]])):(n||=!0,t.push(...i))}),n?Ne(t):null}},Fe=class{name=`SmartRouter`;#e=[];#t=[];constructor(e){this.#e=e.routers}add(e,t,n){if(!this.#t)throw Error(ge);this.#t.push([e,t,n])}match(e,t){if(!this.#t)throw Error(`Fatal error`);let n=this.#e,r=this.#t,i=n.length,a=0,o;for(;a<i;a++){let i=n[a];try{for(let e=0,t=r.length;e<t;e++)i.add(...r[e]);o=i.match(e,t)}catch(e){if(e instanceof _e)continue;throw e}this.match=i.match.bind(i),this.#e=[i],this.#t=void 0;break}if(a===i)throw Error(`Fatal error`);return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(this.#t||this.#e.length!==1)throw Error(`No active router has been determined yet.`);return this.#e[0]}},C=Object.create(null),Ie=e=>{for(let t in e)return!0;return!1},Le=class e{#e;#t;#n;#r=0;#i=C;constructor(e,t,n){if(this.#t=n||Object.create(null),this.#e=[],e&&t){let n=Object.create(null);n[e]={handler:t,possibleKeys:[],score:0},this.#e=[n]}this.#n=[]}insert(t,n,r){this.#r=++this.#r;let i=this,a=l(n),o=[];for(let t=0,n=a.length;t<n;t++){let n=a[t],r=a[t+1],s=p(n,r),c=Array.isArray(s)?s[0]:n;if(c in i.#t){i=i.#t[c],s&&o.push(s[1]);continue}i.#t[c]=new e,s&&(i.#n.push(s),o.push(s[1])),i=i.#t[c]}return i.#e.push({[t]:{handler:r,possibleKeys:o.filter((e,t,n)=>n.indexOf(e)===t),score:this.#r}}),i}#a(e,t,n,r,i){for(let a=0,o=t.#e.length;a<o;a++){let o=t.#e[a],s=o[n]||o.ALL,c={};if(s!==void 0&&(s.params=Object.create(null),e.push(s),r!==C||i&&i!==C))for(let e=0,t=s.possibleKeys.length;e<t;e++){let t=s.possibleKeys[e],n=c[s.score];s.params[t]=i?.[t]&&!n?i[t]:r[t]??i?.[t],c[s.score]=!0}}}search(e,t){let n=[];this.#i=C;let r=[this],i=c(t),a=[],o=i.length,s=null;for(let c=0;c<o;c++){let l=i[c],u=c===o-1,d=[];for(let f=0,p=r.length;f<p;f++){let p=r[f],m=p.#t[l];m&&(m.#i=p.#i,u?(m.#t[`*`]&&this.#a(n,m.#t[`*`],e,p.#i),this.#a(n,m,e,p.#i)):d.push(m));for(let r=0,f=p.#n.length;r<f;r++){let f=p.#n[r],m=p.#i===C?{}:{...p.#i};if(f===`*`){let t=p.#t[`*`];t&&(this.#a(n,t,e,p.#i),t.#i=m,d.push(t));continue}let[h,g,_]=f;if(!l&&!(_ instanceof RegExp))continue;let v=p.#t[h];if(_ instanceof RegExp){if(s===null){s=Array(o);let e=+(t[0]===`/`);for(let t=0;t<o;t++)s[t]=e,e+=i[t].length+1}let r=t.substring(s[c]),l=_.exec(r);if(l){if(m[g]=l[0],this.#a(n,v,e,p.#i,m),Ie(v.#t)){v.#i=m;let e=l[0].match(/\//)?.length??0;(a[e]||=[]).push(v)}continue}}(_===!0||_.test(l))&&(m[g]=l,u?(this.#a(n,v,e,m,p.#i),v.#t[`*`]&&this.#a(n,v.#t[`*`],e,m,p.#i)):(v.#i=m,d.push(v)))}}let f=a.shift();r=f?d.concat(f):d}return n.length>1&&n.sort((e,t)=>e.score-t.score),[n.map(({handler:e,params:t})=>[e,t])]}},Re=class{name=`TrieRouter`;#e;constructor(){this.#e=new Le}add(e,t,n){let r=ee(t);if(r){for(let t=0,i=r.length;t<i;t++)this.#e.insert(e,r[t],n);return}this.#e.insert(e,t,n)}match(e,t){return this.#e.search(e,t)}},ze=class extends xe{constructor(e={}){super(e),this.router=e.router??new Fe({routers:[new Pe,new Re]})}},Be=e=>{let t={origin:`*`,allowMethods:[`GET`,`HEAD`,`PUT`,`POST`,`DELETE`,`PATCH`],allowHeaders:[],exposeHeaders:[],...e},n=(e=>typeof e==`string`?e===`*`?t.credentials?e=>e||null:()=>e:t=>e===t?t:null:typeof e==`function`?e:t=>e.includes(t)?t:null)(t.origin),r=(e=>typeof e==`function`?e:Array.isArray(e)?()=>e:()=>[])(t.allowMethods);return async function(e,i){function a(t,n){e.res.headers.set(t,n)}let o=await n(e.req.header(`origin`)||``,e);if(o&&a(`Access-Control-Allow-Origin`,o),t.credentials&&a(`Access-Control-Allow-Credentials`,`true`),t.exposeHeaders?.length&&a(`Access-Control-Expose-Headers`,t.exposeHeaders.join(`,`)),e.req.method===`OPTIONS`){(t.origin!==`*`||t.credentials)&&a(`Vary`,`Origin`),t.maxAge!=null&&a(`Access-Control-Max-Age`,t.maxAge.toString());let n=await r(e.req.header(`origin`)||``,e);n.length&&a(`Access-Control-Allow-Methods`,n.join(`,`));let i=t.allowHeaders;if(!i?.length){let t=e.req.header(`Access-Control-Request-Headers`);t&&(i=t.split(/\s*,\s*/))}return i?.length&&(a(`Access-Control-Allow-Headers`,i.join(`,`)),e.res.headers.append(`Vary`,`Access-Control-Request-Headers`)),e.res.headers.delete(`Content-Length`),e.res.headers.delete(`Content-Type`),new Response(null,{headers:e.res.headers,status:204,statusText:`No Content`})}await i(),(t.origin!==`*`||t.credentials)&&e.header(`Vary`,`Origin`,{append:!0})}};function Ve(){return Be({origin:`*`,allowMethods:[`GET`,`POST`,`PUT`,`DELETE`,`OPTIONS`],allowHeaders:[`Content-Type`,`Authorization`],maxAge:86400})}async function He(e,n){if(e instanceof t)return n.json({message:e.message},e.status);let r=e?.message||`Internal Server Error`;return console.error(`[error]`,e),n.json({message:r},500)}function Ue(){let{process:e,Deno:t}=globalThis;return!(typeof t?.noColor==`boolean`?t.noColor:e!==void 0&&`NO_COLOR`in e?.env)}async function We(){let{navigator:e}=globalThis;return!(e!==void 0&&e.userAgent===`Cloudflare-Workers`?await(async()=>{try{return`NO_COLOR`in((await import(`cloudflare:workers`)).env??{})}catch{return!1}})():!Ue())}var Ge=e=>{let[t,n]=[`,`,`.`];return e.map(e=>e.replace(/(\d)(?=(\d\d\d)+(?!\d))/g,`$1`+t)).join(n)},Ke=e=>{let t=Date.now()-e;return Ge([t<1e3?t+`ms`:Math.round(t/1e3)+`s`])},qe=async e=>{if(await We())switch(e/100|0){case 5:return`\x1B[31m${e}\x1B[0m`;case 4:return`\x1B[33m${e}\x1B[0m`;case 3:return`\x1B[36m${e}\x1B[0m`;case 2:return`\x1B[32m${e}\x1B[0m`}return`${e}`};async function Je(e,t,n,r,i=0,a){e(t===`<--`?`${t} ${n} ${r}`:`${t} ${n} ${r} ${await qe(i)} ${a}`)}var Ye=(e=console.log)=>async function(t,n){let{method:r,url:i}=t.req,a=i.slice(i.indexOf(`/`,8));await Je(e,`<--`,r,a);let o=Date.now();await n(),await Je(e,`-->`,r,a,t.res.status,Ke(o))};function Xe(){return Ye()}function Ze(e){return async(t,n)=>{t.set(`repo`,e),await n()}}function Qe(){return`
    ...
    <\/script>
    `}function at(){return{arrow:`<svg viewBox="0 0 1024 1024" width="12" height="12">
                ...
                </svg>`}}const ot=at();function st(){return`
    <script>
    ...
    <\/script>`}const ct=at();function lt(){return`
    <script>
...
`).filter(Boolean)??[]).reduce((e,t)=>(e.unshift({label:t,value:t}),e),[{label:`ACL4SSR_Online 默认版 分组比较全 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini`},{label:`ACL4SSR_Online_AdblockPlus 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_AdblockPlus.ini`},{label:`ACL4SSR_Online_NoAuto 无自动测速 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_NoAuto.ini`},{label:`ACL4SSR_Online_NoReject 无广告拦截规则 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_NoReject.ini`},{label:`ACL4SSR_Online_Mini 精简版 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini.ini`},{label:`ACL4SSR_Online_Mini_AdblockPlus.ini 精简版 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_AdblockPlus.ini`},{label:`ACL4SSR_Online_Mini_NoAuto.ini 精简版 不带自动测速 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_NoAuto.ini`},{label:`ACL4SSR_Online_Mini_Fallback.ini 精简版 带故障转移 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_Fallback.ini`},{label:`ACL4SSR_Online_Mini_MultiMode.ini 精简版 自动测速、故障转移、负载均衡 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_MultiMode.ini`},{label:`ACL4SSR_Online_Full 全分组 重度用户使用 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full.ini`},{label:`ACL4SSR_Online_Full_NoAuto.ini 全分组 无自动测速 重度用户使用 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_NoAuto.ini`},{label:`ACL4SSR_Online_Full_AdblockPlus 全分组 重度用户使用 更多去广告 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_AdblockPlus.ini`},{label:`ACL4SSR_Online_Full_Netflix 全分组 重度用户使用 奈飞全量 (与Github同步)`,value:`https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_Netflix.ini`}])}function _t(e,t){if(!t.SHORT_URL_ENABLED)return[];let{origin:n}=new URL(e.url);return[{label:n,value:n}]}function vt(){return[{label:`Clash`,value:`clash`},{label:`Sing-box`,value:`singbox`},{label:`v2ray`,value:`v2ray`}]}var yt=class e{static#e=[{label:`中国香港`,value:`ZH_HK`,rules:`港|HK|Hong Kong|HongKong|HKG`},{label:`中国台湾`,value:`ZH_TW`,rules:`台|新北|彰化|TW|Taiwan|TPE|KHH`},{label:`中国澳门`,value:`ZH_MO`,rules:`澳|MAC|Macao|macau|MACAU`},{label:`韩国`,value:`KR`,rules:`KR|Korea|KOR|Seoul|首尔|春川|韩|韓|ICN`},{label:`日本`,value:`JP`,rules:`日本|川日|东京|大阪|泉日|埼玉|沪日|深日|[^-]日|JP|Japan|Tokyo|NRT|KIX`},{label:`新加坡`,value:`SG`,rules:`新加坡|坡|狮城|SG|Singapore|SIN`},{label:`美国`,value:`US`,rules:`美|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉拉|西雅图|芝加哥|US|United States|ATL|BUF|DFW|EWR|IAD|LAX|MCI|MIA|ORD|PHX|PDX|SEA|SJC`}];static#t=null;static#n(e){let t=e.split(`|`).map(e=>/^[A-Z0-9][A-Z0-9 ]*$/i.test(e)?`\\b${e}\\b`:e).join(`|`);return new RegExp(t,`i`)}static#r(){return e.#t||=e.#e.map(t=>({value:t.value,regexp:e.#n(t.rules)})),e.#t}getTag(t){if(!t)return null;let n=decodeURIComponent(t);for(let{value:t,regexp:r}of e.#r())if(r.test(n))return t;return null}get excludeRules(){return e.#e}};function bt(){return new yt().excludeRules.map(e=>({label:e.label,value:e.value}))}function xt(){return`
    ...
    `}function wt(e,t){if(e.length!==t.length)return!1;let n=0;for(let r=0;r<e.length;r++)n|=e.charCodeAt(r)^t.charCodeAt(r);return n===0}function Tt(e){return e.SHORT_URL_KEY?.trim()||null}function Et(e,t){let n=t.SHORT_URL_ENABLED===!0,r=Tt(t)!==null,i=`
    <!DOCTYPE html>
    ...
    `;return new Response(i,{headers:new Headers({"Content-Type":`text/html; charset=UTF-8`,"Cache-Control":`no-store, no-cache, must-revalidate`})})}function Dt(e,t){let n=gt(t),r=mt(e,t),i=_t(e,t),a=vt(),o=ft(),s=ht(),c=bt(),l=pt(e,t),u=t.SHORT_URL_ENABLED===!0,d=`  
    <!DOCTYPE html>
                    ...
                    <section>
                        <sub-form id="sub-convert-form" label-width="100px">
                            ...
                            <sub-form-item label="短链地址">
                                <sub-select key="shortServe" filterable placeholder="${u?``:`未配置数据库`}"></sub-select>
                            </sub-form-item>
    ...
    `;return new Response(d,{headers:new Headers({"Content-Type":`text/html; charset=UTF-8`,"Cache-Control":`no-store, no-cache, must-revalidate`})})}const Ot=new ze;Ot.get(`/`,e=>Dt(e.req.raw,e.env)),Ot.get(`/shortUrl`,e=>Et(e.req.raw,e.env)),Ot.get(`/favicon.ico`,e=>e.body(null,204));var kt=class{constructor(e){this.service=e}async toSub(e){let n=e.req.query(`target`);if(!n)throw new t(400,{message:`Unsupported client type`});let r=vt().map(e=>e.value);if(!r.includes(n))throw new t(400,{message:`Unsupported client type, support list: ${r.join(`, `)}`});let{body:i,contentType:a}=await this.service.toSub(e.req.raw,e.env,n);return e.body(i,200,{"Content-Type":a,"Cache-Control":`no-store`})}async getVersion(e){let t=this.service.getVersionRedirect(e.req.raw,e.env);return e.redirect(t,302)}async add(e){let n=await e.req.json();if(!n?.long_url)throw new t(400,{message:`Missing long_url`});let r=new URL(e.req.url),i=n.serve||`${r.protocol}//${r.host}`,a=await this.service.add(n.long_url,i);return e.json({data:a})}async verifyAdmin(e){if(e.env.SHORT_URL_ENABLED!==!0)throw new t(503,{message:`短链服务未启用`});let n=Tt(e.env);if(!n)throw new t(503,{message:`请先配置 SHORT_URL_KEY`});let r=(await e.req.json().catch(()=>({key:``})))?.key?.trim()??``;if(!r||!wt(r,n))throw new t(401,{message:`密钥不正确`});return e.json({data:{ok:!0}})}async delete(e){this.assertAdminKey(e);let n=e.req.query(`code`);if(!n)throw new t(400,{message:`Missing code`});return await this.service.deleteByCode(n),e.json({data:{deleted:!0}})}async queryByCode(e){this.assertAdminKey(e);let n=e.req.query(`code`);if(!n)throw new t(400,{message:`Missing code`});let r=await this.service.getByCode(n);if(!r)throw new t(404,{message:`Not found`});return e.json({data:r})}async queryList(e){this.assertAdminKey(e);let t=Number.parseInt(e.req.query(`page`)||`1`,10),n=Number.parseInt(e.req.query(`pageSize`)||`20`,10),r=await this.service.getList(t,n);return e.json({data:r})}async redirect(e){let n=e.req.param(`code`);if(!n)throw new t(400,{message:`Invalid short URL`});let r=await this.service.getByCode(n);if(!r)throw new t(404,{message:`Not found`});return e.redirect(r.long_url,302)}assertAdminKey(e){let n=Tt(e.env);if(!n)throw new t(503,{message:`请先配置 SHORT_URL_KEY`});let r=(e.req.header(`X-Admin-Key`)??``).trim();if(!r||!wt(r,n))throw new t(401,{message:`密钥不正确`})}};
/*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT */
function At(e){return e==null}function jt(e){return typeof e==`object`&&!!e}function Mt(e){return Array.isArray(e)?e:At(e)?[]:[e]}function Nt(e,t){var n,r,i,a;if(t)for(a=Object.keys(t),n=0,r=a.length;n<r;n+=1)i=a[n],e[i]=t[i];return e}function Pt(e,t){var n=``,r;for(r=0;r<t;r+=1)n+=e;return n}function Ft(e){return e===0&&1/e==-1/0}var w={isNothing:At,isObject:jt,toArray:Mt,repeat:Pt,isNegativeZero:Ft,extend:Nt};function It(e,t){var n=``,r=e.reason||`(unknown reason)`;return e.mark?(e.mark.name&&(n+=`in "`+e.mark.name+`" `),n+=`(`+(e.mark.line+1)+`:`+(e.mark.column+1)+`)`,!t&&e.mark.snippet&&(n+=`

`+e.mark.snippet),r+` `+n):r}function T(e,t){Error.call(this),this.name=`YAMLException`,this.reason=e,this.mark=t,this.message=It(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack||``}T.prototype=Object.create(Error.prototype),T.prototype.constructor=T,T.prototype.toString=function(e){return this.name+`: `+It(this,e)};var E=T;function Lt(e,t,n,r,i){var a=``,o=``,s=Math.floor(i/2)-1;return r-t>s&&(a=` ... `,t=r-s+a.length),n-r>s&&(o=` ...`,n=r+s-o.length),{str:a+e.slice(t,n).replace(/\t/g,`→`)+o,pos:r-t+a.length}}function Rt(e,t){return w.repeat(` `,t-e.length)+e}function zt(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||=79,typeof t.indent!=`number`&&(t.indent=1),typeof t.linesBefore!=`number`&&(t.linesBefore=3),typeof t.linesAfter!=`number`&&(t.linesAfter=2);for(var n=/\r?\n|\r|\0/g,r=[0],i=[],a,o=-1;a=n.exec(e.buffer);)i.push(a.index),r.push(a.index+a[0].length),e.position<=a.index&&o<0&&(o=r.length-2);o<0&&(o=r.length-1);var s=``,c,l,u=Math.min(e.line+t.linesAfter,i.length).toString().length,d=t.maxLength-(t.indent+u+3);for(c=1;c<=t.linesBefore&&!(o-c<0);c++)l=Lt(e.buffer,r[o-c],i[o-c],e.position-(r[o]-r[o-c]),d),s=w.repeat(` `,t.indent)+Rt((e.line-c+1).toString(),u)+` | `+l.str+`
`+s;for(l=Lt(e.buffer,r[o],i[o],e.position,d),s+=w.repeat(` `,t.indent)+Rt((e.line+1).toString(),u)+` | `+l.str+`
`,s+=w.repeat(`-`,t.indent+u+3+l.pos)+`^
`,c=1;c<=t.linesAfter&&!(o+c>=i.length);c++)l=Lt(e.buffer,r[o+c],i[o+c],e.position-(r[o]-r[o+c]),d),s+=w.repeat(` `,t.indent)+Rt((e.line+c+1).toString(),u)+` | `+l.str+`
`;return s.replace(/\n$/,``)}var Bt=zt,Vt=[`kind`,`multi`,`resolve`,`construct`,`instanceOf`,`predicate`,`represent`,`representName`,`defaultStyle`,`styleAliases`],Ht=[`scalar`,`sequence`,`mapping`];function Ut(e){var t={};return e!==null&&Object.keys(e).forEach(function(n){e[n].forEach(function(e){t[String(e)]=n})}),t}function Wt(e,t){if(t||={},Object.keys(t).forEach(function(t){if(Vt.indexOf(t)===-1)throw new E(`Unknown option "`+t+`" is met in definition of "`+e+`" YAML type.`)}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(e){return e},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=Ut(t.styleAliases||null),Ht.indexOf(this.kind)===-1)throw new E(`Unknown kind "`+this.kind+`" is specified for "`+e+`" YAML type.`)}var D=Wt;function Gt(e,t){var n=[];return e[t].forEach(function(e){var t=n.length;n.forEach(function(n,r){n.tag===e.tag&&n.kind===e.kind&&n.multi===e.multi&&(t=r)}),n[t]=e}),n}function Kt(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},t,n;function r(t){t.multi?(e.multi[t.kind].push(t),e.multi.fallback.push(t)):e[t.kind][t.tag]=e.fallback[t.tag]=t}for(t=0,n=arguments.length;t<n;t+=1)arguments[t].forEach(r);return e}function qt(e){return this.extend(e)}qt.prototype.extend=function(e){var t=[],n=[];if(e instanceof D)n.push(e);else if(Array.isArray(e))n=n.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(n=n.concat(e.explicit));else throw new E(`Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })`);t.forEach(function(e){if(!(e instanceof D))throw new E(`Specified list of YAML types (or a single Type object) contains a non-Type object.`);if(e.loadKind&&e.loadKind!==`scalar`)throw new E(`There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.`);if(e.multi)throw new E(`There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.`)}),n.forEach(function(e){if(!(e instanceof D))throw new E(`Specified list of YAML types (or a single Type object) contains a non-Type object.`)});var r=Object.create(qt.prototype);return r.implicit=(this.implicit||[]).concat(t),r.explicit=(this.explicit||[]).concat(n),r.compiledImplicit=Gt(r,`implicit`),r.compiledExplicit=Gt(r,`explicit`),r.compiledTypeMap=Kt(r.compiledImplicit,r.compiledExplicit),r};var Jt=new qt({explicit:[new D(`tag:yaml.org,2002:str`,{kind:`scalar`,construct:function(e){return e===null?``:e}}),new D(`tag:yaml.org,2002:seq`,{kind:`sequence`,construct:function(e){return e===null?[]:e}}),new D(`tag:yaml.org,2002:map`,{kind:`mapping`,construct:function(e){return e===null?{}:e}})]});function Yt(e){if(e===null)return!0;var t=e.length;return t===1&&e===`~`||t===4&&(e===`null`||e===`Null`||e===`NULL`)}function Xt(){return null}function Zt(e){return e===null}var Qt=new D(`tag:yaml.org,2002:null`,{kind:`scalar`,resolve:Yt,construct:Xt,predicate:Zt,represent:{canonical:function(){return`~`},lowercase:function(){return`null`},uppercase:function(){return`NULL`},camelcase:function(){return`Null`},empty:function(){return``}},defaultStyle:`lowercase`});function $t(e){if(e===null)return!1;var t=e.length;return t===4&&(e===`true`||e===`True`||e===`TRUE`)||t===5&&(e===`false`||e===`False`||e===`FALSE`)}function en(e){return e===`true`||e===`True`||e===`TRUE`}function tn(e){return Object.prototype.toString.call(e)===`[object Boolean]`}var nn=new D(`tag:yaml.org,2002:bool`,{kind:`scalar`,resolve:$t,construct:en,predicate:tn,represent:{lowercase:function(e){return e?`true`:`false`},uppercase:function(e){return e?`TRUE`:`FALSE`},camelcase:function(e){return e?`True`:`False`}},defaultStyle:`lowercase`});function rn(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function an(e){return 48<=e&&e<=55}function on(e){return 48<=e&&e<=57}function sn(e){if(e===null)return!1;var t=e.length,n=0,r=!1,i;if(!t)return!1;if(i=e[n],(i===`-`||i===`+`)&&(i=e[++n]),i===`0`){if(n+1===t)return!0;if(i=e[++n],i===`b`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(i!==`0`&&i!==`1`)return!1;r=!0}return r&&i!==`_`}if(i===`x`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(!rn(e.charCodeAt(n)))return!1;r=!0}return r&&i!==`_`}if(i===`o`){for(n++;n<t;n++)if(i=e[n],i!==`_`){if(!an(e.charCodeAt(n)))return!1;r=!0}return r&&i!==`_`}}if(i===`_`)return!1;for(;n<t;n++)if(i=e[n],i!==`_`){if(!on(e.charCodeAt(n)))return!1;r=!0}return!(!r||i===`_`)}function cn(e){var t=e,n=1,r;if(t.indexOf(`_`)!==-1&&(t=t.replace(/_/g,``)),r=t[0],(r===`-`||r===`+`)&&(r===`-`&&(n=-1),t=t.slice(1),r=t[0]),t===`0`)return 0;if(r===`0`){if(t[1]===`b`)return n*parseInt(t.slice(2),2);if(t[1]===`x`)return n*parseInt(t.slice(2),16);if(t[1]===`o`)return n*parseInt(t.slice(2),8)}return n*parseInt(t,10)}function ln(e){return Object.prototype.toString.call(e)===`[object Number]`&&e%1==0&&!w.isNegativeZero(e)}var un=new D(`tag:yaml.org,2002:int`,{kind:`scalar`,resolve:sn,construct:cn,predicate:ln,represent:{binary:function(e){return e>=0?`0b`+e.toString(2):`-0b`+e.toString(2).slice(1)},octal:function(e){return e>=0?`0o`+e.toString(8):`-0o`+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?`0x`+e.toString(16).toUpperCase():`-0x`+e.toString(16).toUpperCase().slice(1)}},defaultStyle:`decimal`,styleAliases:{binary:[2,`bin`],octal:[8,`oct`],decimal:[10,`dec`],hexadecimal:[16,`hex`]}}),dn=RegExp(`^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`);function fn(e){return!(e===null||!dn.test(e)||e[e.length-1]===`_`)}function pn(e){var t=e.replace(/_/g,``).toLowerCase(),n=t[0]===`-`?-1:1;return`+-`.indexOf(t[0])>=0&&(t=t.slice(1)),t===`.inf`?n===1?1/0:-1/0:t===`.nan`?NaN:n*parseFloat(t,10)}var mn=/^[-+]?[0-9]+e/;function hn(e,t){var n;if(isNaN(e))switch(t){case`lowercase`:return`.nan`;case`uppercase`:return`.NAN`;case`camelcase`:return`.NaN`}else if(e===1/0)switch(t){case`lowercase`:return`.inf`;case`uppercase`:return`.INF`;case`camelcase`:return`.Inf`}else if(e===-1/0)switch(t){case`lowercase`:return`-.inf`;case`uppercase`:return`-.INF`;case`camelcase`:return`-.Inf`}else if(w.isNegativeZero(e))return`-0.0`;return n=e.toString(10),mn.test(n)?n.replace(`e`,`.e`):n}function gn(e){return Object.prototype.toString.call(e)===`[object Number]`&&(e%1!=0||w.isNegativeZero(e))}var _n=new D(`tag:yaml.org,2002:float`,{kind:`scalar`,resolve:fn,construct:pn,predicate:gn,represent:hn,defaultStyle:`lowercase`}),vn=Jt.extend({implicit:[Qt,nn,un,_n]}),yn=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$`),bn=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$`);function xn(e){return e===null?!1:yn.exec(e)!==null||bn.exec(e)!==null}function Sn(e){var t,n,r,i,a,o,s,c=0,l=null,u,d,f;if(t=yn.exec(e),t===null&&(t=bn.exec(e)),t===null)throw Error(`Date resolve error`);if(n=+t[1],r=t[2]-1,i=+t[3],!t[4])return new Date(Date.UTC(n,r,i));if(a=+t[4],o=+t[5],s=+t[6],t[7]){for(c=t[7].slice(0,3);c.length<3;)c+=`0`;c=+c}return t[9]&&(u=+t[10],d=+(t[11]||0),l=(u*60+d)*6e4,t[9]===`-`&&(l=-l)),f=new Date(Date.UTC(n,r,i,a,o,s,c)),l&&f.setTime(f.getTime()-l),f}function Cn(e){return e.toISOString()}var wn=new D(`tag:yaml.org,2002:timestamp`,{kind:`scalar`,resolve:xn,construct:Sn,instanceOf:Date,represent:Cn});function Tn(e){return e===`<<`||e===null}var En=new D(`tag:yaml.org,2002:merge`,{kind:`scalar`,resolve:Tn}),Dn=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function On(e){if(e===null)return!1;var t,n,r=0,i=e.length,a=Dn;for(n=0;n<i;n++)if(t=a.indexOf(e.charAt(n)),!(t>64)){if(t<0)return!1;r+=6}return r%8==0}function kn(e){var t,n,r=e.replace(/[\r\n=]/g,``),i=r.length,a=Dn,o=0,s=[];for(t=0;t<i;t++)t%4==0&&t&&(s.push(o>>16&255),s.push(o>>8&255),s.push(o&255)),o=o<<6|a.indexOf(r.charAt(t));return n=i%4*6,n===0?(s.push(o>>16&255),s.push(o>>8&255),s.push(o&255)):n===18?(s.push(o>>10&255),s.push(o>>2&255)):n===12&&s.push(o>>4&255),new Uint8Array(s)}function An(e){var t=``,n=0,r,i,a=e.length,o=Dn;for(r=0;r<a;r++)r%3==0&&r&&(t+=o[n>>18&63],t+=o[n>>12&63],t+=o[n>>6&63],t+=o[n&63]),n=(n<<8)+e[r];return i=a%3,i===0?(t+=o[n>>18&63],t+=o[n>>12&63],t+=o[n>>6&63],t+=o[n&63]):i===2?(t+=o[n>>10&63],t+=o[n>>4&63],t+=o[n<<2&63],t+=o[64]):i===1&&(t+=o[n>>2&63],t+=o[n<<4&63],t+=o[64],t+=o[64]),t}function jn(e){return Object.prototype.toString.call(e)===`[object Uint8Array]`}var Mn=new D(`tag:yaml.org,2002:binary`,{kind:`scalar`,resolve:On,construct:kn,predicate:jn,represent:An}),Nn=Object.prototype.hasOwnProperty,Pn=Object.prototype.toString;function Fn(e){if(e===null)return!0;var t=[],n,r,i,a,o,s=e;for(n=0,r=s.length;n<r;n+=1){if(i=s[n],o=!1,Pn.call(i)!==`[object Object]`)return!1;for(a in i)if(Nn.call(i,a))if(!o)o=!0;else return!1;if(!o)return!1;if(t.indexOf(a)===-1)t.push(a);else return!1}return!0}function In(e){return e===null?[]:e}var Ln=new D(`tag:yaml.org,2002:omap`,{kind:`sequence`,resolve:Fn,construct:In}),Rn=Object.prototype.toString;function zn(e){if(e===null)return!0;var t,n,r,i,a,o=e;for(a=Array(o.length),t=0,n=o.length;t<n;t+=1){if(r=o[t],Rn.call(r)!==`[object Object]`||(i=Object.keys(r),i.length!==1))return!1;a[t]=[i[0],r[i[0]]]}return!0}function Bn(e){if(e===null)return[];var t,n,r,i,a,o=e;for(a=Array(o.length),t=0,n=o.length;t<n;t+=1)r=o[t],i=Object.keys(r),a[t]=[i[0],r[i[0]]];return a}var Vn=new D(`tag:yaml.org,2002:pairs`,{kind:`sequence`,resolve:zn,construct:Bn}),Hn=Object.prototype.hasOwnProperty;function Un(e){if(e===null)return!0;var t,n=e;for(t in n)if(Hn.call(n,t)&&n[t]!==null)return!1;return!0}function Wn(e){return e===null?{}:e}var Gn=new D(`tag:yaml.org,2002:set`,{kind:`mapping`,resolve:Un,construct:Wn}),Kn=vn.extend({implicit:[wn,En],explicit:[Mn,Ln,Vn,Gn]}),O=Object.prototype.hasOwnProperty,qn=1,Jn=2,Yn=3,Xn=4,Zn=1,Qn=2,$n=3,er=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,tr=/[\x85\u2028\u2029]/,nr=/[,\[\]\{\}]/,rr=/^(?:!|!!|![a-z\-]+!)$/i,ir=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function ar(e){return Object.prototype.toString.call(e)}function k(e){return e===10||e===13}function A(e){return e===9||e===32}function j(e){return e===9||e===32||e===10||e===13}function M(e){return e===44||e===91||e===93||e===123||e===125}function or(e){var t;return 48<=e&&e<=57?e-48:(t=e|32,97<=t&&t<=102?t-97+10:-1)}function sr(e){return e===120?2:e===117?4:e===85?8:0}function cr(e){return 48<=e&&e<=57?e-48:-1}function lr(e){return e===48?`\0`:e===97?`\x07`:e===98?`\b`:e===116||e===9?`	`:e===110?`
`:e===118?`\v`:e===102?`\f`:e===114?`\r`:e===101?`\x1B`:e===32?` `:e===34?`"`:e===47?`/`:e===92?`\\`:e===78?``:e===95?`\xA0`:e===76?`\u2028`:e===80?`\u2029`:``}function ur(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function dr(e,t,n){t===`__proto__`?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:n}):e[t]=n}for(var fr=Array(256),pr=Array(256),N=0;N<256;N++)fr[N]=+!!lr(N),pr[N]=lr(N);function mr(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||Kn,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function hr(e,t){var n={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return n.snippet=Bt(n),new E(t,n)}function P(e,t){throw hr(e,t)}function gr(e,t){e.onWarning&&e.onWarning.call(null,hr(e,t))}var _r={YAML:function(e,t,n){var r,i,a;e.version!==null&&P(e,`duplication of %YAML directive`),n.length!==1&&P(e,`YAML directive accepts exactly one argument`),r=/^([0-9]+)\.([0-9]+)$/.exec(n[0]),r===null&&P(e,`ill-formed argument of the YAML directive`),i=parseInt(r[1],10),a=parseInt(r[2],10),i!==1&&P(e,`unacceptable YAML version of the document`),e.version=n[0],e.checkLineBreaks=a<2,a!==1&&a!==2&&gr(e,`unsupported YAML version of the document`)},TAG:function(e,t,n){var r,i;n.length!==2&&P(e,`TAG directive accepts exactly two arguments`),r=n[0],i=n[1],rr.test(r)||P(e,`ill-formed tag handle (first argument) of the TAG directive`),O.call(e.tagMap,r)&&P(e,`there is a previously declared suffix for "`+r+`" tag handle`),ir.test(i)||P(e,`ill-formed tag prefix (second argument) of the TAG directive`);try{i=decodeURIComponent(i)}catch{P(e,`tag prefix is malformed: `+i)}e.tagMap[r]=i}};function F(e,t,n,r){var i,a,o,s;if(t<n){if(s=e.input.slice(t,n),r)for(i=0,a=s.length;i<a;i+=1)o=s.charCodeAt(i),o===9||32<=o&&o<=1114111||P(e,`expected valid JSON character`);else er.test(s)&&P(e,`the stream contains non-printable characters`);e.result+=s}}function vr(e,t,n,r){var i,a,o,s;for(w.isObject(n)||P(e,`cannot merge mappings; the provided source object is unacceptable`),i=Object.keys(n),o=0,s=i.length;o<s;o+=1)a=i[o],O.call(t,a)||(dr(t,a,n[a]),r[a]=!0)}function I(e,t,n,r,i,a,o,s,c){var l,u;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),l=0,u=i.length;l<u;l+=1)Array.isArray(i[l])&&P(e,`nested arrays are not supported inside keys`),typeof i==`object`&&ar(i[l])===`[object Object]`&&(i[l]=`[object Object]`);if(typeof i==`object`&&ar(i)===`[object Object]`&&(i=`[object Object]`),i=String(i),t===null&&(t={}),r===`tag:yaml.org,2002:merge`)if(Array.isArray(a))for(l=0,u=a.length;l<u;l+=1)vr(e,t,a[l],n);else vr(e,t,a,n);else !e.json&&!O.call(n,i)&&O.call(t,i)&&(e.line=o||e.line,e.lineStart=s||e.lineStart,e.position=c||e.position,P(e,`duplicated mapping key`)),dr(t,i,a),delete n[i];return t}function yr(e){var t=e.input.charCodeAt(e.position);t===10?e.position++:t===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):P(e,`a line break is expected`),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function L(e,t,n){for(var r=0,i=e.input.charCodeAt(e.position);i!==0;){for(;A(i);)i===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),i=e.input.charCodeAt(++e.position);if(t&&i===35)do i=e.input.charCodeAt(++e.position);while(i!==10&&i!==13&&i!==0);if(k(i))for(yr(e),i=e.input.charCodeAt(e.position),r++,e.lineIndent=0;i===32;)e.lineIndent++,i=e.input.charCodeAt(++e.position);else break}return n!==-1&&r!==0&&e.lineIndent<n&&gr(e,`deficient indentation`),r}function br(e){var t=e.position,n=e.input.charCodeAt(t);return!!((n===45||n===46)&&n===e.input.charCodeAt(t+1)&&n===e.input.charCodeAt(t+2)&&(t+=3,n=e.input.charCodeAt(t),n===0||j(n)))}function xr(e,t){t===1?e.result+=` `:t>1&&(e.result+=w.repeat(`
`,t-1))}function Sr(e,t,n){var r,i,a,o,s,c,l,u,d=e.kind,f=e.result,p=e.input.charCodeAt(e.position);if(j(p)||M(p)||p===35||p===38||p===42||p===33||p===124||p===62||p===39||p===34||p===37||p===64||p===96||(p===63||p===45)&&(i=e.input.charCodeAt(e.position+1),j(i)||n&&M(i)))return!1;for(e.kind=`scalar`,e.result=``,a=o=e.position,s=!1;p!==0;){if(p===58){if(i=e.input.charCodeAt(e.position+1),j(i)||n&&M(i))break}else if(p===35){if(r=e.input.charCodeAt(e.position-1),j(r))break}else if(e.position===e.lineStart&&br(e)||n&&M(p))break;else if(k(p))if(c=e.line,l=e.lineStart,u=e.lineIndent,L(e,!1,-1),e.lineIndent>=t){s=!0,p=e.input.charCodeAt(e.position);continue}else{e.position=o,e.line=c,e.lineStart=l,e.lineIndent=u;break}s&&=(F(e,a,o,!1),xr(e,e.line-c),a=o=e.position,!1),A(p)||(o=e.position+1),p=e.input.charCodeAt(++e.position)}return F(e,a,o,!1),e.result?!0:(e.kind=d,e.result=f,!1)}function Cr(e,t){var n=e.input.charCodeAt(e.position),r,i;if(n!==39)return!1;for(e.kind=`scalar`,e.result=``,e.position++,r=i=e.position;(n=e.input.charCodeAt(e.position))!==0;)if(n===39)if(F(e,r,e.position,!0),n=e.input.charCodeAt(++e.position),n===39)r=e.position,e.position++,i=e.position;else return!0;else k(n)?(F(e,r,i,!0),xr(e,L(e,!1,t)),r=i=e.position):e.position===e.lineStart&&br(e)?P(e,`unexpected end of the document within a single quoted scalar`):(e.position++,i=e.position);P(e,`unexpected end of the stream within a single quoted scalar`)}function wr(e,t){var n,r,i,a,o,s=e.input.charCodeAt(e.position);if(s!==34)return!1;for(e.kind=`scalar`,e.result=``,e.position++,n=r=e.position;(s=e.input.charCodeAt(e.position))!==0;)if(s===34)return F(e,n,e.position,!0),e.position++,!0;else if(s===92){if(F(e,n,e.position,!0),s=e.input.charCodeAt(++e.position),k(s))L(e,!1,t);else if(s<256&&fr[s])e.result+=pr[s],e.position++;else if((o=sr(s))>0){for(i=o,a=0;i>0;i--)s=e.input.charCodeAt(++e.position),(o=or(s))>=0?a=(a<<4)+o:P(e,`expected hexadecimal character`);e.result+=ur(a),e.position++}else P(e,`unknown escape sequence`);n=r=e.position}else k(s)?(F(e,n,r,!0),xr(e,L(e,!1,t)),n=r=e.position):e.position===e.lineStart&&br(e)?P(e,`unexpected end of the document within a double quoted scalar`):(e.position++,r=e.position);P(e,`unexpected end of the stream within a double quoted scalar`)}function Tr(e,t){var n=!0,r,i,a,o=e.tag,s,c=e.anchor,l,u,d,f,p,m=Object.create(null),h,g,_,v=e.input.charCodeAt(e.position);if(v===91)u=93,p=!1,s=[];else if(v===123)u=125,p=!0,s={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=s),v=e.input.charCodeAt(++e.position);v!==0;){if(L(e,!0,t),v=e.input.charCodeAt(e.position),v===u)return e.position++,e.tag=o,e.anchor=c,e.kind=p?`mapping`:`sequence`,e.result=s,!0;n?v===44&&P(e,`expected the node content, but found ','`):P(e,`missed comma between flow collection entries`),g=h=_=null,d=f=!1,v===63&&(l=e.input.charCodeAt(e.position+1),j(l)&&(d=f=!0,e.position++,L(e,!0,t))),r=e.line,i=e.lineStart,a=e.position,R(e,t,qn,!1,!0),g=e.tag,h=e.result,L(e,!0,t),v=e.input.charCodeAt(e.position),(f||e.line===r)&&v===58&&(d=!0,v=e.input.charCodeAt(++e.position),L(e,!0,t),R(e,t,qn,!1,!0),_=e.result),p?I(e,s,m,g,h,_,r,i,a):d?s.push(I(e,null,m,g,h,_,r,i,a)):s.push(h),L(e,!0,t),v=e.input.charCodeAt(e.position),v===44?(n=!0,v=e.input.charCodeAt(++e.position)):n=!1}P(e,`unexpected end of the stream within a flow collection`)}function Er(e,t){var n,r,i=Zn,a=!1,o=!1,s=t,c=0,l=!1,u,d=e.input.charCodeAt(e.position);if(d===124)r=!1;else if(d===62)r=!0;else return!1;for(e.kind=`scalar`,e.result=``;d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)Zn===i?i=d===43?$n:Qn:P(e,`repeat of a chomping mode identifier`);else if((u=cr(d))>=0)u===0?P(e,`bad explicit indentation width of a block scalar; it cannot be less than one`):o?P(e,`repeat of an indentation width identifier`):(s=t+u-1,o=!0);else break;if(A(d)){do d=e.input.charCodeAt(++e.position);while(A(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!k(d)&&d!==0)}for(;d!==0;){for(yr(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!o||e.lineIndent<s)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!o&&e.lineIndent>s&&(s=e.lineIndent),k(d)){c++;continue}if(e.lineIndent<s){i===$n?e.result+=w.repeat(`
...
`,c):e.result+=w.repeat(`
`,a?1+c:c),a=!0,o=!0,c=0,n=e.position;!k(d)&&d!==0;)d=e.input.charCodeAt(++e.position);F(e,n,e.position,!1)}return!0}function Dr(e,t){var n,r=e.tag,i=e.anchor,a=[],o,s=!1,c;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=a),c=e.input.charCodeAt(e.position);c!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,P(e,`tab characters must not be used in indentation`)),!(c!==45||(o=e.input.charCodeAt(e.position+1),!j(o))));){if(s=!0,e.position++,L(e,!0,-1)&&e.lineIndent<=t){a.push(null),c=e.input.charCodeAt(e.position);continue}if(n=e.line,R(e,t,Yn,!1,!0),a.push(e.result),L(e,!0,-1),c=e.input.charCodeAt(e.position),(e.line===n||e.lineIndent>t)&&c!==0)P(e,`bad indentation of a sequence entry`);else if(e.lineIndent<t)break}return s?(e.tag=r,e.anchor=i,e.kind=`sequence`,e.result=a,!0):!1}function Or(e,t,n){var r,i,a,o,s,c,l=e.tag,u=e.anchor,d={},f=Object.create(null),p=null,m=null,h=null,g=!1,_=!1,v;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=d),v=e.input.charCodeAt(e.position);v!==0;){if(!g&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,P(e,`tab characters must not be used in indentation`)),r=e.input.charCodeAt(e.position+1),a=e.line,(v===63||v===58)&&j(r))v===63?(g&&(I(e,d,f,p,m,null,o,s,c),p=m=h=null),_=!0,g=!0,i=!0):g?(g=!1,i=!0):P(e,`incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line`),e.position+=1,v=r;else{if(o=e.line,s=e.lineStart,c=e.position,!R(e,n,Jn,!1,!0))break;if(e.line===a){for(v=e.input.charCodeAt(e.position);A(v);)v=e.input.charCodeAt(++e.position);if(v===58)v=e.input.charCodeAt(++e.position),j(v)||P(e,`a whitespace character is expected after the key-value separator within a block mapping`),g&&(I(e,d,f,p,m,null,o,s,c),p=m=h=null),_=!0,g=!1,i=!1,p=e.tag,m=e.result;else if(_)P(e,`can not read an implicit mapping pair; a colon is missed`);else return e.tag=l,e.anchor=u,!0}else if(_)P(e,`can not read a block mapping entry; a multiline key may not be an implicit key`);else return e.tag=l,e.anchor=u,!0}if((e.line===a||e.lineIndent>t)&&(g&&(o=e.line,s=e.lineStart,c=e.position),R(e,t,Xn,!0,i)&&(g?m=e.result:h=e.result),g||(I(e,d,f,p,m,h,o,s,c),p=m=h=null),L(e,!0,-1),v=e.input.charCodeAt(e.position)),(e.line===a||e.lineIndent>t)&&v!==0)P(e,`bad indentation of a mapping entry`);else if(e.lineIndent<t)break}return g&&I(e,d,f,p,m,null,o,s,c),_&&(e.tag=l,e.anchor=u,e.kind=`mapping`,e.result=d),_}function kr(e){var t,n=!1,r=!1,i,a,o=e.input.charCodeAt(e.position);if(o!==33)return!1;if(e.tag!==null&&P(e,`duplication of a tag property`),o=e.input.charCodeAt(++e.position),o===60?(n=!0,o=e.input.charCodeAt(++e.position)):o===33?(r=!0,i=`!!`,o=e.input.charCodeAt(++e.position)):i=`!`,t=e.position,n){do o=e.input.charCodeAt(++e.position);while(o!==0&&o!==62);e.position<e.length?(a=e.input.slice(t,e.position),o=e.input.charCodeAt(++e.position)):P(e,`unexpected end of the stream within a verbatim tag`)}else{for(;o!==0&&!j(o);)o===33&&(r?P(e,`tag suffix cannot contain exclamation marks`):(i=e.input.slice(t-1,e.position+1),rr.test(i)||P(e,`named tag handle cannot contain such characters`),r=!0,t=e.position+1)),o=e.input.charCodeAt(++e.position);a=e.input.slice(t,e.position),nr.test(a)&&P(e,`tag suffix cannot contain flow indicator characters`)}a&&!ir.test(a)&&P(e,`tag name cannot contain such characters: `+a);try{a=decodeURIComponent(a)}catch{P(e,`tag name is malformed: `+a)}return n?e.tag=a:O.call(e.tagMap,i)?e.tag=e.tagMap[i]+a:i===`!`?e.tag=`!`+a:i===`!!`?e.tag=`tag:yaml.org,2002:`+a:P(e,`undeclared tag handle "`+i+`"`),!0}function Ar(e){var t,n=e.input.charCodeAt(e.position);if(n!==38)return!1;for(e.anchor!==null&&P(e,`duplication of an anchor property`),n=e.input.charCodeAt(++e.position),t=e.position;n!==0&&!j(n)&&!M(n);)n=e.input.charCodeAt(++e.position);return e.position===t&&P(e,`name of an anchor node must contain at least one character`),e.anchor=e.input.slice(t,e.position),!0}function jr(e){var t,n,r=e.input.charCodeAt(e.position);if(r!==42)return!1;for(r=e.input.charCodeAt(++e.position),t=e.position;r!==0&&!j(r)&&!M(r);)r=e.input.charCodeAt(++e.position);return e.position===t&&P(e,`name of an alias node must contain at least one character`),n=e.input.slice(t,e.position),O.call(e.anchorMap,n)||P(e,`unidentified alias "`+n+`"`),e.result=e.anchorMap[n],L(e,!0,-1),!0}function R(e,t,n,r,i){var a,o,s,c=1,l=!1,u=!1,d,f,p,m,h,g;if(e.listener!==null&&e.listener(`open`,e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,a=o=s=Xn===n||Yn===n,r&&L(e,!0,-1)&&(l=!0,e.lineIndent>t?c=1:e.lineIndent===t?c=0:e.lineIndent<t&&(c=-1)),c===1)for(;kr(e)||Ar(e);)L(e,!0,-1)?(l=!0,s=a,e.lineIndent>t?c=1:e.lineIndent===t?c=0:e.lineIndent<t&&(c=-1)):s=!1;if(s&&=l||i,(c===1||Xn===n)&&(h=qn===n||Jn===n?t:t+1,g=e.position-e.lineStart,c===1?s&&(Dr(e,g)||Or(e,g,h))||Tr(e,h)?u=!0:(o&&Er(e,h)||Cr(e,h)||wr(e,h)?u=!0:jr(e)?(u=!0,(e.tag!==null||e.anchor!==null)&&P(e,`alias node should not have any properties`)):Sr(e,h,qn===n)&&(u=!0,e.tag===null&&(e.tag=`?`)),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):c===0&&(u=s&&Dr(e,g))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag===`?`){for(e.result!==null&&e.kind!==`scalar`&&P(e,`unacceptable node kind for !<?> tag; it should be "scalar", not "`+e.kind+`"`),d=0,f=e.implicitTypes.length;d<f;d+=1)if(m=e.implicitTypes[d],m.resolve(e.result)){e.result=m.construct(e.result),e.tag=m.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!==`!`){if(O.call(e.typeMap[e.kind||`fallback`],e.tag))m=e.typeMap[e.kind||`fallback`][e.tag];else for(m=null,p=e.typeMap.multi[e.kind||`fallback`],d=0,f=p.length;d<f;d+=1)if(e.tag.slice(0,p[d].tag.length)===p[d].tag){m=p[d];break}m||P(e,`unknown tag !<`+e.tag+`>`),e.result!==null&&m.kind!==e.kind&&P(e,`unacceptable node kind for !<`+e.tag+`> tag; it should be "`+m.kind+`", not "`+e.kind+`"`),m.resolve(e.result,e.tag)?(e.result=m.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):P(e,`cannot resolve a node with !<`+e.tag+`> explicit tag`)}return e.listener!==null&&e.listener(`close`,e),e.tag!==null||e.anchor!==null||u}function Mr(e){var t=e.position,n,r,i,a=!1,o;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(o=e.input.charCodeAt(e.position))!==0&&(L(e,!0,-1),o=e.input.charCodeAt(e.position),!(e.lineIndent>0||o!==37));){for(a=!0,o=e.input.charCodeAt(++e.position),n=e.position;o!==0&&!j(o);)o=e.input.charCodeAt(++e.position);for(r=e.input.slice(n,e.position),i=[],r.length<1&&P(e,`directive name must not be less than one character in length`);o!==0;){for(;A(o);)o=e.input.charCodeAt(++e.position);if(o===35){do o=e.input.charCodeAt(++e.position);while(o!==0&&!k(o));break}if(k(o))break;for(n=e.position;o!==0&&!j(o);)o=e.input.charCodeAt(++e.position);i.push(e.input.slice(n,e.position))}o!==0&&yr(e),O.call(_r,r)?_r[r](e,r,i):gr(e,`unknown document directive "`+r+`"`)}if(L(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,L(e,!0,-1)):a&&P(e,`directives end mark is expected`),R(e,e.lineIndent-1,Xn,!1,!0),L(e,!0,-1),e.checkLineBreaks&&tr.test(e.input.slice(t,e.position))&&gr(e,`non-ASCII line breaks are interpreted as content`),e.documents.push(e.result),e.position===e.lineStart&&br(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,L(e,!0,-1));return}if(e.position<e.length-1)P(e,`end of the stream or a document separator is expected`);else return}function Nr(e,t){e=String(e),t||={},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var n=new mr(e,t),r=e.indexOf(`\0`);for(r!==-1&&(n.position=r,P(n,`null byte is not allowed in input`)),n.input+=`\0`;n.input.charCodeAt(n.position)===32;)n.lineIndent+=1,n.position+=1;for(;n.position<n.length-1;)Mr(n);return n.documents}function Pr(e,t,n){typeof t==`object`&&t&&n===void 0&&(n=t,t=null);var r=Nr(e,n);if(typeof t!=`function`)return r;for(var i=0,a=r.length;i<a;i+=1)t(r[i])}function Fr(e,t){var n=Nr(e,t);if(n.length!==0){if(n.length===1)return n[0];throw new E(`expected a single document in the stream, but found more`)}}var Ir={loadAll:Pr,load:Fr},Lr=Object.prototype.toString,Rr=Object.prototype.hasOwnProperty,zr=65279,Br=9,z=10,Vr=13,Hr=32,Ur=33,Wr=34,Gr=35,Kr=37,qr=38,Jr=39,Yr=42,Xr=44,Zr=45,Qr=58,$r=61,ei=62,ti=63,ni=64,ri=91,ii=93,ai=96,oi=123,si=124,ci=125,B={};B[0]=`\\0`,B[7]=`\\a`,B[8]=`\\b`,B[9]=`\\t`,B[10]=`\\n`,B[11]=`\\v`,B[12]=`\\f`,B[13]=`\\r`,B[27]=`\\e`,B[34]=`\\"`,B[92]=`\\\\`,B[133]=`\\N`,B[160]=`\\_`,B[8232]=`\\L`,B[8233]=`\\P`;var li=[`y`,`Y`,`yes`,`Yes`,`YES`,`on`,`On`,`ON`,`n`,`N`,`no`,`No`,`NO`,`off`,`Off`,`OFF`],ui=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function di(e,t){var n,r,i,a,o,s,c;if(t===null)return{};for(n={},r=Object.keys(t),i=0,a=r.length;i<a;i+=1)o=r[i],s=String(t[o]),o.slice(0,2)===`!!`&&(o=`tag:yaml.org,2002:`+o.slice(2)),c=e.compiledTypeMap.fallback[o],c&&Rr.call(c.styleAliases,s)&&(s=c.styleAliases[s]),n[o]=s;return n}function fi(e){var t=e.toString(16).toUpperCase(),n,r;if(e<=255)n=`x`,r=2;else if(e<=65535)n=`u`,r=4;else if(e<=4294967295)n=`U`,r=8;else throw new E(`code point within a string may not be greater than 0xFFFFFFFF`);return`\\`+n+w.repeat(`0`,r-t.length)+t}var pi=1,V=2;function mi(e){this.schema=e.schema||Kn,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=w.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=di(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType===`"`?V:pi,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer==`function`?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result=``,this.duplicates=[],this.usedDuplicates=null}function hi(e,t){for(var n=w.repeat(` `,t),r=0,i=-1,a=``,o,s=e.length;r<s;)i=e.indexOf(`
`,r),i===-1?(o=e.slice(r),r=s):(o=e.slice(r,i+1),r=i+1),o.length&&o!==`
`&&(a+=n),a+=o;return a}function gi(e,t){return`
`+w.repeat(` `,e.indent*t)}function _i(e,t){var n,r,i;for(n=0,r=e.implicitTypes.length;n<r;n+=1)if(i=e.implicitTypes[n],i.resolve(t))return!0;return!1}function vi(e){return e===Hr||e===Br}function H(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==zr||65536<=e&&e<=1114111}function yi(e){return H(e)&&e!==zr&&e!==Vr&&e!==z}function bi(e,t,n){var r=yi(e),i=r&&!vi(e);return(n?r:r&&e!==Xr&&e!==ri&&e!==ii&&e!==oi&&e!==ci)&&e!==Gr&&!(t===Qr&&!i)||yi(t)&&!vi(t)&&e===Gr||t===Qr&&i}function xi(e){return H(e)&&e!==zr&&!vi(e)&&e!==Zr&&e!==ti&&e!==Qr&&e!==Xr&&e!==ri&&e!==ii&&e!==oi&&e!==ci&&e!==Gr&&e!==qr&&e!==Yr&&e!==Ur&&e!==si&&e!==$r&&e!==ei&&e!==Jr&&e!==Wr&&e!==Kr&&e!==ni&&e!==ai}function Si(e){return!vi(e)&&e!==Qr}function U(e,t){var n=e.charCodeAt(t),r;return n>=55296&&n<=56319&&t+1<e.length&&(r=e.charCodeAt(t+1),r>=56320&&r<=57343)?(n-55296)*1024+r-56320+65536:n}function Ci(e){return/^\n* /.test(e)}var wi=1,Ti=2,Ei=3,Di=4,W=5;function Oi(e,t,n,r,i,a,o,s){var c,l=0,u=null,d=!1,f=!1,p=r!==-1,m=-1,h=xi(U(e,0))&&Si(U(e,e.length-1));if(t||o)for(c=0;c<e.length;l>=65536?c+=2:c++){if(l=U(e,c),!H(l))return W;h&&=bi(l,u,s),u=l}else{for(c=0;c<e.length;l>=65536?c+=2:c++){if(l=U(e,c),l===z)d=!0,p&&(f||=c-m-1>r&&e[m+1]!==` `,m=c);else if(!H(l))return W;h&&=bi(l,u,s),u=l}f||=p&&c-m-1>r&&e[m+1]!==` `}return!d&&!f?h&&!o&&!i(e)?wi:a===V?W:Ti:n>9&&Ci(e)?W:o?a===V?W:Ti:f?Di:Ei}function ki(e,t,n,r,i){e.dump=function(){if(t.length===0)return e.quotingType===V?`""`:`''`;if(!e.noCompatMode&&(li.indexOf(t)!==-1||ui.test(t)))return e.quotingType===V?`"`+t+`"`:`'`+t+`'`;var a=e.indent*Math.max(1,n),o=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-a),s=r||e.flowLevel>-1&&n>=e.flowLevel;function c(t){return _i(e,t)}switch(Oi(t,s,e.indent,o,c,e.quotingType,e.forceQuotes&&!r,i)){case wi:return t;case Ti:return`'`+t.replace(/'/g,`''`)+`'`;case Ei:return`|`+Ai(t,e.indent)+ji(hi(t,a));case Di:return`>`+Ai(t,e.indent)+ji(hi(Mi(t,o),a));case W:return`"`+Pi(t)+`"`;default:throw new E(`impossible error: invalid scalar style`)}}()}function Ai(e,t){var n=Ci(e)?String(t):``,r=e[e.length-1]===`
`;return n+(r&&(e[e.length-2]===`
`||e===`
`)?`+`:r?``:`-`)+`
`}function ji(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function Mi(e,t){for(var n=/(\n+)([^\n]*)/g,r=function(){var r=e.indexOf(`
`);return r=r===-1?e.length:r,n.lastIndex=r,Ni(e.slice(0,r),t)}(),i=e[0]===`
`||e[0]===` `,a,o;o=n.exec(e);){var s=o[1],c=o[2];a=c[0]===` `,r+=s+(!i&&!a&&c!==``?`
`:``)+Ni(c,t),i=a}return r}function Ni(e,t){if(e===``||e[0]===` `)return e;for(var n=/ [^ ]/g,r,i=0,a,o=0,s=0,c=``;r=n.exec(e);)s=r.index,s-i>t&&(a=o>i?o:s,c+=`
`+e.slice(i,a),i=a+1),o=s;return c+=`
`,e.length-i>t&&o>i?c+=e.slice(i,o)+`
`+e.slice(o+1):c+=e.slice(i),c.slice(1)}function Pi(e){for(var t=``,n=0,r,i=0;i<e.length;n>=65536?i+=2:i++)n=U(e,i),r=B[n],!r&&H(n)?(t+=e[i],n>=65536&&(t+=e[i+1])):t+=r||fi(n);return t}function Fi(e,t,n){var r=``,i=e.tag,a,o,s;for(a=0,o=n.length;a<o;a+=1)s=n[a],e.replacer&&(s=e.replacer.call(n,String(a),s)),(G(e,t,s,!1,!1)||s===void 0&&G(e,t,null,!1,!1))&&(r!==``&&(r+=`,`+(e.condenseFlow?``:` `)),r+=e.dump);e.tag=i,e.dump=`[`+r+`]`}function Ii(e,t,n,r){var i=``,a=e.tag,o,s,c;for(o=0,s=n.length;o<s;o+=1)c=n[o],e.replacer&&(c=e.replacer.call(n,String(o),c)),(G(e,t+1,c,!0,!0,!1,!0)||c===void 0&&G(e,t+1,null,!0,!0,!1,!0))&&((!r||i!==``)&&(i+=gi(e,t)),e.dump&&z===e.dump.charCodeAt(0)?i+=`-`:i+=`- `,i+=e.dump);e.tag=a,e.dump=i||`[]`}function Li(e,t,n){var r=``,i=e.tag,a=Object.keys(n),o,s,c,l,u;for(o=0,s=a.length;o<s;o+=1)u=``,r!==``&&(u+=`, `),e.condenseFlow&&(u+=`"`),c=a[o],l=n[c],e.replacer&&(l=e.replacer.call(n,c,l)),G(e,t,c,!1,!1)&&(e.dump.length>1024&&(u+=`? `),u+=e.dump+(e.condenseFlow?`"`:``)+`:`+(e.condenseFlow?``:` `),G(e,t,l,!1,!1)&&(u+=e.dump,r+=u));e.tag=i,e.dump=`{`+r+`}`}function Ri(e,t,n,r){var i=``,a=e.tag,o=Object.keys(n),s,c,l,u,d,f;if(e.sortKeys===!0)o.sort();else if(typeof e.sortKeys==`function`)o.sort(e.sortKeys);else if(e.sortKeys)throw new E(`sortKeys must be a boolean or a function`);for(s=0,c=o.length;s<c;s+=1)f=``,(!r||i!==``)&&(f+=gi(e,t)),l=o[s],u=n[l],e.replacer&&(u=e.replacer.call(n,l,u)),G(e,t+1,l,!0,!0,!0)&&(d=e.tag!==null&&e.tag!==`?`||e.dump&&e.dump.length>1024,d&&(e.dump&&z===e.dump.charCodeAt(0)?f+=`?`:f+=`? `),f+=e.dump,d&&(f+=gi(e,t)),G(e,t+1,u,!0,d)&&(e.dump&&z===e.dump.charCodeAt(0)?f+=`:`:f+=`: `,f+=e.dump,i+=f));e.tag=a,e.dump=i||`{}`}function zi(e,t,n){var r,i=n?e.explicitTypes:e.implicitTypes,a,o,s,c;for(a=0,o=i.length;a<o;a+=1)if(s=i[a],(s.instanceOf||s.predicate)&&(!s.instanceOf||typeof t==`object`&&t instanceof s.instanceOf)&&(!s.predicate||s.predicate(t))){if(n?s.multi&&s.representName?e.tag=s.representName(t):e.tag=s.tag:e.tag=`?`,s.represent){if(c=e.styleMap[s.tag]||s.defaultStyle,Lr.call(s.represent)===`[object Function]`)r=s.represent(t,c);else if(Rr.call(s.represent,c))r=s.represent[c](t,c);else throw new E(`!<`+s.tag+`> tag resolver accepts not "`+c+`" style`);e.dump=r}return!0}return!1}function G(e,t,n,r,i,a,o){e.tag=null,e.dump=n,zi(e,n,!1)||zi(e,n,!0);var s=Lr.call(e.dump),c=r,l;r&&=e.flowLevel<0||e.flowLevel>t;var u=s===`[object Object]`||s===`[object Array]`,d,f;if(u&&(d=e.duplicates.indexOf(n),f=d!==-1),(e.tag!==null&&e.tag!==`?`||f||e.indent!==2&&t>0)&&(i=!1),f&&e.usedDuplicates[d])e.dump=`*ref_`+d;else{if(u&&f&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),s===`[object Object]`)r&&Object.keys(e.dump).length!==0?(Ri(e,t,e.dump,i),f&&(e.dump=`&ref_`+d+e.dump)):(Li(e,t,e.dump),f&&(e.dump=`&ref_`+d+` `+e.dump));else if(s===`[object Array]`)r&&e.dump.length!==0?(e.noArrayIndent&&!o&&t>0?Ii(e,t-1,e.dump,i):Ii(e,t,e.dump,i),f&&(e.dump=`&ref_`+d+e.dump)):(Fi(e,t,e.dump),f&&(e.dump=`&ref_`+d+` `+e.dump));else if(s===`[object String]`)e.tag!==`?`&&ki(e,e.dump,t,a,c);else if(s===`[object Undefined]`)return!1;else{if(e.skipInvalid)return!1;throw new E(`unacceptable kind of an object to dump `+s)}e.tag!==null&&e.tag!==`?`&&(l=encodeURI(e.tag[0]===`!`?e.tag.slice(1):e.tag).replace(/!/g,`%21`),l=e.tag[0]===`!`?`!`+l:l.slice(0,18)===`tag:yaml.org,2002:`?`!!`+l.slice(18):`!<`+l+`>`,e.dump=l+` `+e.dump)}return!0}function Bi(e,t){var n=[],r=[],i,a;for(Vi(e,n,r),i=0,a=r.length;i<a;i+=1)t.duplicates.push(n[r[i]]);t.usedDuplicates=Array(a)}function Vi(e,t,n){var r,i,a;if(typeof e==`object`&&e)if(i=t.indexOf(e),i!==-1)n.indexOf(i)===-1&&n.push(i);else if(t.push(e),Array.isArray(e))for(i=0,a=e.length;i<a;i+=1)Vi(e[i],t,n);else for(r=Object.keys(e),i=0,a=r.length;i<a;i+=1)Vi(e[r[i]],t,n)}function Hi(e,t){t||={};var n=new mi(t);n.noRefs||Bi(e,n);var r=e;return n.replacer&&(r=n.replacer.call({"":r},``,r)),G(n,0,r,!0,!0)?n.dump+`
`:``}var Ui={dump:Hi},Wi=Ir.load;Ir.loadAll;var Gi=Ui.dump;const K={BACKEND:`https://url.v1.mk`,LOCK_BACKEND:!1,REMOTE_CONFIG:``,CHUNK_COUNT:`20`};function Ki(e,t=10){let n=[],r=[];return e.forEach((e,i)=>{r.push(e),(i+1)%t===0&&(n.push(r.join(`|`)),r=[])}),r.length>0&&n.push(r.join(`|`)),n}function qi(e){try{return JSON.parse(e),!0}catch{return!1}}function q(e,t){return Object.hasOwn(e,t)}const J={retries:0,retryDelay:1e3,maxRetryDelay:3e4,timeout:1e4,retryOn:[408,429,500,502,503,504],exponentialBackoff:!0,jitter:.1},Ji={timeout:0};var Yi=class{requestInterceptors=[];responseInterceptors=[];useRequestInterceptor(e){this.requestInterceptors.push(e)}useResponseInterceptor(e){this.responseInterceptors.push(e)}async request(e,t={}){let n,r;e instanceof Request?(r=e.url,n={...t,retries:J.retries,url:r,method:e.method||`GET`,headers:Object.fromEntries(e.headers.entries())}):typeof e==`string`||e instanceof URL?(r=e.toString(),n={...t,retries:J.retries,url:r}):(r=e.url,n={...e,...t,retries:t.retries??J.retries}),n.retries=n.retries??J.retries,n.retryDelay=n.retryDelay??J.retryDelay,n.timeout=n.timeout??Ji.timeout,n.method=n.method||`GET`;for(let e of this.requestInterceptors)n=await e(n);if(n.params){let e=new URLSearchParams(n.params).toString();n.url+=(n.url.includes(`?`)?`&`:`?`)+e}let i=0,a=new AbortController,o=t.signal||a.signal,s=async()=>{i++;let e;n.timeout&&n.timeout>0&&(e=setTimeout(()=>{a.abort()},n.timeout));try{let t=new Request(n.url,{method:n.method,headers:n.headers,body:n.body?JSON.stringify(n.body):void 0,signal:o}),r=await fetch(t);e&&clearTimeout(e);let a;switch(n.responseType){case`text`:a=await r.text();break;case`blob`:a=await r.blob();break;case`arrayBuffer`:a=await r.arrayBuffer();break;case`formData`:a=await r.formData();break;case`stream`:if(!r.body)throw Error(`Response body is null`);a=r.body;break;default:a=await r.json();break}let c={data:a,status:r.status,statusText:r.statusText,headers:Object.fromEntries(r.headers.entries()),config:n,ok:r.ok};for(let e of this.responseInterceptors)c=await e(c);return!r.ok&&n.retries>0&&i<n.retries?(await new Promise(e=>setTimeout(e,n.retryDelay)),s()):c}catch(t){if(e&&clearTimeout(e),t.name===`AbortError`)throw Error(`请求超时`);if(n.retries>0&&i<n.retries)return await new Promise(e=>setTimeout(e,n.retryDelay)),s();throw t}};return s()}get(e,t){return this.request(e,{...t,method:`GET`})}post(e,t,n){return this.request(e,{...n,method:`POST`,body:t})}put(e,t,n){return this.request(e,{...n,method:`PUT`,body:t})}delete(e,t){return this.request(e,{...t,method:`DELETE`})}patch(e,t,n){return this.request(e,{...n,method:`PATCH`,body:t})}async fetchJson(e,t){return await this.request(e,{...t,headers:{Accept:`application/json`,...t?.headers}})}async fetchBlob(e,t){let n=await fetch(new Request(e,t));return{data:await n.blob(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchText(e,t){let n=await fetch(new Request(e,t));return{data:await n.text(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchArrayBuffer(e,t){let n=await fetch(new Request(e,t));return{data:await n.arrayBuffer(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchFormData(e,t){let n=await fetch(new Request(e,t));return{data:await n.formData(),status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}async fetchStream(e,t){let n=await fetch(new Request(e,t));if(!n.body)throw Error(`Response body is null`);return{data:n.body,status:n.status,statusText:n.statusText,headers:Object.fromEntries(n.headers.entries()),config:{url:n.url,...t},ok:n.ok}}},Xi=class extends Error{constructor(e,t,n,r){super(e),this.message=e,this.status=t,this.response=n,this.attempt=r,this.name=`FetchRetryError`}};function Zi(e,t){let n=t.retryDelay;if(t.exponentialBackoff&&(n*=2**(e-1)),t.jitter>0){let e=t.jitter*Math.random();n*=1+e}return Math.min(n,t.maxRetryDelay)}function Qi(e){return new Promise((t,n)=>{setTimeout(()=>{n(new Xi(`请求超时 (${e}ms)`))},e)})}async function $i(e,t={}){let n={...J,...t,retries:t.retries===1/0?30:Math.min(t.retries||J.retries||0,30)},r=0,i=async()=>{r++;try{let a,o;if(e instanceof Request){o=e.url;let n=e.clone();a=new Request(n,{...n,...t})}else o=e.toString(),a=new Request(o,t);let s=fetch(a),c=n.timeout?Qi(n.timeout):null,l=await(c?Promise.race([s,c]):s),u={status:l.status,statusText:l.statusText,headers:Object.fromEntries(l.headers.entries()),data:l,config:{url:o,...t},ok:l.ok};if(n.retries>0&&r<=n.retries&&(typeof n.retryOn==`function`?n.retryOn(l):n.retryOn.includes(l.status))){let e=Zi(r,n);if(n.onRetry&&await n.onRetry(r,e),n.onError){let e=new Xi(`请求失败，状态码 ${u.status}`,u.status,l,r);await n.onError(e,r)}return await new Promise(t=>setTimeout(t,e)),i()}return u}catch(e){let t=e instanceof Xi?e:new Xi(e.message||`请求失败`,void 0,void 0,r);if(n.onError&&await n.onError(t,r),n.retries>0&&r<=n.retries){let e=Zi(r,n);return n.onRetry&&await n.onRetry(r,e),await new Promise(t=>setTimeout(t,e)),i()}throw t}};return i()}new Yi;function ea(e){if(!e)return e;let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return new TextDecoder().decode(n)}function ta(e,t){let n=t||(e=>e);try{return e?ea(e.toString()):n(e)}catch{return n(e)}}function Y(e){if(!e)return e;let t=new TextEncoder().encode(e.trim()),n=``;for(let e=0;e<t.length;e+=1)n+=String.fromCharCode(t[e]);return btoa(n)}function na(e,t){let n=t||(e=>e);try{return e?Y(e.toString()):n(e)}catch{return n(e)}}var ra=class{existVps=[];existVpsMap=new Map;constructor(e=[]){this.existVps=e,this.updateExist(this.existVps)}updateExist(e=[]){for(let t of e){let e=this.getParser(t);e&&this.setExistVpsMap(e)}}updateVpsPs(e){let t=this.getParser(e);if(!t)return null;let n=t.originPs,[r,i]=n.split(`#`);if(!i)return e;let a=this.existVpsMap.get(i)||0,o=a===0?n:`${r}#${i} ${a}`;return t.updateOriginConfig(o),this.existVpsMap.set(i,a+1),t.originLink}setExistVpsMap(e){let[,t]=e.originPs.split(`#`);if(!t)return;let[n,r]=t.split(` `),i=r?Number.parseInt(r)>>>0:0,a=this.existVpsMap.get(n)||0;this.existVpsMap.set(n,Math.max(a,i+1))}getParser(e){return e.startsWith(`anytls://`)?new aa(e):e.startsWith(`vless://`)?new da(e):e.startsWith(`vmess://`)?new fa(e):e.startsWith(`trojan://`)?new la(e):e.startsWith(`ss://`)?new sa(e):e.startsWith(`ssr://`)?new ca(e):e.startsWith(`hysteria2://`)||e.startsWith(`hysteria://`)||e.startsWith(`hy2://`)?new oa(e):e.startsWith(`tuic://`)?new ua(e):null}},ia=class extends ra{constructor(e=[]){super(e)}},X=class extends yt{constructor(){super()}#e=[`localhost`,`127.0.0.1`,`abc.cba.com`];#t=[`AES_256_GCM`,`CHACHA20_POLY1305`,`AES_128_GCM`,`CHACHA20_IETF`];#n=1024;#r=65535;getUUID(){return crypto.randomUUID()}getUsername(){return this.getUUID()}getPassword(){return this.getUUID()}getHost(){return`${this.getHostName()}:${this.getPort()}`}getHostName(){return this.#e[Math.floor(Math.random()*this.#e.length)]}getPort(){return Math.floor(Math.random()*(this.#r-this.#n+1)+this.#n).toString()}getEncrtptionProtocol(){return this.#t[Math.floor(Math.random()*this.#t.length)]}},Z=class e{static#e=`^LINK_TO^`;static#t=new Map;static getPs(t){let n=t.split(e.#e);return[n[0],n[1]]}static setPs(t,n){return[this.formatPs(t),n].join(e.#e)}static formatPs(e){return e?e.replace(/\|/g,`-`):crypto.randomUUID()}static getPrefix(t){if(!t?.includes(e.#e))return null;if(e.#t.has(t))return e.#t.get(t);let[n]=e.getPs(t);if(n){let r=n.trim();return e.#t.set(t,r),r}return null}static isConfigType(e){return e.includes(this.#e)}static clearCache(){this.#t.clear()}},aa=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.password=this.originConfig.username??``,this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams.get(`sni`)??``),this.originConfig.searchParams?.has(`insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`insecure`)===`1`),e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.password=this.originConfig.username??``,e.tls?.server_name&&this.originConfig.searchParams?.has(`sni`)&&(e.tls.server_name=this.originConfig.searchParams.get(`sni`)??``),e.tls&&this.originConfig.searchParams?.has(`insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},oa=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.type===`hysteria2`&&q(e,`password`)&&(e.password=this.originConfig?.searchParams?.get(`password`)??this.originConfig.username??``),e.type===`hysteria2`&&q(e,`auth`)&&(e.auth=this.originConfig?.searchParams?.get(`auth`)??this.originConfig.username??``),q(e,`down`)&&(e.down=e.down===``?this.originConfig.searchParams?.get(`down`)??this.originConfig.searchParams?.get(`downmbps`)??0:e.down,e.down=decodeURIComponent(e.down)),q(e,`up`)&&(e.up=e.up===``?this.originConfig.searchParams?.get(`up`)??this.originConfig.searchParams?.get(`upmbps`)??0:e.up,e.up=decodeURIComponent(e.up)),q(e,`delay`)&&(e.delay=this.originConfig.searchParams?.get(`delay`)??0),this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams?.get(`sni`)??``),this.originConfig.searchParams?.has(`insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`insecure`)===`1`),e}restoreSingbox(e,t){return e.password=this.originConfig?.searchParams?.get(`password`)??``,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.down&&=decodeURIComponent(e.down),e.up&&=decodeURIComponent(e.up),e.tls&&this.originConfig.searchParams?.has(`insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},sa=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){let t=this.toStandard(e);this.#e=t,this.#n=new URL(t),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(this.toStandard(e)),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=`ss://${decodeURIComponent(this.#n.username)}@${this.#r.hostname}:${this.#r.port}${this.#r.search}#${this.#r.hash}`}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig?.port??0),e}restoreSingbox(e,t){return e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}toStandard(e){let t=e.match(/#(.*)$/),n=t?`#${t[1]}`:``,r=e.replace(/#.*$/,``);if(!r.startsWith(`ss://`))return e;let i=r.substring(5);if(i.includes(`@`))return e;try{let e=ea(i),t=e.lastIndexOf(`@`);if(t===-1)throw Error(`Invalid SIP002 format: missing @ separator`);let r=e.substring(0,t),a=e.substring(t+1),o=r.indexOf(`:`);if(o===-1)throw Error(`Invalid user info: missing colon separator`);let s=r.substring(0,o),c=r.substring(o+1),l=a.lastIndexOf(`:`);if(l===-1)throw Error(`Invalid server info: missing port`);let u=a.substring(0,l),d=a.substring(l+1);if(!s||!c||!u||!d)throw Error(`Invalid format: missing required fields`);let f=`ss://${Y(`${s}:${c}`)}@${u}:${d}`;return f+=`?type=tcp`,n&&(f+=n),f}catch{return e}}},ca=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig()}setOriginConfig(e){let[t,n]=e.match(/ssr:\/\/(.*)/)||[];this.#e=e,this.#n=this.getOriginConfig(ea(n)),this.#i=this.#n.remarks??``,this.#o=this.getTag(this.#n.remarks)??``}getOriginConfig(e){let[t,n,r,i,a,o]=e.split(`:`),s=new URL(e);return{server:t,port:n,protocol:r,method:i,obfs:a,password_base64:o.replace(s.search,``),remarks:ta(s.searchParams.get(`remarks`)?.replace(`-`,`+`)||``),params:s.search.replace(`?remarks=${s.searchParams.get(`remarks`)}`,``)}}updateOriginConfig(e){this.#n.remarks=e,this.#i=e,this.#e=`ssr://${Y(`${this.#n.server}:${this.#n.port}:${this.#n.protocol}:${this.#n.method}:${this.#n.obfs}:${this.#n.password_base64}?remarks=${this.#n.remarks}${this.#n.params}`)}`,this.setConfuseConfig()}setConfuseConfig(){this.#r=structuredClone(this.#n),this.#r.server=this.getHostName(),this.#r.port=this.getPort(),this.#r.remarks=Y(Z.setPs(this.#i,this.#a)),this.#t=`ssr://${Y(`${this.#r.server}:${this.#r.port}:${this.#r.protocol}:${this.#r.method}:${this.#r.obfs}:${this.#r.password_base64}?remarks=${this.#r.remarks}${this.#r.params}`)}`}restoreClash(e,t){return e.name=t,e.server=this.originConfig.server??``,e.port=Number(this.originConfig?.port??0),e}restoreSingbox(e,t){return e.server=this.originConfig.server??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.add??``),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},la=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=Z.formatPs(this.#n.hash)??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=Z.formatPs(e),this.#i=Z.formatPs(e),this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.password=this.originConfig?.username??``,e.alpn=e.alpn?e.alpn.map(e=>decodeURIComponent(e)):e.alpn,e}restoreSingbox(e,t){return e.password=this.originConfig?.username??``,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.hostname??``),e.tls?.alpn&&(e.tls.alpn=e.tls.alpn.map(e=>decodeURIComponent(e))),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},ua=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=this.#n.hash??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=e,this.#i=e,this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.password=this.getPassword(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=this.#r.href}restoreClash(e,t){return e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.password=this.originConfig.password??``,this.originConfig.searchParams?.has(`sni`)&&(e.sni=this.originConfig.searchParams?.get(`sni`)??``),this.originConfig.searchParams?.has(`allow_insecure`)&&(e[`skip-cert-verify`]=this.originConfig.searchParams.get(`allow_insecure`)===`1`),e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.password=this.originConfig.password??``,e.tls?.server_name&&this.originConfig.searchParams?.has(`sni`)&&(e.tls.server_name=this.originConfig.searchParams?.get(`sni`)??``),e.tls&&this.originConfig.searchParams?.has(`allow_insecure`)&&(e.tls.insecure=this.originConfig.searchParams.get(`allow_insecure`)===`1`),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return encodeURIComponent(this.#a)}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},da=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig(e)}setOriginConfig(e){this.#e=e,this.#n=new URL(e),this.#i=Z.formatPs(this.#n.hash)??``,this.#o=this.getTag(this.#n.hash)??``}updateOriginConfig(e){this.#n.hash=Z.formatPs(e),this.#i=Z.formatPs(e),this.#e=this.#n.href,this.setConfuseConfig(this.#e)}setConfuseConfig(e){this.#r=new URL(e),this.#r.username=this.getUsername(),this.#r.host=this.getHost(),this.#r.hostname=this.getHostName(),this.#r.port=this.getPort(),this.#r.hash=Z.setPs(this.#i,this.#a),this.#t=this.#r.href}#s(e){return q(e,`Host`)?{...e,Host:e.Host||this.originConfig.add||``}:e}#c(e){e.network===`ws`&&(e[`ws-opts`]={...e[`ws-opts`],headers:this.#s(e[`ws-opts`].headers),path:decodeURIComponent(this.originConfig.searchParams?.get(`path`)??`/`)})}restoreClash(e,t){return this.#c(e),e.name=t,e.server=this.originConfig.hostname??``,e.port=Number(this.originConfig?.port??0),e.uuid=this.originConfig.username??``,e.alpn=e.alpn?e.alpn?.map(e=>decodeURIComponent(decodeURIComponent(e))):e.alpn,e}restoreSingbox(e,t){return e.tag=t,e.server=this.originConfig.hostname??``,e.server_port=Number(this.originConfig.port??0),e.uuid=this.originConfig.username??``,e.tls?.server_name&&(e.tls.server_name=this.originConfig.hostname??``),e.tls?.alpn&&(e.tls.alpn=e.tls.alpn.map(e=>decodeURIComponent(decodeURIComponent(e)))),e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}},fa=class extends X{#e=``;#t=``;#n={};#r={};#i=``;#a=``;#o=``;constructor(e){super(),this.#a=crypto.randomUUID(),this.setOriginConfig(e),this.setConfuseConfig()}setOriginConfig(e){let[t,n]=e.match(/vmess:\/\/(.*)/)||[];this.#e=e,this.#n=JSON.parse(ea(n)),this.#i=this.#n.ps??``,this.#o=this.getTag(this.#n.ps)??``}updateOriginConfig(e){this.#n.ps=e,this.#i=e,this.#e=`vmess://${Y(JSON.stringify(this.#n))}`,this.setConfuseConfig()}setConfuseConfig(){this.#r=structuredClone(this.#n),this.#r.add=this.getHostName(),this.#r.port=this.getPort(),this.#r.id=this.getPassword(),this.#r.ps=Z.setPs(this.#i,this.#a),this.#t=`vmess://${Y(JSON.stringify(this.#r))}`}#s(e){return q(e,`Host`)?{...e,Host:e.Host||this.originConfig.add||``}:e}#c(e){e.network===`ws`&&(e[`ws-opts`]={...e[`ws-opts`],headers:this.#s(e[`ws-opts`].headers),path:this.originConfig.path})}restoreClash(e,t){return this.#c(e),e.name=t,e.server=this.originConfig.add??``,e.port=Number(this.originConfig?.port??0),e.uuid=this.originConfig?.id??``,q(e,`servername`)&&(e.servername=this.originConfig.add??``),e}restoreSingbox(e,t){return e.server=this.originConfig.add??``,e.server_port=Number(this.originConfig.port??0),e.tag=t,e.tls?.server_name&&(e.tls.server_name=this.originConfig.add??``),e.uuid=this.originConfig?.id??``,e}get originPs(){return this.#i}get originLink(){return this.#e}get originConfig(){return this.#n}get confusePs(){return this.#a}get confuseLink(){return this.#t}get confuseConfig(){return this.#r}get tag(){return this.#o??null}};function pa(e){if(!e?.server||!e.port||!e.password)throw Error(`AnyTLS configuration object must contain server, port, and password.`);let t=new URLSearchParams,n=(e,n)=>{n!=null&&n!==``&&t.set(e,String(n))};n(`sni`,e.sni??e.servername),n(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),n(`fp`,e[`client-fingerprint`]??e.fingerprint);let r=e.insecure??e[`skip-cert-verify`];typeof r==`boolean`&&t.set(`insecure`,r?`1`:`0`),n(`idle_session_check_interval`,e[`idle-session-check-interval`]??e.idle_session_check_interval),n(`idle_session_timeout`,e[`idle-session-timeout`]??e.idle_session_timeout),n(`min_idle_session`,e[`min-idle-session`]??e.min_idle_session);let i=t.toString(),a=e.name?`#${encodeURIComponent(e.name)}`:``;return`anytls://${encodeURIComponent(e.password)}@${encodeURIComponent(e.server)}:${e.port}${i?`?${i}`:``}${a}`}function ma(e){let t=e.password||e.auth||e.auth_str;if(!e||!e.server||!e.port||!t)throw Error(`Hysteria configuration object must contain server, port, and authentication (password, auth, or auth_str).`);let n=e.server,r=e.port,i=e.name||``,a=new URLSearchParams;a.append(`auth`,t),e.peerCA&&a.append(`peerCA`,Y(e.peerCA).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``));let o=e.insecure??e[`skip-cert-verify`];typeof o==`boolean`&&a.append(`insecure`,o?`1`:`0`),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&a.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),e.upmbps!==void 0&&e.upmbps!==null&&a.append(`upmbps`,e.upmbps.toString()),e.downmbps!==void 0&&e.downmbps!==null&&a.append(`downmbps`,e.downmbps.toString()),e.obfs&&a.append(`obfs`,e.obfs),e[`obfs-param`]&&a.append(`obfs-param`,e[`obfs-param`]),q(e,`up`)&&a.append(`up`,e.up),q(e,`down`)&&a.append(`down`,e.down),q(e,`delay`)&&a.append(`delay`,e.delay),q(e,`sni`)&&a.append(`sni`,e.sni);let s=a.toString(),c=encodeURIComponent(n),l=encodeURIComponent(i),u=`hysteria://${c}:${r}`;return s&&(u+=`?${s}`),i&&(u+=`#${l}`),u}function ha(e){if(!e||!e.server||!e.port||!e.password)throw Error(`Hysteria2 configuration object must contain server, port, and password.`);let t=e.server,n=e.port,r=e.password,i=e.name||``,a=new URLSearchParams;a.append(`password`,r);let o=e.sni||e.servername||e.server;o&&a.append(`sni`,o);let s=e.insecure??e[`skip-cert-verify`];typeof s==`boolean`&&a.append(`insecure`,s?`1`:`0`),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&a.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn),e.obfs&&a.append(`obfs`,e.obfs),e[`obfs-param`]&&a.append(`obfs-param`,e[`obfs-param`]),e[`obfs-password`]&&a.append(`obfs-password`,e[`obfs-password`]);let c=a.toString(),l=encodeURIComponent(t),u=encodeURIComponent(i),d=`hysteria2://${l}:${n}`;return c&&(d+=`?${c}`),i&&(d+=`#${u}`),d}function ga(e){if(!e||!e.server||!e.port||!e.cipher||!e.password)throw Error(`Shadowsocks configuration object must contain server, port, cipher, and password.`);let t=e.cipher,n=e.password,r=e.server,i=e.port,a=e.name||``,o=Y(`${t}:${n}`),s=new URLSearchParams,c=e.network||`tcp`;if((c!==`tcp`||e.network)&&s.append(`type`,c),e.tls){s.append(`security`,`tls`);let t=e.sni||e.servername||e.server;t&&s.append(`sni`,t),e[`client-fingerprint`]&&s.append(`fp`,e[`client-fingerprint`]),e[`skip-cert-verify`]&&s.append(`allowInsecure`,`1`)}switch(c){case`ws`:case`http`:{let t=e[`ws-opts`]||e[`http-opts`]||{},n;n=t.headers&&t.headers.Host?t.headers.Host:e.sni||e.servername?e.sni||e.servername:e.server,n&&s.append(`host`,n);let r=t.path||`/`;r!==`/`&&s.append(`path`,r);break}case`grpc`:{let t=e[`grpc-opts`]||{};t.serviceName&&s.append(`serviceName`,t.serviceName);break}}e.tfo&&s.append(`tfo`,`1`),e.udp&&s.append(`udp`,`1`);let l=`ss://${o}@${encodeURIComponent(r)}:${i}`,u=s.toString();return u&&(l+=`?${u}`),a&&(l+=`#${encodeURIComponent(a)}`),l}function _a(e){return Y(e).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}function va(e){if(!e||!e.server||!e.port||!e.protocol||!e.method||!e.obfs||!e.password)throw Error(`ShadowsocksR configuration object must contain server, port, protocol, method, obfs, and password.`);let t=e.server,n=e.port,r=e.protocol,i=e.method||e.cipher,a=e.obfs,o=e.password,s=e[`obfs-param`]||``,c=e[`protocol-param`]||``,l=e.name||``,u=`${t}:${n}:${r}:${i}:${a}:${_a(o)}/`,d=new URLSearchParams;if(s){let e=_a(s);d.append(`obfsparam`,e)}if(c){let e=_a(c);d.append(`protoparam`,e)}let f=d.toString();f&&(u+=`?${f}`);let p=_a(u),m=encodeURIComponent(l),h=`ssr://${p}`;return l&&(h+=`#${m}`),h}function ya(e){if(!e||!e.server||!e.port||!e.password)throw Error(`Trojan configuration object must contain server, port, and password.`);let t=e.password,n=e.server,r=e.port,i=e.name||``,a=new URLSearchParams,o=e.sni||e.servername||e.server;o&&a.append(`sni`,o),e[`skip-cert-verify`]&&a.append(`allowInsecure`,`1`);let s=e.network||`tcp`;switch(a.append(`type`,s),s){case`ws`:case`http`:{let t=e[`ws-opts`]||e[`http-opts`]||{},n;n=t.headers&&t.headers.Host?t.headers.Host:e.sni||e.servername?e.sni||e.servername:e.server,n&&a.append(`host`,n);let r=t.path||`/`;r!==`/`&&a.append(`path`,r);break}case`grpc`:{let t=e[`grpc-opts`]||{};t.serviceName&&a.append(`serviceName`,t.serviceName);break}}e.flow&&a.append(`flow`,e.flow),e.tfo&&a.append(`tfo`,`1`),e.udp&&a.append(`udp`,`1`),e[`client-fingerprint`]&&a.append(`fp`,e[`client-fingerprint`]);let c=`trojan://${encodeURIComponent(t)}@${encodeURIComponent(n)}:${r}`,l=a.toString();return l&&(c+=`?${l}`),i&&(c+=`#${encodeURIComponent(i)}`),c}function ba(e){if(!e||!e.server||!e.port||!e.uuid)throw Error(`TUIC configuration object must contain server, port, and uuid.`);let t=e.server,n=e.port,r=e.uuid,i=e.password??``,a=e.name||``,o=new URLSearchParams,s=e[`congestion-controller`]||e.congestion_control;s&&o.append(`congestion_control`,s);let c=e[`udp-relay-mode`]||e.udp_relay_mode;c&&o.append(`udp_relay_mode`,c),e.alpn&&(typeof e.alpn==`string`||Array.isArray(e.alpn))&&o.append(`alpn`,Array.isArray(e.alpn)?e.alpn.join(`,`):e.alpn);let l=e.sni||e.servername;l&&o.append(`sni`,l);let u=e.insecure??e[`skip-cert-verify`];typeof u==`boolean`&&o.append(`allow_insecure`,u?`1`:`0`),e[`disable-sni`]&&o.append(`disable_sni`,`1`);let d=o.toString(),f=`${encodeURIComponent(r)}:${encodeURIComponent(i)}`,p=encodeURIComponent(t),m=encodeURIComponent(a),h=`tuic://${f}@${p}:${n}`;return d&&(h+=`?${d}`),a&&(h+=`#${m}`),h}function xa(e){if(e.type!==`vless`)throw Error(`Configuration type must be "vless"`);if(!e.uuid||!e.server||!e.port)throw Error(`Missing required fields: uuid, server, or port`);let t=e.uuid,n=e.server,r=e.port,i=`#${encodeURIComponent(e.name||`vless-node`)}`,a=new URLSearchParams,o=e.network||`tcp`,s=`none`;if(e.security===`reality`||e[`reality-opts`]?s=`reality`:(e.security===`tls`||e.tls===!0)&&(s=`tls`),(o!==`tcp`||o===`tcp`&&e[`tcp-opts`]?.header?.type&&e[`tcp-opts`].header.type!==`none`)&&a.set(`type`,o),s===`tls`){a.set(`security`,`tls`),e.servername&&a.set(`sni`,e.servername),Array.isArray(e.alpn)&&e.alpn.length>0&&a.set(`alpn`,encodeURIComponent(e.alpn.join(`,`)));let t=e[`client-fingerprint`]||e.fingerprint;t&&a.set(`fp`,encodeURIComponent(t)),e[`skip-cert-verify`]===!0&&a.set(`allowInsecure`,`1`),e.flow&&a.set(`flow`,e.flow)}else if(s===`reality`){a.set(`security`,`reality`),e.servername&&a.set(`sni`,e.servername);let t=e[`reality-opts`]||{},n=t[`public-key`]||t.publicKey,r=t[`short-id`]||t.shortId;n&&a.set(`pbk`,encodeURIComponent(n)),r&&a.set(`sid`,encodeURIComponent(r));let i=e[`client-fingerprint`]||e.fingerprint;i&&a.set(`fp`,encodeURIComponent(i))}switch(o){case`tcp`:e[`tcp-opts`]?.header?.type&&e[`tcp-opts`].header.type!==`none`&&a.set(`headerType`,e[`tcp-opts`].header.type);break;case`ws`:e[`ws-opts`]&&(e[`ws-opts`].headers?.Host&&a.set(`host`,e[`ws-opts`].headers.Host),e[`ws-opts`].path&&a.set(`path`,encodeURIComponent(e[`ws-opts`].path)));break;case`grpc`:if(e[`grpc-opts`]){(e[`grpc-opts`][`grpc-mode`]||e[`grpc-opts`].mode)===`multi`&&a.set(`mode`,`multi`);let t=e[`grpc-opts`][`grpc-service-name`];t&&a.set(`serviceName`,encodeURIComponent(t))}break;case`quic`:s!==`tls`&&s!==`reality`&&(a.has(`security`)||a.set(`security`,`tls`)),e[`quic-opts`]&&(e[`quic-opts`].security&&e[`quic-opts`].security!==`none`&&a.set(`quicSecurity`,encodeURIComponent(e[`quic-opts`].security)),e[`quic-opts`].key&&a.set(`key`,encodeURIComponent(e[`quic-opts`].key)),e[`quic-opts`].header?.type&&e[`quic-opts`].header.type!==`none`&&a.set(`headerType`,e[`quic-opts`].header.type));break;case`httpupgrade`:e[`httpupgrade-opts`]&&(e[`httpupgrade-opts`].host&&a.set(`host`,e[`httpupgrade-opts`].host),e[`httpupgrade-opts`].path&&a.set(`path`,encodeURIComponent(e[`httpupgrade-opts`].path)));break;case`h2`:if(s!==`tls`&&s!==`reality`&&(a.has(`security`)||a.set(`security`,`tls`)),e[`h2-opts`]){let t=e[`h2-opts`].host;Array.isArray(t)&&t.length>0?a.set(`host`,encodeURIComponent(t.join(`,`))):typeof t==`string`&&a.set(`host`,encodeURIComponent(t)),e[`h2-opts`].path&&a.set(`path`,encodeURIComponent(e[`h2-opts`].path))}break;default:console.warn(`Unsupported network type for URL generation: ${o}`)}e.tfo===!0&&a.set(`tfo`,`1`);let c=a.toString();return`vless://${t}@${n}:${r}${c?`?${c}`:``}${i}`}function Sa(e){if(!e||!e.server||!e.port||!e.uuid)throw Error(`Vmess configuration object must contain server, port, and uuid.`);let t={v:`2`,ps:e.name||``,add:e.server,port:e.port,id:e.uuid,aid:e.alterId||0,scy:e.cipher||`auto`,net:e.network||`tcp`};switch(e.tls?(t.tls=`tls`,t.sni=e.servername||e.server,e[`client-fingerprint`]&&(t.fp=e[`client-fingerprint`])):t.tls=``,t.net){case`ws`:case`http`:{let n=e[`ws-opts`]||e[`http-opts`]||{};n.headers&&n.headers.Host?t.host=n.headers.Host:t.sni?t.host=t.sni:t.host=t.add,t.path=n.path||`/`,t.net===`http`&&!e.tls?t.type=`http`:t.net===`ws`&&!e.tls&&(t.type=`ws`);break}case`tcp`:e.tls||(t.type=`none`);break;case`grpc`:e[`grpc-opts`]&&e[`grpc-opts`].serviceName&&(t.serviceName=e[`grpc-opts`].serviceName),t.type=`grpc`;break}return(t.type===`none`||t.net===t.type&&!e.tls)&&delete t.type,t.tfo=e.tfo?`1`:`0`,t.udp=e.udp?`1`:`0`,`vmess://${Y(JSON.stringify(t))}`}function Ca(e){let t=[];for(let n of e)try{n.type===`anytls`&&t.push(pa(n)),n.type===`vmess`&&t.push(Sa(n)),n.type===`trojan`&&t.push(ya(n)),n.type===`vless`&&t.push(xa(n)),n.type===`ss`&&t.push(ga(n)),n.type===`ssr`&&t.push(va(n)),(n.type===`hysteria2`||n.type===`hy2`)&&t.push(ha(n)),n.type===`hysteria`&&t.push(ma(n)),n.type===`tuic`&&t.push(ba(n))}catch{continue}return t}var wa=class extends ia{urlSet=new Set;vpsStore=new Map;originUrls=new Set;vps=[];includeProtocol=[];excludeTag=[];constructor(e,t=[],n=``,r=``){super(t),this.vps=e,this.includeProtocol=n?JSON.parse(n):[],this.excludeTag=r?JSON.parse(r):[]}async parse(e=this.vps){for await(let t of e)try{let e=this.updateVpsPs(t);if(e){let t=null;e.startsWith(`anytls://`)&&this.hasProtocol(`anytls`)?t=new aa(e):e.startsWith(`vless://`)&&this.hasProtocol(`vless`)?t=new da(e):e.startsWith(`vmess://`)&&this.hasProtocol(`vmess`)?t=new fa(e):e.startsWith(`trojan://`)&&this.hasProtocol(`trojan`)?t=new la(e):e.startsWith(`ss://`)&&this.hasProtocol(`shadowsocks`)?t=new sa(e):e.startsWith(`ssr://`)&&this.hasProtocol(`shadowsocksr`)?t=new ca(e):this.isHysteria2(e)&&this.hasProtocol(`hysteria`,`hysteria2`,`hy2`)?t=new oa(e):e.startsWith(`tuic://`)&&this.hasProtocol(`tuic`)&&(t=new ua(e)),t&&this.setStore(e,t)}if(t.startsWith(`https://`)||t.startsWith(`http://`)){let e=await $i(t,{retries:3}).then(async e=>e.data.text()),{subType:n,content:r}=this.getSubType(e);if(n===`base64`&&r&&(this.updateExist(Array.from(this.originUrls)),await this.parse(r.split(`
`).filter(Boolean))),n===`yaml`&&r){let e=r.proxies;if(e.length){this.updateExist(Array.from(this.originUrls));let t=Ca(e);await this.parse(t.filter(Boolean))}}}}catch{continue}}setStore(e,t){let n=t.tag;n&&this.excludeTag.includes(n)||(this.urlSet.add(t.confuseLink),this.originUrls.add(e),this.vpsStore.set(t.confusePs,t))}getSubType(e){try{return{subType:`base64`,content:ea(e)}}catch{try{return{subType:`yaml`,content:Wi(e)}}catch{try{let t=JSON.parse(e);return{subType:`json`,content:JSON.stringify(t)}}catch{return{subType:`unknown`,content:e}}}}}isHysteria2(e){return e.startsWith(`hysteria2://`)||e.startsWith(`hysteria://`)||e.startsWith(`hy2://`)}hasProtocol(...e){return this.includeProtocol.length===0||e.some(e=>this.includeProtocol.includes(e))}get urls(){return Array.from(this.urlSet)}get vpsMap(){return this.vpsStore}get originVps(){return Array.from(this.originUrls)}},Ta=class{async getConfig(e){try{let t=(await Promise.all(e.map(e=>$i(e,{retries:3}).then(e=>e.data.text())))).map(e=>Wi(e));return this.mergeClashConfig(t)}catch(e){throw Error(`Failed to get clash config: ${e.message||e}`)}}isSameProxies(e,t){if(e.length!==t.length)return!1;let n=new Set(e);return t.every(e=>n.has(e))}mergeGroupProxies(e,t){let n=new Set(e),r=[...e];for(let e of t)n.has(e)||(n.add(e),r.push(e));return r}mergeClashConfig(e=[]){try{if(!e.length)return{};if(e.length===1)return e[0];let t=[];for(let n of e)n.proxies?.length&&t.push(...n.proxies);let n=new Map,r=[];for(let t of e)if(t[`proxy-groups`]?.length)for(let e of t[`proxy-groups`]){let t=n.get(e.name);if(!t)n.set(e.name,{...e,proxies:[...e.proxies||[]]}),r.push(e.name);else{let n=t.proxies||[],r=e.proxies||[];this.isSameProxies(n,r)||(t.proxies=this.mergeGroupProxies(n,r))}}return{...e[0],proxies:t,"proxy-groups":r.map(e=>n.get(e))}}catch(e){throw Error(`Failed to merge clash config: ${e.message||e}`)}}},Ea=class{async getConfig(e){try{let t=(await Promise.all(e.map(e=>$i(e,{retries:3}).then(e=>e.data.text())))).filter(e=>qi(e)).map(e=>JSON.parse(e));return this.mergeConfig(t)}catch(e){throw Error(`Failed to get singbox config: ${e.message||e}`)}}mergeConfig(e){try{if(e.length===0)return{};let t=structuredClone(e[0]),n=[],r=new Set,i=new Map;for(let t of e)if(t.outbounds?.length){for(let e of t.outbounds)if(e.outbounds){let t=`${e.type}:${e.tag}`;if(!i.has(t)){let n=new Set(e.outbounds.filter(e=>!Z.isConfigType(e)));i.set(t,{base:e,baseOutbounds:n,linkOutbounds:new Set})}e.outbounds.forEach(e=>{Z.isConfigType(e)&&i.get(t)?.linkOutbounds.add(e)})}}for(let t of e)if(t.outbounds?.length){for(let e of t.outbounds)if(!e.outbounds)if(Z.isConfigType(e.tag))n.push(e);else{let t=`${e.type}:${e.tag}`;r.has(t)||(r.add(t),n.push(e))}}for(let[e,t]of i){let e={...t.base},r=new Set([...t.baseOutbounds,...t.linkOutbounds]);e.outbounds=Array.from(r),n.push(e)}return t.outbounds=n,t}catch(e){throw Error(`Failed to merge singbox config: ${e.message||e}`)}}},Da=class extends wa{async getConfig(e,t){try{return await this.parse(t),na(this.originVps.join(`
`))}catch(e){throw Error(`Failed to get v2ray config: ${e.message||e}`)}}},Oa=class{urls=[];vps=[];chunkCount=Number(K.CHUNK_COUNT);backend=K.BACKEND;parser=null;clashClient=new Ta;singboxClient=new Ea;v2rayClient=new Da(this.vps);constructor(e){this.chunkCount=Number(e.CHUNK_COUNT??K.CHUNK_COUNT),this.backend=e.BACKEND??K.BACKEND,this.parser=null}async setSubUrls(e){let{searchParams:t}=new URL(e.url),n=t.get(`url`),r=t.get(`protocol`),i=t.get(`exclude`);this.backend=t.get(`backend`)??this.backend;let a=n.split(/\||\n/).filter(Boolean);this.parser=new wa(a,[],r,i),this.vps=a,await this.parser.parse(a);let o=Ki(Array.from(this.parser.urls),Number(this.chunkCount));this.urls=o.map(t=>{let n=new URL(`${this.backend}/sub`),{searchParams:r}=new URL(e.url);return r.set(`url`,t),n.search=r.toString(),n.toString()})}async getClashConfig(){return await this.clashClient.getConfig(this.urls)}async getSingboxConfig(){return await this.singboxClient.getConfig(this.urls)}async getV2RayConfig(){return await this.v2rayClient.getConfig(this.urls,this.vps)}get vpsStore(){return this.parser?.vpsMap}},ka=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(e){try{return this.confuseConfig.proxies=this.restoreProxies(this.confuseConfig.proxies,e),this.confuseConfig[`proxy-groups`]=this.confuseConfig?.[`proxy-groups`]?.map(e=>(e.proxies&&=this.updateProxiesGroups(e.proxies),e)),this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}restoreProxies(e,t){let n=[];if(!e)return n;for(let r of e)try{let[e,i]=Z.getPs(r.name);t.has(i)&&(t.get(i)?.restoreClash(r,e),n.push(r))}catch(e){console.warn(`Restore proxies failed: ${e.message||e}, function trace: ${e.stack}`);continue}return n}updateProxiesGroups(e){try{return e.map(e=>{let[t]=Z.getPs(e);return t})}catch(e){throw Error(`Update proxies groups failed: ${e.message||e}, function trace: ${e.stack}`)}}},Aa=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(e){try{return this.confuseConfig.outbounds=this.restoreOutbounds(this.confuseConfig.outbounds,e),this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}restoreOutbounds(e=[],t){let n=[];if(!e)return n;for(let r of e)try{if(this.isConfuseVps(r.tag)){let[e,n]=Z.getPs(r.tag);t.get(n)?.restoreSingbox(r,e)}Reflect.has(r,`outbounds`)&&(r.outbounds=this.updateOutbouns(r.outbounds)),n.push(r)}catch(e){console.warn(`Restore outbounds failed: ${e.message||e}, function trace: ${e.stack}`);continue}return n}updateOutbouns(e=[]){try{return e.map(e=>{if(this.isConfuseVps(e)){let[t]=Z.getPs(e);return t}return e})}catch(e){throw Error(`Update outbounds failed: ${e.message||e}, function trace: ${e.stack}`)}}isConfuseVps(e){return Z.isConfigType(e)}},ja=class{confuseConfig;constructor(e){this.confuseConfig=e}getOriginConfig(){try{return this.confuseConfig}catch(e){throw Error(`Get origin config failed: ${e.message||e}, function trace: ${e.stack}`)}}},Ma=class{constructor(e){this.confuse=e,this.confuse=e}async getClashConfig(){return new ka(await this.confuse.getClashConfig()).getOriginConfig(this.confuse.vpsStore)}async getSingboxConfig(){return new Aa(await this.confuse.getSingboxConfig()).getOriginConfig(this.confuse.vpsStore)}async getV2RayConfig(){return new ja(await this.confuse.getV2RayConfig()).getOriginConfig()}},Na=class{constructor(e){this.repo=e}async toSub(e,t,n){let r=new Oa(t);await r.setSubUrls(e);let i=new Ma(r);if([`clash`,`clashr`].includes(n))return{body:Gi(await i.getClashConfig(),{indent:2,lineWidth:200}),contentType:`text/yaml; charset=UTF-8`};if(n===`singbox`){let e=await i.getSingboxConfig();return{body:JSON.stringify(e),contentType:`text/plain; charset=UTF-8`}}if(n===`v2ray`)return{body:await i.getV2RayConfig(),contentType:`text/plain; charset=UTF-8`};throw Error(`Unsupported client type, support list: clash, singbox, v2ray`)}getVersionRedirect(e,t){let{searchParams:n}=new URL(e.url);return`${n.get(`backend`)??t.BACKEND??K.BACKEND}/version`}async add(e,t){return this.ensureRepo(),this.repo.add(e,t)}async deleteByCode(e){return this.ensureRepo(),this.repo.deleteByCode(e)}async getByCode(e){return this.ensureRepo(),this.repo.getByCode(e)}async getList(e=1,t=20){return this.ensureRepo(),this.repo.getList(e,t)}ensureRepo(){if(!this.repo)throw Error(`Short URL service is not enabled (no repository configured)`)}};const Q=new ze;function $(e){let n=e.get(`repo`);if(!n)throw new t(503,{message:`Short URL service is not enabled`});return new kt(new Na(n))}Q.post(`/api/add`,e=>$(e).add(e)),Q.post(`/api/admin/verify`,e=>$(e).verifyAdmin(e)),Q.delete(`/api/delete`,e=>$(e).delete(e)),Q.get(`/api/queryByCode`,e=>$(e).queryByCode(e)),Q.get(`/api/queryList`,e=>$(e).queryList(e)),Q.get(`/:code`,e=>$(e).redirect(e));const Pa=new ze;Pa.get(`/sub`,e=>new kt(new Na(e.get(`repo`))).toSub(e)),Pa.get(`/version`,e=>new kt(new Na(e.get(`repo`))).getVersion(e));function Fa(e){e.route(`/`,Ot),e.route(`/`,Pa),e.route(`/`,Q)}function Ia(e){let t=new ze;return t.use(`*`,Xe()),t.use(`*`,Ve()),t.use(`*`,Ze(e.repo)),t.onError(He),t.notFound(e=>e.json({error:`Not Found`},404)),Fa(t),t}function La(){return crypto.randomUUID().substring(0,8)}var Ra=class{constructor(e){this.db=e}async add(e,t){let n=La(),r=`${t}/${n}`,i=new Date().toISOString(),a=await this.db.prepare(`INSERT INTO short_url (short_code, short_url, long_url, created_at) VALUES (?, ?, ?, ?) RETURNING id`).bind(n,r,e,i).first();if(!a?.id)throw Error(`Failed to create short URL`);return{id:a.id,short_code:n,short_url:r,long_url:e,created_at:i}}async deleteByCode(e){await this.db.prepare(`DELETE FROM short_url WHERE short_code = ?`).bind(e).run()}async getByCode(e){return await this.db.prepare(`SELECT id, short_code, short_url, long_url, created_at FROM short_url WHERE short_code = ?`).bind(e).first()}async getList(e,t){let n=(e-1)*t,[r,i]=await Promise.all([this.db.prepare(`SELECT COUNT(*) as count FROM short_url`).first(),this.db.prepare(`SELECT id, short_code, short_url, long_url, created_at
                     FROM short_url
                     ORDER BY created_at IS NULL, created_at DESC, id DESC
                     LIMIT ? OFFSET ?`).bind(t,n).all()]);return{total:r?.count||0,items:i?.results||[]}}};function za(e){return e?new Ra(e):null}var Ba={fetch(e,t,n){let r=za(t.DB),i=Ia({repo:r}),a={...t,SHORT_URL_ENABLED:r!==null};return i.fetch(e,a,n)}};export{Ba as default};